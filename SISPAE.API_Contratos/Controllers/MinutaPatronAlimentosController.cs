...
namespace SISPAE_API_Contratos.WebAPI.Controllers
{
    ...
    public partial class MinutaPatronAlimentosController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Esta WebAPI permite consultar los registros existentes en SISPAE_API_Contratos de la entidad  MinutaPatronAlimentos!
        ...
        /// </summary>
        /// <remarks>Esta WebAPI permite crear los registros existentes en SISPAE_API_Contratos de la entidad  MinutaPatronAlimentos!!</remarks>
        ...
        /// </summary>
        /// <remarks>Esta WebAPI permite actualizar los registros existentes en SISPAE_API_Contratos de la entidad  MinutaPatronAlimentos!!</remarks>
        ...
        /// </summary>
        /// <remarks>Esta WebAPI permite eliminar los registros existentes en SISPAE_API_Contratos de la entidad  MinutaPatronAlimentos!!</remarks>
             ...
             try
 {
	...
	orderAscendingDirection = dtParameters.Order[0].Dir.ToString().ToLower() == "asc";
                ...
                var totalResultsCount = result.Count();
                                  ...
                                  if (orderAscendingDirection)                  {                  if (orderCriteria =="id") result = result.OrderBy(p => p.id).Cast <MinutaPatronAlimentos>().ToList();  
                  if (orderCriteria == "Nombre") result = result.OrderBy(p => p.Nombre).Cast <MinutaPatronAlimentos>().ToList(); 
                   ...
                   //if (orderCriteria == "ID_UsuarioEntidad") result = result.OrderBy(p => p.ID_UsuarioEntidad).Cast <MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "sID_UsuariosEntidades") result = result.OrderBy(p => p.sID_UsuarioEntidad).Cast <MinutaPatronAlimentos>().ToList(); 
                   ...
                   //if (orderCriteria == "sID_TiposModeloOperacion") result = result.OrderBy(p => p.sID_TipoModeloOperacion).Cast <MinutaPatronAlimentos>().ToList(); 
                   if (orderCriteria == "ID_ETC") result = result.OrderBy(p => p.ID_ETC).Cast <MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "sID_ETC") result = result.OrderBy(p => p.sID_ETC).Cast <MinutaPatronAlimentos>().ToList(); 
                  // if (orderCriteria == "ID_TipoGrupoEtario") result = result.OrderBy(p => p.ID_TipoGrupoEtario).Cast <MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "sID_TiposGrupoEtario") result = result.OrderBy(p => p.sID_TipoGrupoEtario).Cast <MinutaPatronAlimentos>().ToList(); 
                     }
  else 
                  ...
                  if (orderCriteria == "Nombre") result = result.OrderByDescending(p => p.Nombre).Cast <MinutaPatronAlimentos>().ToList(); 
                   ...
                   //if (orderCriteria == "ID_UsuarioEntidad") result = result.OrderByDescending(p => p.ID_UsuarioEntidad).Cast <MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "sID_UsuariosEntidades") result = result.OrderByDescending(p => p.sID_UsuarioEntidad).Cast<MinutaPatronAlimentos>().ToList(); 
                   ...
                   //if (orderCriteria == "sID_TiposModeloOperacion") result = result.OrderByDescending(p => p.sID_TipoModeloOperacion).Cast<MinutaPatronAlimentos>().ToList(); 
                   if (orderCriteria == "ID_ETC") result = result.OrderByDescending(p => p.ID_ETC).Cast <MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "sID_ETC") result = result.OrderByDescending(p => p.sID_ETC).Cast<MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "ID_TipoGrupoEtario") result = result.OrderByDescending(p => p.ID_TipoGrupoEtario).Cast <MinutaPatronAlimentos>().ToList(); 
                   //if (orderCriteria == "sID_TiposGrupoEtario") result = result.OrderByDescending(p => p.sID_TipoGrupoEtario).Cast<MinutaPatronAlimentos>().ToList(); 
                     }
