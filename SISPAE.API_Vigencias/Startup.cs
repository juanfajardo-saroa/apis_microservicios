...
using SISPAE_API_Vigencias.WebAPI.OperationFilter;
using SISPAE.Model;
...
using SISPAE_API_Vigencias.WebAPI.Data;
using SISPAE_API_Vigencias.WebAPI.Model;
...
namespace SISPAE_API_Vigencias.WebAPI
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
            ...
            app.UseSwagger(c =>
            {
                c.PreSerializeFilters.Add((swaggerDoc, httpRequest) =>
                {
                    ...
                    var basePath = "sispae-api-vigencias";
