...
namespace SISPAE_API_Seguridad.WebAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddScoped<IAlimentosBase, AlimentosBaseRepository>();
            ...
            //var test = Configuration.GetValue<string>("DefaultConnection");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
            {
                c.PreSerializeFilters.Add((swaggerDoc, httpRequest) =>
             {
                 ...
                 var basePath = "sispae-api-seguridad";
