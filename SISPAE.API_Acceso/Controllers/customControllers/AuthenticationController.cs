...
namespace SISPAE_API_Acceso.WebAPI.Controllers.customControllers
{
   ...
   public class AuthenticationController : ControllerBase
   {
      ...
      /// <summary>
      /// Crea el token de authenticacion para un usuario
      /// </summary>
      /// <param name="credentials">Las credenciales del usuario que se loguea (usuario, Contrase�a).</param>
      /// <returns></returns>
      [HttpPost]
      [AllowAnonymous]
