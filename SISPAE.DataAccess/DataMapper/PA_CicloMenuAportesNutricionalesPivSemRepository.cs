...
{
     /// <Resumen>
     /// Clase Abstracta para  PA_CicloMenuAportesNutricionalesPivSem
     /// No haga cambios sobre esta clase,
     /// 
     /// </Resumen>
	public partial class PA_CicloMenuAportesNutricionalesPivSemRepository : DataObject , IPA_CicloMenuAportesNutricionalesPivSem 
        {
		#region Class Declarations
            ...
            private readonly SqlConnection con;
			 ...
			 public PA_CicloMenuAportesNutricionalesPivSemRepository() 
            {
				_dataSource = new DataMapperSource();
                con = new SqlConnection(_dataSource.cadena);
            }			
			
			public PA_CicloMenuAportesNutricionalesPivSemRepository(DataAccess.DataMapper.DataMapperSource dataSource) 
			{
...
p.Add("@ID_Semana",ID_Semana);
					...
					List<PA_CicloMenuAportesNutricionalesPivSem> l = SqlMapper.Query<PA_CicloMenuAportesNutricionalesPivSem>(con, "PTN.PA_CicloMenuAportesNutricionalesPivSem" , p, commandType: CommandType.StoredProcedure).AsList();

					return l;
				}
				catch (Exception ex)
				{
						throw new Exception("DataMapper:(GetPA_CicloMenuAportesNutricionalesPivSem)  PA_CicloMenuAportesNutricionalesPivSem  ->" + ex.Message);
				}
			}
