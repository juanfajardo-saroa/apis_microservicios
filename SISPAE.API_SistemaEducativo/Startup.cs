...
using SISPAE_API_SistemaEducativo.WebAPI.OperationFilter;
using SISPAE.Model;
...
using SISPAE_API_SistemaEducativo.WebAPI.Data;
using SISPAE_API_SistemaEducativo.WebAPI.Model;
...
namespace SISPAE_API_SistemaEducativo.WebAPI
{
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
            ...
            app.UseSwagger(c =>
            {
                c.PreSerializeFilters.Add((swaggerDoc, httpRequest) =>
                {
                    ...
                    var basePath = "sispae-api-sistemaeducativo";
