...
namespace SISPAE2_API_Seguimiento.WebAPI.Controllers
{
    ...
    public partial class SemanaEntregaRacionesController : ControllerBase
    {
        ...
        public async Task<IActionResult> LoadTable([FromBody] DtParameters dtParameters)
        {
            ...
            try
            {
                ...
                { 
                if (orderCriteria =="id") result = result.OrderBy(p => p.id).Cast <SemanaEntregaRaciones>().ToList();  
                if (orderCriteria == "ID_EstadoSemana") result = result.OrderBy(p => p.ID_EstadoSemana).Cast <SemanaEntregaRaciones>().ToList(); 
                 ...
                 if (orderCriteria == "Mes") result = result.OrderBy(p => p.Mes).Cast <SemanaEntregaRaciones>().ToList(); 
                 if (orderCriteria == "Semana") result = result.OrderBy(p => p.Semana).Cast <SemanaEntregaRaciones>().ToList(); 
                ...
                if (orderCriteria == "ID_EstadoSemana") result = result.OrderByDescending(p => p.ID_EstadoSemana).Cast <SemanaEntregaRaciones>().ToList(); 
                 ...
                 if (orderCriteria == "Mes") result = result.OrderByDescending(p => p.Mes).Cast <SemanaEntregaRaciones>().ToList(); 
                 if (orderCriteria == "Semana") result = result.OrderByDescending(p => p.Semana).Cast <SemanaEntregaRaciones>().ToList(); 
                ...
                if (!string.IsNullOrEmpty(searchBy))
                {
                 ...
                 || r.Semana != null && r.Semana.ToString().ToUpper().Contains(searchBy.ToUpper()) 
