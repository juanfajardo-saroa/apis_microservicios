...
{
    public  class UTAlertaEstadosController: ITestCaseOrderer
    {
        private readonly AlertaEstadosController _controller;
        private readonly IAlertaEstadosService _service;
        private readonly AlertaEstados _Objeto;
        ...
        public UTAlertaEstadosController()
        {
            _service = new UTAlertaEstadosServiceFake();
            _controller = new AlertaEstadosController();
            
             _Objeto = new AlertaEstados()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlertaEstados v = (AlertaEstados)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlertaEstados c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlertaEstados>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlertaEstados>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlertaEstados).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlertaEstados"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlertaEstados() { id = i });
      //
      //      // Assert
