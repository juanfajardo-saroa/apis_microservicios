...
namespace SISPAE.Tests.Controllers
{
    public  class UTAlertasController: ITestCaseOrderer
    {
        ...
        public UTAlertasController()
        {
            _service = new UTAlertasServiceFake();
            _controller = new AlertasController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Alertas v = (Alertas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Alertas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Alertas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Alertas).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.Valor="a";
_Objeto.URL="a";
_Objeto.FechaCreado=DateTime.Now;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Alertas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Alertas() { id = i });
      //
      //      // Assert
