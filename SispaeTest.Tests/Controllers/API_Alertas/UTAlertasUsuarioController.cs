...
using System;
using System.Linq;
using SISPAE_API_Alertas.WebAPI.Controllers;
...
{
    public  class UTAlertasUsuarioController: ITestCaseOrderer
    {
        private readonly AlertasUsuarioController _controller;
        private readonly IAlertasUsuarioService _service;
        private readonly AlertasUsuario _Objeto;
        ...
        public UTAlertasUsuarioController()
        {
            _service = new UTAlertasUsuarioServiceFake();
            _controller = new AlertasUsuarioController();
            
             _Objeto = new AlertasUsuario()
            {
                id=0,
ID_Alerta=1,
ID_User=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlertasUsuario v = (AlertasUsuario)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlertasUsuario c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlertasUsuario>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlertasUsuario>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlertasUsuario).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlertasUsuario"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlertasUsuario() { id = i });
      //
      //      // Assert
