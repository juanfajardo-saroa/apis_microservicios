...
{
    public  class UTVigenciasController: ITestCaseOrderer
    {
        private readonly VigenciasController _controller;
        private readonly IVigenciasService _service;
        private readonly Vigencias _Objeto;
        ...
        public UTVigenciasController()
        {
            _service = new UTVigenciasServiceFake();
            _controller = new VigenciasController();
            
             _Objeto = new Vigencias()
            {
                id=0,
Nombre="a",
Ano=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Vigencias v = (Vigencias)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Vigencias c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Vigencias>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Vigencias>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Vigencias).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.Nombre="a";
_Objeto.Ano=1;
_Objeto.FechaInicial=DateTime.Now;
_Objeto.VigenciaActual=true;
_Objeto.id_FaseVigencia=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Vigencias"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Vigencias() { id = i });
      //
      //      // Assert
