...
using System;
using System.Linq;
using SISPAE_API_Vigencias.WebAPI.Controllers;
...
{
    public  class UTVisitasControlSocialController: ITestCaseOrderer
    {
        private readonly VisitasControlSocialController _controller;
        private readonly IVisitasControlSocialService _service;
        private readonly VisitasControlSocial _Objeto;
        ...
        public UTVisitasControlSocialController()
        {
            _service = new UTVisitasControlSocialServiceFake();
            _controller = new VisitasControlSocialController();
            
             _Objeto = new VisitasControlSocial()
            {
                id=0,
ID_TipoActorControlSocial=1,
ID_Divipola=1,
ID_TipoEntidad=1,
ID_Sede=1,
ID_Vigencia=1,
ID_TipoCargoControlSocial=1,
cargoControlSocialOtros=1,
ID_TipolnstitucionControlSocial=1,
InstitucionControlSocialOtros=1,
Correo="a",
Nombre="a",
Apellido="a",
Cedula="a",
...
FechaHoraVisita=1,
FechaReporte=1,
FotoComplementoEvidenciaPath=1,
DescripcionFoto=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            VisitasControlSocial v = (VisitasControlSocial)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            VisitasControlSocial c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<VisitasControlSocial>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<VisitasControlSocial>(okResult.Value);
            Assert.Equal(i, (okResult.Value as VisitasControlSocial).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoActorControlSocial=1;
_Objeto.ID_Divipola=2;
_Objeto.ID_TipoEntidad=1;
_Objeto.ID_Sede=2;
_Objeto.ID_Vigencia=2;
_Objeto.ID_TipoCargoControlSocial=1;
_Objeto.cargoControlSocialOtros=1;
_Objeto.ID_TipolnstitucionControlSocial=1;
_Objeto.InstitucionControlSocialOtros=1;
_Objeto.Correo="a";
_Objeto.Nombre="a";
_Objeto.Apellido="a";
_Objeto.Cedula="a";
_Objeto.Celular="a";
_Objeto.FechaHoraVisita=1;
_Objeto.FechaReporte=1;
_Objeto.FotoComplementoEvidenciaPath=1;
_Objeto.DescripcionFoto=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("VisitasControlSocial"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new VisitasControlSocial() { id = i });
      //
      //      // Assert
