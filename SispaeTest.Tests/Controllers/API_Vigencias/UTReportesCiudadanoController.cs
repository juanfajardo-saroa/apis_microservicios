...
{
    public  class UTReportesCiudadanoController: ITestCaseOrderer
    {
        private readonly ReportesCiudadanoController _controller;
        private readonly IReportesCiudadanoService _service;
        private readonly ReportesCiudadano _Objeto;
        ...
        public UTReportesCiudadanoController()
        {
            _service = new UTReportesCiudadanoServiceFake();
            _controller = new ReportesCiudadanoController();
            
             _Objeto = new ReportesCiudadano()
            {
                id=0,
ID_TipoReporteCiudadano=1,
ID_Categoria=1,
ID_Vigencia=1,
Detalle=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ReportesCiudadano v = (ReportesCiudadano)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ReportesCiudadano c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ReportesCiudadano>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ReportesCiudadano>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ReportesCiudadano).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoReporteCiudadano=1;
_Objeto.ID_Categoria=1;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ReportesCiudadano"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ReportesCiudadano() { id = i });
      //
      //      // Assert
