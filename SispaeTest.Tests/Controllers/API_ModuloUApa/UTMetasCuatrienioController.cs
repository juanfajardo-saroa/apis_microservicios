...
{
    public  class UTMetasCuatrienioController: ITestCaseOrderer
    {
        private readonly MetasCuatrienioController _controller;
        private readonly IMetasCuatrienioService _service;
        private readonly MetasCuatrienio _Objeto;
        ...
        public UTMetasCuatrienioController()
        {
            _service = new UTMetasCuatrienioServiceFake();
            _controller = new MetasCuatrienioController();
            
             _Objeto = new MetasCuatrienio()
            {
                id=0,
Definicion="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MetasCuatrienio v = (MetasCuatrienio)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MetasCuatrienio c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MetasCuatrienio>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MetasCuatrienio>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MetasCuatrienio).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MetasCuatrienio"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MetasCuatrienio() { id = i });
      //
      //      // Assert
