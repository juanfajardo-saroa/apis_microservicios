...
{
    public  class UTTipoArchivoController: ITestCaseOrderer
    {
        private readonly TipoArchivoController _controller;
        private readonly ITipoArchivoService _service;
        private readonly TipoArchivo _Objeto;
        ...
        public UTTipoArchivoController()
        {
            _service = new UTTipoArchivoServiceFake();
            _controller = new TipoArchivoController();
            
             _Objeto = new TipoArchivo()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoArchivo v = (TipoArchivo)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoArchivo c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoArchivo>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoArchivo>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoArchivo).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoArchivo"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoArchivo() { id = i });
      //
      //      // Assert
