...
{
    public  class UTRolesSinAccesoController: ITestCaseOrderer
    {
        private readonly RolesSinAccesoController _controller;
        private readonly IRolesSinAccesoService _service;
        private readonly RolesSinAcceso _Objeto;
        ...
        public UTRolesSinAccesoController()
        {
            _service = new UTRolesSinAccesoServiceFake();
            _controller = new RolesSinAccesoController();
            
             _Objeto = new RolesSinAcceso()
            {
                id=0,
ID_Repositorio=1,
ID_Rol=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            RolesSinAcceso v = (RolesSinAcceso)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            RolesSinAcceso c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<RolesSinAcceso>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<RolesSinAcceso>(okResult.Value);
            Assert.Equal(i, (okResult.Value as RolesSinAcceso).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Repositorio=2;
_Objeto.ID_Rol=2;
_Objeto.ID_Usuario=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("RolesSinAcceso"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new RolesSinAcceso() { id = i });
      //
      //      // Assert
