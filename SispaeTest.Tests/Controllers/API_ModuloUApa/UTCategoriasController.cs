...
namespace SISPAE.Tests.Controllers
{
    public  class UTCategoriasController: ITestCaseOrderer
    {
        ...
        {
            _service = new UTCategoriasServiceFake();
            _controller = new CategoriasController();
            
             _Objeto = new Categorias()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Categorias v = (Categorias)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Categorias c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Categorias>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Categorias>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Categorias).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Categorias"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Categorias() { id = i });
      //
      //      // Assert
