...
{
    public  class UTIndicadoresMetaController: ITestCaseOrderer
    {
        private readonly IndicadoresMetaController _controller;
        private readonly IIndicadoresMetaService _service;
        private readonly IndicadoresMeta _Objeto;
        ...
        public UTIndicadoresMetaController()
        {
            _service = new UTIndicadoresMetaServiceFake();
            _controller = new IndicadoresMetaController();
            
             _Objeto = new IndicadoresMeta()
            {
                id=0,
ID_Meta=1,
Definicion="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            IndicadoresMeta v = (IndicadoresMeta)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            IndicadoresMeta c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<IndicadoresMeta>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<IndicadoresMeta>(okResult.Value);
            Assert.Equal(i, (okResult.Value as IndicadoresMeta).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("IndicadoresMeta"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new IndicadoresMeta() { id = i });
      //
      //      // Assert
