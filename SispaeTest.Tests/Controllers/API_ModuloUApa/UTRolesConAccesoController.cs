...
{
    public  class UTRolesConAccesoController: ITestCaseOrderer
    {
        private readonly RolesConAccesoController _controller;
        private readonly IRolesConAccesoService _service;
        private readonly RolesConAcceso _Objeto;
        ...
        public UTRolesConAccesoController()
        {
            _service = new UTRolesConAccesoServiceFake();
            _controller = new RolesConAccesoController();
            
             _Objeto = new RolesConAcceso()
            {
                id=0,
ID_Repositorio=1,
ID_Rol=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            RolesConAcceso v = (RolesConAcceso)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            RolesConAcceso c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<RolesConAcceso>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<RolesConAcceso>(okResult.Value);
            Assert.Equal(i, (okResult.Value as RolesConAcceso).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("RolesConAcceso"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new RolesConAcceso() { id = i });
      //
      //      // Assert
