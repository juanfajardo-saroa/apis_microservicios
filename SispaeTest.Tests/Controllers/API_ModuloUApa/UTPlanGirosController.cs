...
{
    public  class UTPlanGirosController: ITestCaseOrderer
    {
        private readonly PlanGirosController _controller;
        private readonly IPlanGirosService _service;
        private readonly PlanGiros _Objeto;
        ...
        public UTPlanGirosController()
        {
            _service = new UTPlanGirosServiceFake();
            _controller = new PlanGirosController();
            
             _Objeto = new PlanGiros()
            {
                id=0,
ID_ETC=1,
Mes=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PlanGiros v = (PlanGiros)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PlanGiros c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PlanGiros>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PlanGiros>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PlanGiros).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_ETC=2;
_Objeto.Mes=2;
_Objeto.GiroProyectado=1;
_Objeto.GiroConfirmado=1;
_Objeto.PATHSoporteGiro="a";
_Objeto.idVigencia=2;
_Objeto.FechaTransferencia=DateTime.Now;
_Objeto.NumeroOrden="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PlanGiros"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PlanGiros() { id = i });
      //
      //      // Assert
