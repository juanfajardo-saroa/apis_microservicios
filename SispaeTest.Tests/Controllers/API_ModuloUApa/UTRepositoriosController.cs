...
using System;
using System.Linq;
using SISPAE_API_ModuloUApa.WebAPI.Controllers;
...
{
    public  class UTRepositoriosController: ITestCaseOrderer
    {
        private readonly RepositoriosController _controller;
        private readonly IRepositoriosService _service;
        private readonly Repositorios _Objeto;
        ...
        public UTRepositoriosController()
        {
            _service = new UTRepositoriosServiceFake();
            _controller = new RepositoriosController();
            
             _Objeto = new Repositorios()
            {
                id=0,
idTipoArchivo=1,
idCategoria=1,
...
fechaCarga=DateTime.Now,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Repositorios v = (Repositorios)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Repositorios c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Repositorios>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Repositorios>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Repositorios).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.idTipoArchivo=2;
_Objeto.idCategoria=2;
_Objeto.idVigencia=2;
_Objeto.PAHTArchivo="a";
_Objeto.Nombre="a";
_Objeto.Descripcion="a";
_Objeto.auditoria="a";
_Objeto.fechaArchivo=DateTime.Now;
_Objeto.fechaCarga=DateTime.Now;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Repositorios"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Repositorios() { id = i });
      //
      //      // Assert
