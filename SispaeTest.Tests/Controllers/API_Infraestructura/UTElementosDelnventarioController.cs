...
{
    public  class UTElementosDelnventarioController: ITestCaseOrderer
    {
        private readonly ElementosDelnventarioController _controller;
        private readonly IElementosDelnventarioService _service;
        private readonly ElementosDelnventario _Objeto;
        ...
        public UTElementosDelnventarioController()
        {
            _service = new UTElementosDelnventarioServiceFake();
            _controller = new ElementosDelnventarioController();
            
             _Objeto = new ElementosDelnventario()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ElementosDelnventario v = (ElementosDelnventario)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ElementosDelnventario c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ElementosDelnventario>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ElementosDelnventario>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ElementosDelnventario).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ElementosDelnventario"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ElementosDelnventario() { id = i });
      //
      //      // Assert
