...
{
    public  class UTAreasIdentificadasController: ITestCaseOrderer
    {
        private readonly AreasIdentificadasController _controller;
        private readonly IAreasIdentificadasService _service;
        private readonly AreasIdentificadas _Objeto;
        ...
        public UTAreasIdentificadasController()
        {
            _service = new UTAreasIdentificadasServiceFake();
            _controller = new AreasIdentificadasController();
            
             _Objeto = new AreasIdentificadas()
            {
                id=0,
ID_Dimension=1,
auditoria="a",
Nombre="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AreasIdentificadas v = (AreasIdentificadas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AreasIdentificadas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AreasIdentificadas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AreasIdentificadas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AreasIdentificadas).id);
        }
...
_Objeto.Nombre="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AreasIdentificadas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AreasIdentificadas() { id = i });
      //
      //      // Assert
