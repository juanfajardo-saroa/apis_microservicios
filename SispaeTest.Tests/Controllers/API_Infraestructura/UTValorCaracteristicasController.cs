...
{
    public  class UTValorCaracteristicasController: ITestCaseOrderer
    {
        private readonly ValorCaracteristicasController _controller;
        private readonly IValorCaracteristicasService _service;
        private readonly ValorCaracteristicas _Objeto;
        ...
        public UTValorCaracteristicasController()
        {
            _service = new UTValorCaracteristicasServiceFake();
            _controller = new ValorCaracteristicasController();
            
             _Objeto = new ValorCaracteristicas()
            {
                id=0,
ID_Caracterizacion=1,
ID_ValorEscala=1,
auditoria="a",
ID_Caracteristica=1,
Valor=1,
fecha=DateTime.Now,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ValorCaracteristicas v = (ValorCaracteristicas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ValorCaracteristicas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ValorCaracteristicas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ValorCaracteristicas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ValorCaracteristicas).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Caracterizacion=2;
_Objeto.ID_ValorEscala=2;
_Objeto.auditoria="a";
...
_Objeto.fecha=DateTime.Now;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ValorCaracteristicas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ValorCaracteristicas() { id = i });
      //
      //      // Assert
