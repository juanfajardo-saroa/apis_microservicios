...
{
    public  class UTValorCaracteristicasModalidadController: ITestCaseOrderer
    {
        private readonly ValorCaracteristicasModalidadController _controller;
        private readonly IValorCaracteristicasModalidadService _service;
        private readonly ValorCaracteristicasModalidad _Objeto;
        ...
        public UTValorCaracteristicasModalidadController()
        {
            _service = new UTValorCaracteristicasModalidadServiceFake();
            _controller = new ValorCaracteristicasModalidadController();
            
             _Objeto = new ValorCaracteristicasModalidad()
            {
                id=0,
ID_ModalidadRacion=1,
ID_Caracteristica=1,
ID_ValorCaracteristica=1,
Valor=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ValorCaracteristicasModalidad v = (ValorCaracteristicasModalidad)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ValorCaracteristicasModalidad c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ValorCaracteristicasModalidad>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ValorCaracteristicasModalidad>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ValorCaracteristicasModalidad).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_ModalidadRacion=2;
_Objeto.ID_Caracteristica=2;
_Objeto.ID_ValorCaracteristica=2;
_Objeto.Valor=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ValorCaracteristicasModalidad"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ValorCaracteristicasModalidad() { id = i });
      //
      //      // Assert
