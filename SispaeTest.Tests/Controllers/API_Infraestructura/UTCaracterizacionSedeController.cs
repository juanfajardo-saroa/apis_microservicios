...
{
    public  class UTCaracterizacionSedeController: ITestCaseOrderer
    {
        private readonly CaracterizacionSedeController _controller;
        private readonly ICaracterizacionSedeService _service;
        private readonly CaracterizacionSede _Objeto;
        ...
        public UTCaracterizacionSedeController()
        {
            _service = new UTCaracterizacionSedeServiceFake();
            _controller = new CaracterizacionSedeController();
            
             _Objeto = new CaracterizacionSede()
            {
                ID=0,
ID_Sede=1,
ID_DiagnosticoSituacional=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CaracterizacionSede v = (CaracterizacionSede)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CaracterizacionSede c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CaracterizacionSede>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CaracterizacionSede>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CaracterizacionSede).ID);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_Sede=2;
_Objeto.ID_DiagnosticoSituacional=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CaracterizacionSede"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CaracterizacionSede() { id = i });
      //
      //      // Assert
