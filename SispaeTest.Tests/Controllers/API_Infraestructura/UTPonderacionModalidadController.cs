...
{
    public  class UTPonderacionModalidadController: ITestCaseOrderer
    {
        private readonly PonderacionModalidadController _controller;
        private readonly IPonderacionModalidadService _service;
        private readonly PonderacionModalidad _Objeto;
        ...
        public UTPonderacionModalidadController()
        {
            _service = new UTPonderacionModalidadServiceFake();
            _controller = new PonderacionModalidadController();
            
             _Objeto = new PonderacionModalidad()
            {
                id=0,
ID_Caracteristica=1,
ID_TipoAcceso=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PonderacionModalidad v = (PonderacionModalidad)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PonderacionModalidad c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PonderacionModalidad>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PonderacionModalidad>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PonderacionModalidad).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PonderacionModalidad"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PonderacionModalidad() { id = i });
      //
      //      // Assert
