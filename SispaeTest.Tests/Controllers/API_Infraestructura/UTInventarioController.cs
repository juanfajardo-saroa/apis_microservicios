...
namespace SISPAE.Tests.Controllers
{
    public  class UTInventarioController: ITestCaseOrderer
    {
        ...
        public UTInventarioController()
        {
            _service = new UTInventarioServiceFake();
            _controller = new InventarioController();
            
             _Objeto = new Inventario()
            {
                id=0,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Inventario v = (Inventario)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Inventario c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Inventario>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Inventario>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Inventario).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Caracterizacion=1;
_Objeto.ID_Elemento=2;
_Objeto.Cantidad=1;
_Objeto.Funcionan=1;
_Objeto.SonSuficientes=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Inventario"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Inventario() { id = i });
      //
      //      // Assert
