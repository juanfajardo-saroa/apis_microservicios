...
{
    public  class UTSuficienciaEquiposMenajeController: ITestCaseOrderer
    {
        private readonly SuficienciaEquiposMenajeController _controller;
        private readonly ISuficienciaEquiposMenajeService _service;
        private readonly SuficienciaEquiposMenaje _Objeto;
        ...
        public UTSuficienciaEquiposMenajeController()
        {
            _service = new UTSuficienciaEquiposMenajeServiceFake();
            _controller = new SuficienciaEquiposMenajeController();
            
             _Objeto = new SuficienciaEquiposMenaje()
            {
                id=0,
elemento="a",
id_caracteristica=1,
CantidadInicial=1,
CantidadFinal=1,
RacionInicalInsuficiente=1,
RacionIncialAceptable=1,
RacionFinalAceptable=1,
RacionInicialSuficiente=1,
RacionFinalSuficiente=1,
Auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            SuficienciaEquiposMenaje v = (SuficienciaEquiposMenaje)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            SuficienciaEquiposMenaje c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<SuficienciaEquiposMenaje>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<SuficienciaEquiposMenaje>(okResult.Value);
            Assert.Equal(i, (okResult.Value as SuficienciaEquiposMenaje).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.elemento="a";
_Objeto.id_caracteristica=1;
_Objeto.CantidadInicial=1;
_Objeto.CantidadFinal=1;
_Objeto.RacionInicalInsuficiente=1;
_Objeto.RacionIncialAceptable=1;
_Objeto.RacionFinalAceptable=1;
_Objeto.RacionInicialSuficiente=1;
_Objeto.RacionFinalSuficiente=1;
_Objeto.Auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("SuficienciaEquiposMenaje"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new SuficienciaEquiposMenaje() { id = i });
      //
      //      // Assert
