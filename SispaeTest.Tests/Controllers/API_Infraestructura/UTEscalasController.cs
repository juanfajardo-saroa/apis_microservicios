...
{
    public  class UTEscalasController: ITestCaseOrderer
    {
        private readonly EscalasController _controller;
        private readonly IEscalasService _service;
        private readonly Escalas _Objeto;
        ...
        public UTEscalasController()
        {
            _service = new UTEscalasServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Escalas v = (Escalas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Escalas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Escalas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Escalas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Escalas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Escalas() { id = i });
      //
      //      // Assert
