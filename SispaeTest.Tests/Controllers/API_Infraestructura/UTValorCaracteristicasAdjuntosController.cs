...
{
    public  class UTValorCaracteristicasAdjuntosController: ITestCaseOrderer
    {
        private readonly ValorCaracteristicasAdjuntosController _controller;
        private readonly IValorCaracteristicasAdjuntosService _service;
        private readonly ValorCaracteristicasAdjuntos _Objeto;
        ...
        public UTValorCaracteristicasAdjuntosController()
        {
            _service = new UTValorCaracteristicasAdjuntosServiceFake();
            _controller = new ValorCaracteristicasAdjuntosController();
            
             _Objeto = new ValorCaracteristicasAdjuntos()
            {
                id=0,
id_ValorCaracteristicas=1,
Adjunto="a",
Fecha=DateTime.Now,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ValorCaracteristicasAdjuntos v = (ValorCaracteristicasAdjuntos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ValorCaracteristicasAdjuntos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ValorCaracteristicasAdjuntos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ValorCaracteristicasAdjuntos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ValorCaracteristicasAdjuntos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.id_ValorCaracteristicas=2;
_Objeto.Adjunto="a";
_Objeto.Fecha=DateTime.Now;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ValorCaracteristicasAdjuntos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ValorCaracteristicasAdjuntos() { id = i });
      //
      //      // Assert
