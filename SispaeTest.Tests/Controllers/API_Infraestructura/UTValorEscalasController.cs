...
{
    public  class UTValorEscalasController: ITestCaseOrderer
    {
        private readonly ValorEscalasController _controller;
        private readonly IValorEscalasService _service;
        private readonly ValorEscalas _Objeto;
        ...
        public UTValorEscalasController()
        {
            _service = new UTValorEscalasServiceFake();
            _controller = new ValorEscalasController();
            
             _Objeto = new ValorEscalas()
            {
                id=0,
ID_Escala=1,
Respuesta="a",
...
Maximo=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ValorEscalas v = (ValorEscalas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ValorEscalas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ValorEscalas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ValorEscalas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ValorEscalas).id);
        }
...
_Objeto.Valor=1;
_Objeto.auditoria="a";
_Objeto.RequiereAdjunto=true;
_Objeto.RequiereFecha=true;
_Objeto.EncenderHijos=true;
_Objeto.Minimo=1;
_Objeto.Maximo=1;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ValorEscalas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ValorEscalas() { id = i });
      //
      //      // Assert
