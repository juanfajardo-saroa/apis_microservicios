...
{
    public  class UTRiesgosDimensionController: ITestCaseOrderer
    {
        private readonly RiesgosDimensionController _controller;
        private readonly IRiesgosDimensionService _service;
        private readonly RiesgosDimension _Objeto;
        ...
        public UTRiesgosDimensionController()
        {
            _service = new UTRiesgosDimensionServiceFake();
            _controller = new RiesgosDimensionController();
            
             _Objeto = new RiesgosDimension()
            {
                id=0,
ID_CaInfraestructura=1,
ID_Dimension=1,
Riesgo=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            RiesgosDimension v = (RiesgosDimension)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            RiesgosDimension c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<RiesgosDimension>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<RiesgosDimension>(okResult.Value);
            Assert.Equal(i, (okResult.Value as RiesgosDimension).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_CaInfraestructura=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("RiesgosDimension"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new RiesgosDimension() { id = i });
      //
      //      // Assert
