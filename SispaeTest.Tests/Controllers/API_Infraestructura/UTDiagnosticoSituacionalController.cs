...
{
    public  class UTDiagnosticoSituacionalController: ITestCaseOrderer
    {
        private readonly DiagnosticoSituacionalController _controller;
        private readonly IDiagnosticoSituacionalService _service;
        private readonly DiagnosticoSituacional _Objeto;
        ...
        public UTDiagnosticoSituacionalController()
        {
            _service = new UTDiagnosticoSituacionalServiceFake();
            _controller = new DiagnosticoSituacionalController();
            
             _Objeto = new DiagnosticoSituacional()
            {
                id=0,
Nombre="aaa",
FechaActualizacion=DateTime.Now,
DescripcionDiagnostico="a",
PATHDiasnosticoSituacion="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DiagnosticoSituacional v = (DiagnosticoSituacional)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DiagnosticoSituacional c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DiagnosticoSituacional>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DiagnosticoSituacional>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DiagnosticoSituacional).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.Nombre="aaa";
_Objeto.FechaActualizacion=DateTime.Now;
_Objeto.DescripcionDiagnostico="a";
_Objeto.PATHDiasnosticoSituacion="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DiagnosticoSituacional"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DiagnosticoSituacional() { id = i });
      //
      //      // Assert
