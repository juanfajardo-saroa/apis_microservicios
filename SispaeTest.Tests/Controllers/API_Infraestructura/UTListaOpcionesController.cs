...
{
    public  class UTListaOpcionesController: ITestCaseOrderer
    {
        private readonly ListaOpcionesController _controller;
        private readonly IListaOpcionesService _service;
        private readonly ListaOpciones _Objeto;
        ...
        public UTListaOpcionesController()
        {
            _service = new UTListaOpcionesServiceFake();
            _controller = new ListaOpcionesController();
            
             _Objeto = new ListaOpciones()
            {
                id=0,
Lista="a",
Codigo=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ListaOpciones v = (ListaOpciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ListaOpciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ListaOpciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ListaOpciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ListaOpciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ListaOpciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ListaOpciones() { id = i });
      //
      //      // Assert
