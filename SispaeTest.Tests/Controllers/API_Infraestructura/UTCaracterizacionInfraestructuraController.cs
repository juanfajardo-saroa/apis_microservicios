...
using System;
using System.Linq;
using SISPAE_API_Infraestructura.WebAPI.Controllers;
...
{
    public  class UTCaracterizacionInfraestructuraController: ITestCaseOrderer
    {
        private readonly CaracterizacionInfraestructuraController _controller;
        private readonly ICaracterizacionInfraestructuraService _service;
        private readonly CaracterizacionInfraestructura _Objeto;
        ...
        public UTCaracterizacionInfraestructuraController()
        {
            _service = new UTCaracterizacionInfraestructuraServiceFake();
            _controller = new CaracterizacionInfraestructuraController();
            
             _Objeto = new CaracterizacionInfraestructura()
            {
                id=0,
ID_Sede=1,
ID_Inventario=1,
FechaCaracterizacion=DateTime.Now,
FechaModificacion=DateTime.Now,
Descripcion="a",
CHS_Fecha=DateTime.Now,
CHS_Documento=new byte[] { 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
RutaArchivo="a",
auditoria="a",
SuficienciaDotacion=1,
Id_TipoEstadoCaracterizacion=1,
id_TipoModalidadRacionSugerida=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CaracterizacionInfraestructura v = (CaracterizacionInfraestructura)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CaracterizacionInfraestructura c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CaracterizacionInfraestructura>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CaracterizacionInfraestructura>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CaracterizacionInfraestructura).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_Sede=2;
_Objeto.ID_Inventario=2;
_Objeto.FechaCaracterizacion=DateTime.Now;
_Objeto.FechaModificacion=DateTime.Now;
_Objeto.Descripcion="a";
_Objeto.CHS_Fecha=DateTime.Now;
_Objeto.CHS_Documento=new byte[] { 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 };
_Objeto.RutaArchivo="a";
_Objeto.auditoria="a";
_Objeto.SuficienciaDotacion=1;
_Objeto.Id_TipoEstadoCaracterizacion=2;
_Objeto.id_TipoModalidadRacionSugerida=2;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CaracterizacionInfraestructura"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CaracterizacionInfraestructura() { id = i });
      //
      //      // Assert
