...
{
    public  class UTTipoEstadoCaracterizacionController: ITestCaseOrderer
    {
        private readonly TipoEstadoCaracterizacionController _controller;
        private readonly ITipoEstadoCaracterizacionService _service;
        private readonly TipoEstadoCaracterizacion _Objeto;
        ...
        public UTTipoEstadoCaracterizacionController()
        {
            _service = new UTTipoEstadoCaracterizacionServiceFake();
            _controller = new TipoEstadoCaracterizacionController();
            
             _Objeto = new TipoEstadoCaracterizacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoEstadoCaracterizacion v = (TipoEstadoCaracterizacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoEstadoCaracterizacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoEstadoCaracterizacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoEstadoCaracterizacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoEstadoCaracterizacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoEstadoCaracterizacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoEstadoCaracterizacion() { id = i });
      //
      //      // Assert
