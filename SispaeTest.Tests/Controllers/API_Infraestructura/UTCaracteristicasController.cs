...
{
    public  class UTCaracteristicasController: ITestCaseOrderer
    {
        private readonly CaracteristicasController _controller;
        private readonly ICaracteristicasService _service;
        private readonly Caracteristicas _Objeto;
        ...
        public UTCaracteristicasController()
        {
            _service = new UTCaracteristicasServiceFake();
            _controller = new CaracteristicasController();
            
             _Objeto = new Caracteristicas()
            {
                id=0,
ID_Indicador=1,
ID_Escala=1,
...
OrdenPregunta=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Caracteristicas v = (Caracteristicas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Caracteristicas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Caracteristicas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Caracteristicas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Caracteristicas).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Indicador=2;
_Objeto.ID_Escala=2;
_Objeto.Pregunta="a";
_Objeto.auditoria="a";
_Objeto.ID_PreguntaPadre=1;
_Objeto.OrdenPregunta=1;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Caracteristicas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Caracteristicas() { id = i });
      //
      //      // Assert
