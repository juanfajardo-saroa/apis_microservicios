...
{
    public  class UTIndicadoresController: ITestCaseOrderer
    {
        private readonly IndicadoresController _controller;
        private readonly IIndicadoresService _service;
        private readonly Indicadores _Objeto;
        ...
        public UTIndicadoresController()
        {
            _service = new UTIndicadoresServiceFake();
            _controller = new IndicadoresController();
            
             _Objeto = new Indicadores()
            {
                id=0,
ID_Area=1,
Enunciado="a",
...
icono="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Indicadores v = (Indicadores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Indicadores c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Indicadores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Indicadores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Indicadores).id);
        }
...
_Objeto.icono="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Indicadores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Indicadores() { id = i });
      //
      //      // Assert
