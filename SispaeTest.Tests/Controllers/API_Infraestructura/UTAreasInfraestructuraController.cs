...
{
    public  class UTAreasInfraestructuraController: ITestCaseOrderer
    {
        private readonly AreasInfraestructuraController _controller;
        private readonly IAreasInfraestructuraService _service;
        private readonly AreasInfraestructura _Objeto;
        ...
        public UTAreasInfraestructuraController()
        {
            _service = new UTAreasInfraestructuraServiceFake();
            _controller = new AreasInfraestructuraController();
            
             _Objeto = new AreasInfraestructura()
            {
                id=0,
ID_Dimension=1,
Nombre="a",
...
PonderacionCatering=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AreasInfraestructura v = (AreasInfraestructura)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AreasInfraestructura c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AreasInfraestructura>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AreasInfraestructura>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AreasInfraestructura).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Dimension=2;
_Objeto.Nombre="a";
_Objeto.auditoria="a";
_Objeto.icono="a";
_Objeto.PonderacionRps=1;
_Objeto.PonderacionRi=1;
_Objeto.PonderacionCatering=1;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AreasInfraestructura"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AreasInfraestructura() { id = i });
      //
      //      // Assert
