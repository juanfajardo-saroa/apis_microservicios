...
{
    public  class UTDimensionesController: ITestCaseOrderer
    {
        private readonly DimensionesController _controller;
        private readonly IDimensionesService _service;
        private readonly Dimensiones _Objeto;
        ...
        public UTDimensionesController()
        {
            _service = new UTDimensionesServiceFake();
            _controller = new DimensionesController();
            
             _Objeto = new Dimensiones()
            {
                id=0,
Nombre="a",
auditoria="a",
...
Orden=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Dimensiones v = (Dimensiones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Dimensiones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Dimensiones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Dimensiones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Dimensiones).id);
        }
...
_Objeto.Orden=1;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Dimensiones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Dimensiones() { id = i });
      //
      //      // Assert
