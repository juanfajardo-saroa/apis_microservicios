...
{
    public  class UTEntregaViveresController: ITestCaseOrderer
    {
        private readonly EntregaViveresController _controller;
        private readonly IEntregaViveresService _service;
        private readonly EntregaViveres _Objeto;
        ...
        public UTEntregaViveresController()
        {
            _service = new UTEntregaViveresServiceFake();
            _controller = new EntregaViveresController();
            
             _Objeto = new EntregaViveres()
            {
                id=0,
ID_AgrupacionMensual=1,
ID_Producto=1,
ID_EstadoEntrega=1,
ID_TipoTiempoEntrega=1,
ID_AlimentoPlan=1,
CantidadRecibir=1,
FechaEntrega=DateTime.Now,
AlimentoPlanld=1,
ID_FaltanteIntercambio=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            EntregaViveres v = (EntregaViveres)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            EntregaViveres c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<EntregaViveres>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<EntregaViveres>(okResult.Value);
            Assert.Equal(i, (okResult.Value as EntregaViveres).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_AgrupacionMensual=2;
_Objeto.ID_Producto=2;
_Objeto.ID_EstadoEntrega=2;
_Objeto.ID_TipoTiempoEntrega=2;
_Objeto.ID_AlimentoPlan=2;
_Objeto.CantidadRecibir=1;
_Objeto.FechaEntrega=DateTime.Now;
_Objeto.AlimentoPlanld=1;
_Objeto.ID_FaltanteIntercambio=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("EntregaViveres"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new EntregaViveres() { id = i });
      //
      //      // Assert
