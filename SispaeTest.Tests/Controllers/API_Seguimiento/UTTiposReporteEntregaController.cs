...
{
    public  class UTTiposReporteEntregaController: ITestCaseOrderer
    {
        private readonly TiposReporteEntregaController _controller;
        private readonly ITiposReporteEntregaService _service;
        private readonly TiposReporteEntrega _Objeto;
        ...
        public UTTiposReporteEntregaController()
        {
            _service = new UTTiposReporteEntregaServiceFake();
            _controller = new TiposReporteEntregaController();
            
             _Objeto = new TiposReporteEntrega()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposReporteEntrega v = (TiposReporteEntrega)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposReporteEntrega c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposReporteEntrega>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposReporteEntrega>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposReporteEntrega).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposReporteEntrega"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposReporteEntrega() { id = i });
      //
      //      // Assert
