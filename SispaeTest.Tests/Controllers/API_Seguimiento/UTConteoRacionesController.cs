...
{
    public  class UTConteoRacionesController: ITestCaseOrderer
    {
        private readonly ConteoRacionesController _controller;
        private readonly IConteoRacionesService _service;
        private readonly ConteoRaciones _Objeto;
        ...
        public UTConteoRacionesController()
        {
            _service = new UTConteoRacionesServiceFake();
            _controller = new ConteoRacionesController();
            
             _Objeto = new ConteoRaciones()
            {
                id=0,
ID_AgrupacionMensual=1,
ID_TiposModalidadRacion=1,
Conteo=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ConteoRaciones v = (ConteoRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ConteoRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ConteoRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ConteoRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ConteoRaciones).id);
        }
...
_Objeto.ID_TiposModalidadRacion=2;
_Objeto.Conteo=1;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ConteoRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ConteoRaciones() { id = i });
      //
      //      // Assert
