...
{
    public  class UTPoblacionAtendidaController: ITestCaseOrderer
    {
        private readonly PoblacionAtendidaController _controller;
        private readonly IPoblacionAtendidaService _service;
        private readonly PoblacionAtendida _Objeto;
        ...
        public UTPoblacionAtendidaController()
        {
            _service = new UTPoblacionAtendidaServiceFake();
            _controller = new PoblacionAtendidaController();
            
             _Objeto = new PoblacionAtendida()
            {
                id=0,
ID_TipoPoblacionAtendida=1,
ID_TipoPoblacionEtnica=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PoblacionAtendida v = (PoblacionAtendida)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PoblacionAtendida c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PoblacionAtendida>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PoblacionAtendida>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PoblacionAtendida).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoPoblacionAtendida=2;
_Objeto.ID_TipoPoblacionEtnica=2;
_Objeto.ID_AgrupacionMensual=2;
_Objeto.CantidadTitul=1;
_Objeto.CantidadVictima=1;
_Objeto.Cantidad=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PoblacionAtendida"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PoblacionAtendida() { id = i });
      //
      //      // Assert
