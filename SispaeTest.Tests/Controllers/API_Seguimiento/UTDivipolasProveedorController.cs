...
{
    public  class UTDivipolasProveedorController: ITestCaseOrderer
    {
        private readonly DivipolasProveedorController _controller;
        private readonly IDivipolasProveedorService _service;
        private readonly DivipolasProveedor _Objeto;
        ...
        public UTDivipolasProveedorController()
        {
            _service = new UTDivipolasProveedorServiceFake();
            _controller = new DivipolasProveedorController();
            
             _Objeto = new DivipolasProveedor()
            {
                id=0,
ID_Divipolas=1,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DivipolasProveedor v = (DivipolasProveedor)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DivipolasProveedor c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DivipolasProveedor>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DivipolasProveedor>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DivipolasProveedor).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DivipolasProveedor"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DivipolasProveedor() { id = i });
      //
      //      // Assert
