...
{
    public  class UTQuincenaEntregaRacionesController: ITestCaseOrderer
    {
        private readonly QuincenaEntregaRacionesController _controller;
        private readonly IQuincenaEntregaRacionesService _service;
        private readonly QuincenaEntregaRaciones _Objeto;
        ...
        public UTQuincenaEntregaRacionesController()
        {
            _service = new UTQuincenaEntregaRacionesServiceFake();
            _controller = new QuincenaEntregaRacionesController();
            
             _Objeto = new QuincenaEntregaRaciones()
            {
                id=0,
ID_EstadoQuincena=1,
ID_Contrato=1,
...
fechaCarga=DateTime.Now,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            QuincenaEntregaRaciones v = (QuincenaEntregaRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            QuincenaEntregaRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<QuincenaEntregaRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<QuincenaEntregaRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as QuincenaEntregaRaciones).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_EstadoQuincena=2;
_Objeto.ID_Contrato=2;
_Objeto.ID_GradoSedeJornada=2;
_Objeto.auditoria="a";
_Objeto.pathReporteQuincenal="aaa";
_Objeto.fechaCarga=DateTime.Now;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("QuincenaEntregaRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new QuincenaEntregaRaciones() { id = i });
      //
      //      // Assert
