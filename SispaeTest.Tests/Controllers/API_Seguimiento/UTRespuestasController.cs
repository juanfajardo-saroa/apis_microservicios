...
{
    public  class UTRespuestasController: ITestCaseOrderer
    {
        private readonly RespuestasController _controller;
        private readonly IRespuestasService _service;
        private readonly Respuestas _Objeto;
        ...
        public UTRespuestasController()
        {
            _service = new UTRespuestasServiceFake();
            _controller = new RespuestasController();
            
             _Objeto = new Respuestas()
            {
                id=0,
ID_OpcionRespuesta=1,
ID_Diligenciamiento=1,
Respuesta="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Respuestas v = (Respuestas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Respuestas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Respuestas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Respuestas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Respuestas).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_OpcionRespuesta=2;
_Objeto.ID_Diligenciamiento=2;
_Objeto.Respuesta="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Respuestas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Respuestas() { id = i });
      //
      //      // Assert
