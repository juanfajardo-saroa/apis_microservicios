...
{
    public  class UTMunicipioAdquiereServicioController: ITestCaseOrderer
    {
        private readonly MunicipioAdquiereServicioController _controller;
        private readonly IMunicipioAdquiereServicioService _service;
        private readonly MunicipioAdquiereServicio _Objeto;
        ...
        public UTMunicipioAdquiereServicioController()
        {
            _service = new UTMunicipioAdquiereServicioServiceFake();
            _controller = new MunicipioAdquiereServicioController();
            
             _Objeto = new MunicipioAdquiereServicio()
            {
                id=0,
ID_Divipolas=1,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MunicipioAdquiereServicio v = (MunicipioAdquiereServicio)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MunicipioAdquiereServicio c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MunicipioAdquiereServicio>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MunicipioAdquiereServicio>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MunicipioAdquiereServicio).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MunicipioAdquiereServicio"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MunicipioAdquiereServicio() { id = i });
      //
      //      // Assert
