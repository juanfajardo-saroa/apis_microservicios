...
using System;
using System.Linq;
using SISPAE_API_Seguimiento.WebAPI.Controllers;
...
{
    public  class UTFaltantesIntercambiosController: ITestCaseOrderer
    {
        private readonly FaltantesIntercambiosController _controller;
        private readonly IFaltantesIntercambiosService _service;
        private readonly FaltantesIntercambios _Objeto;
        ...
        public UTFaltantesIntercambiosController()
        {
            _service = new UTFaltantesIntercambiosServiceFake();
            _controller = new FaltantesIntercambiosController();
            
             _Objeto = new FaltantesIntercambios()
            {
                id=0,
ID_ProductoIntercambio=1,
ID_EntregaViveres=1,
CantidadRecibida=1,
CantidadNoCoincidePor="a",
CantidadFaltante=1,
CantidadDevuelta=1,
FechaEntregaFaltante=DateTime.Now,
BuenEstado=true,
BuenEmpacado=true,
SinContaminacion=true,
SinExpirar=true,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            FaltantesIntercambios v = (FaltantesIntercambios)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            FaltantesIntercambios c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<FaltantesIntercambios>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<FaltantesIntercambios>(okResult.Value);
            Assert.Equal(i, (okResult.Value as FaltantesIntercambios).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_ProductoIntercambio=2;
_Objeto.ID_EntregaViveres=2;
_Objeto.CantidadRecibida=1;
_Objeto.CantidadNoCoincidePor="a";
_Objeto.CantidadFaltante=1;
_Objeto.CantidadDevuelta=1;
_Objeto.FechaEntregaFaltante=DateTime.Now;
_Objeto.BuenEstado=true;
_Objeto.BuenEmpacado=true;
_Objeto.SinContaminacion=true;
_Objeto.SinExpirar=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("FaltantesIntercambios"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new FaltantesIntercambios() { id = i });
      //
      //      // Assert
