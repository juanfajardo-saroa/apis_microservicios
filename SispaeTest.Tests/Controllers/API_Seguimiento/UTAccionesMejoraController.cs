...
{
    public  class UTAccionesMejoraController: ITestCaseOrderer
    {
        private readonly AccionesMejoraController _controller;
        private readonly IAccionesMejoraService _service;
        private readonly AccionesMejora _Objeto;
        ...
        public UTAccionesMejoraController()
        {
            _service = new UTAccionesMejoraServiceFake();
            _controller = new AccionesMejoraController();
            
             _Objeto = new AccionesMejora()
            {
                ID=0,
ID_Area=1,
ID_Visita=1,
ID_TipoEstadoAccionMejora=1,
...
Acciones="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AccionesMejora v = (AccionesMejora)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AccionesMejora c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AccionesMejora>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AccionesMejora>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AccionesMejora).ID);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_Area=2;
_Objeto.ID_Visita=2;
_Objeto.ID_TipoEstadoAccionMejora=2;
_Objeto.FechaLimite=DateTime.Now;
_Objeto.auditoria="a";
_Objeto.Acciones="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AccionesMejora"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AccionesMejora() { id = i });
      //
      //      // Assert
