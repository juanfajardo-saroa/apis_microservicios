...
{
    public  class UTPreguntasController: ITestCaseOrderer
    {
        private readonly PreguntasController _controller;
        private readonly IPreguntasService _service;
        private readonly Preguntas _Objeto;
        ...
        public UTPreguntasController()
        {
            _service = new UTPreguntasServiceFake();
            _controller = new PreguntasController();
            
             _Objeto = new Preguntas()
            {
                id=0,
ID_Cuestionario=1,
ID_ETC=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Preguntas v = (Preguntas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Preguntas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Preguntas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Preguntas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Preguntas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Preguntas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Preguntas() { id = i });
      //
      //      // Assert
