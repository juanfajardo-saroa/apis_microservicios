...
{
    public class UTEntregasRacionesController : ITestCaseOrderer
    {
        private readonly EntregasRacionesController _controller;
        private readonly IEntregasRacionesService _service;
        private readonly EntregasRaciones _Objeto;
        ...
        public UTEntregasRacionesController()
        {
            _service = new UTEntregasRacionesServiceFake();
            _controller = new EntregasRacionesController();

            _Objeto = new EntregasRaciones()
            {
                id = 0,
                ID_SemanaEntregaRacion = 1,
                ID_TipoReporteEntrega = 1,
                FechaEntrega = DateTime.Now,
                RacionesPreparadas = 1,
                auditoria = "a",
                Justificacion = "a",
                pathDocumentoContrato = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            EntregasRaciones v = (EntregasRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            EntregasRaciones c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<EntregasRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<EntregasRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as EntregasRaciones).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_SemanaEntregaRacion = 2;
            _Objeto.ID_TipoReporteEntrega = 2;
            _Objeto.FechaEntrega = DateTime.Now;
            _Objeto.RacionesPreparadas = 1;
            _Objeto.auditoria = "a";
            _Objeto.Justificacion = "a";
            _Objeto.pathDocumentoContrato = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("EntregasRaciones"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new EntregasRaciones() { id = i });
        //
        //      // Assert
