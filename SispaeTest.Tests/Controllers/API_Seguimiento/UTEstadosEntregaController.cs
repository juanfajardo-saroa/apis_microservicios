...
{
    public  class UTEstadosEntregaController: ITestCaseOrderer
    {
        private readonly EstadosEntregaController _controller;
        private readonly IEstadosEntregaService _service;
        private readonly EstadosEntrega _Objeto;
        ...
        public UTEstadosEntregaController()
        {
            _service = new UTEstadosEntregaServiceFake();
            _controller = new EstadosEntregaController();
            
             _Objeto = new EstadosEntrega()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            EstadosEntrega v = (EstadosEntrega)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            EstadosEntrega c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<EstadosEntrega>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<EstadosEntrega>(okResult.Value);
            Assert.Equal(i, (okResult.Value as EstadosEntrega).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("EstadosEntrega"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new EstadosEntrega() { id = i });
      //
      //      // Assert
