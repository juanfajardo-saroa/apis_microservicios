...
namespace SISPAE.Tests.Controllers
{
    public  class UTCuestionariosController: ITestCaseOrderer
    {
        ...
        public UTCuestionariosController()
        {
            _service = new UTCuestionariosServiceFake();
            _controller = new CuestionariosController();
            
             _Objeto = new Cuestionarios()
            {
                id=0,
Nombre=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Cuestionarios v = (Cuestionarios)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Cuestionarios c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Cuestionarios>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Cuestionarios>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Cuestionarios).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Cuestionarios"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Cuestionarios() { id = i });
      //
      //      // Assert
