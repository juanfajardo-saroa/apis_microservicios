...
namespace SISPAE.Tests.Controllers
{
    public  class UTProveedoresController: ITestCaseOrderer
    {
        ...
        public UTProveedoresController()
        {
            _service = new UTProveedoresServiceFake();
            _controller = new ProveedoresController();
            
             _Objeto = new Proveedores()
            {
                id=0,
ID_DivipolasProveedor=1,
NombreRazonSocial="a",
Nit="a",
NumeroCedula="a",
ImagenCedulaPATH="a",
...
Direccion="a",
ImagenRUTPath="a",
NombreRepresentantelegalId=1,
ApellidoRepresentantelegalId=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Proveedores v = (Proveedores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Proveedores c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Proveedores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Proveedores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Proveedores).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_DivipolasProveedor=2;
_Objeto.NombreRazonSocial="a";
_Objeto.Nit="a";
_Objeto.NumeroCedula="a";
_Objeto.ImagenCedulaPATH="a";
_Objeto.Correo="a";
_Objeto.Telefono="a";
_Objeto.Direccion="a";
_Objeto.ImagenRUTPath="a";
_Objeto.NombreRepresentantelegalId=1;
_Objeto.ApellidoRepresentantelegalId=1;
_Objeto.NumeroIdentificacion=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Proveedores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Proveedores() { id = i });
      //
      //      // Assert
