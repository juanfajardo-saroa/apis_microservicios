...
{
    public  class UTInformacionPresupuestalController: ITestCaseOrderer
    {
        private readonly InformacionPresupuestalController _controller;
        private readonly IInformacionPresupuestalService _service;
        private readonly InformacionPresupuestal _Objeto;
        ...
        public UTInformacionPresupuestalController()
        {
            _service = new UTInformacionPresupuestalServiceFake();
            _controller = new InformacionPresupuestalController();
            
             _Objeto = new InformacionPresupuestal()
            {
                id=0,
ID_contrato=1,
TotalFuentesFinanciacion=1,
PathPDFContrato="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            InformacionPresupuestal v = (InformacionPresupuestal)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            InformacionPresupuestal c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<InformacionPresupuestal>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<InformacionPresupuestal>(okResult.Value);
            Assert.Equal(i, (okResult.Value as InformacionPresupuestal).id);
        }
...
_Objeto.TotalFuentesFinanciacion=1;
_Objeto.PathPDFContrato="a";
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("InformacionPresupuestal"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new InformacionPresupuestal() { id = i });
      //
      //      // Assert
