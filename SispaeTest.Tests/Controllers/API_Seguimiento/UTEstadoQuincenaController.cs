...
{
    public  class UTEstadoQuincenaController: ITestCaseOrderer
    {
        private readonly EstadoQuincenaController _controller;
        private readonly IEstadoQuincenaService _service;
        private readonly EstadoQuincena _Objeto;
        ...
        public UTEstadoQuincenaController()
        {
            _service = new UTEstadoQuincenaServiceFake();
            _controller = new EstadoQuincenaController();
            
             _Objeto = new EstadoQuincena()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            EstadoQuincena v = (EstadoQuincena)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            EstadoQuincena c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<EstadoQuincena>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<EstadoQuincena>(okResult.Value);
            Assert.Equal(i, (okResult.Value as EstadoQuincena).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("EstadoQuincena"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new EstadoQuincena() { id = i });
      //
      //      // Assert
