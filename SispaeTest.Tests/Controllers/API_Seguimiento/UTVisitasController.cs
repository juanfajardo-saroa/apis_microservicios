...
{
    public  class UTVisitasController: ITestCaseOrderer
    {
        private readonly VisitasController _controller;
        private readonly IVisitasService _service;
        private readonly Visitas _Objeto;
        ...
        public UTVisitasController()
        {
            _service = new UTVisitasServiceFake();
            _controller = new VisitasController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Visitas v = (Visitas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Visitas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Visitas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Visitas).id);
        }
...
_Objeto.ID_PlantaBodega=2;
_Objeto.ID_EstadoVisita=2;
_Objeto.ID_TipoVisita=2;
_Objeto.Fecha=DateTime.Now;
_Objeto.Horalnicio=DateTime.Now;
_Objeto.HoraFin=DateTime.Now;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Visitas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Visitas() { id = i });
      //
      //      // Assert
