...
{
    public  class UTDiligenciamientosController: ITestCaseOrderer
    {
        private readonly DiligenciamientosController _controller;
        private readonly IDiligenciamientosService _service;
        private readonly Diligenciamientos _Objeto;
        ...
        public UTDiligenciamientosController()
        {
            _service = new UTDiligenciamientosServiceFake();
            _controller = new DiligenciamientosController();
            
             _Objeto = new Diligenciamientos()
            {
                id=0,
ID_TipoDiligenciamiento=1,
ID_Cuestionario=1,
ID_VisitaControlSocial=1,
ID_Visita=1,
ID_EstadoDiligenciamiento=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Diligenciamientos v = (Diligenciamientos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Diligenciamientos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Diligenciamientos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Diligenciamientos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Diligenciamientos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoDiligenciamiento=1;
_Objeto.ID_Cuestionario=2;
_Objeto.ID_VisitaControlSocial=2;
_Objeto.ID_Visita=2;
_Objeto.ID_EstadoDiligenciamiento=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Diligenciamientos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Diligenciamientos() { id = i });
      //
      //      // Assert
