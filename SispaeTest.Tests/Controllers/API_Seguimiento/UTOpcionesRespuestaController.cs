...
{
    public  class UTOpcionesRespuestaController: ITestCaseOrderer
    {
        private readonly OpcionesRespuestaController _controller;
        private readonly IOpcionesRespuestaService _service;
        private readonly OpcionesRespuesta _Objeto;
        ...
        public UTOpcionesRespuestaController()
        {
            _service = new UTOpcionesRespuestaServiceFake();
            _controller = new OpcionesRespuestaController();
            
             _Objeto = new OpcionesRespuesta()
            {
                id=0,
ID_lndicador=1,
ID_Pregunta=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            OpcionesRespuesta v = (OpcionesRespuesta)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            OpcionesRespuesta c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<OpcionesRespuesta>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<OpcionesRespuesta>(okResult.Value);
            Assert.Equal(i, (okResult.Value as OpcionesRespuesta).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_lndicador=2;
_Objeto.ID_Pregunta=2;
_Objeto.Opcion="a";
_Objeto.ValorPorcentrual=1;
_Objeto.RespuestaPositiva=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("OpcionesRespuesta"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new OpcionesRespuesta() { id = i });
      //
      //      // Assert
