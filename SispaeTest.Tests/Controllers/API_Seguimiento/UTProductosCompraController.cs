...
{
    public  class UTProductosCompraController: ITestCaseOrderer
    {
        private readonly ProductosCompraController _controller;
        private readonly IProductosCompraService _service;
        private readonly ProductosCompra _Objeto;
        ...
        public UTProductosCompraController()
        {
            _service = new UTProductosCompraServiceFake();
            _controller = new ProductosCompraController();
            
             _Objeto = new ProductosCompra()
            {
                id=0,
ID_CompraLocal=1,
ID_TipoProductoCompraLocal=1,
ID_Alimento=1,
ID_TipoAlimento=1,
ID_SubTipoAlimento=1,
ID_MunicipioAdquiereServicio=1,
DescripcionProducto="a",
DescripcionServicio="a",
CantidadComprada=1,
PrecioUnidad=1,
PrecioTotal=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ProductosCompra v = (ProductosCompra)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ProductosCompra c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ProductosCompra>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ProductosCompra>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ProductosCompra).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_CompraLocal=2;
_Objeto.ID_TipoProductoCompraLocal=2;
_Objeto.ID_Alimento=2;
_Objeto.ID_TipoAlimento=2;
_Objeto.ID_SubTipoAlimento=2;
_Objeto.ID_MunicipioAdquiereServicio=2;
_Objeto.DescripcionProducto="a";
_Objeto.DescripcionServicio="a";
_Objeto.CantidadComprada=1;
_Objeto.PrecioUnidad=1;
_Objeto.PrecioTotal=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ProductosCompra"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ProductosCompra() { id = i });
      //
      //      // Assert
