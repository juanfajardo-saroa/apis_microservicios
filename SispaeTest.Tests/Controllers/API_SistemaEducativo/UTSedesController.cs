...
{
    public  class UTSedesController: ITestCaseOrderer
    {
        private readonly SedesController _controller;
        private readonly ISedesService _service;
        private readonly Sedes _Objeto;
        ...
        public UTSedesController()
        {
            _service = new UTSedesServiceFake();
            _controller = new SedesController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Sedes v = (Sedes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Sedes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Sedes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Sedes).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Sedes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Sedes() { id = i });
      //
      //      // Assert
