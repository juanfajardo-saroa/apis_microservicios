...
{
    public  class UTSedesJornadaController: ITestCaseOrderer
    {
        private readonly SedesJornadaController _controller;
        private readonly ISedesJornadaService _service;
        private readonly SedesJornada _Objeto;
        ...
        public UTSedesJornadaController()
        {
            _service = new UTSedesJornadaServiceFake();
            _controller = new SedesJornadaController();
            
             _Objeto = new SedesJornada()
            {
                id=0,
ID_Sede=1,
ID_Jornada=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            SedesJornada v = (SedesJornada)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            SedesJornada c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<SedesJornada>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<SedesJornada>(okResult.Value);
            Assert.Equal(i, (okResult.Value as SedesJornada).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("SedesJornada"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new SedesJornada() { id = i });
      //
      //      // Assert
