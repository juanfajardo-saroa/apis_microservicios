...
{
    public  class UTNivelEducativoController: ITestCaseOrderer
    {
        private readonly NivelEducativoController _controller;
        private readonly INivelEducativoService _service;
        private readonly NivelEducativo _Objeto;
        ...
        public UTNivelEducativoController()
        {
            _service = new UTNivelEducativoServiceFake();
            _controller = new NivelEducativoController();
            
             _Objeto = new NivelEducativo()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            NivelEducativo v = (NivelEducativo)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            NivelEducativo c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<NivelEducativo>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<NivelEducativo>(okResult.Value);
            Assert.Equal(i, (okResult.Value as NivelEducativo).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("NivelEducativo"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new NivelEducativo() { id = i });
      //
      //      // Assert
