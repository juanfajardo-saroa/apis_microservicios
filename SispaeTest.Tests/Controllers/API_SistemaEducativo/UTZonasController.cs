...
{
    public  class UTZonasController: ITestCaseOrderer
    {
        private readonly ZonasController _controller;
        private readonly IZonasService _service;
        private readonly Zonas _Objeto;
        ...
        public UTZonasController()
        {
            _service = new UTZonasServiceFake();
            _controller = new ZonasController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Zonas v = (Zonas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Zonas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Zonas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Zonas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Zonas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Zonas() { id = i });
      //
      //      // Assert
