...
{
    public  class UTGradosController: ITestCaseOrderer
    {
        private readonly GradosController _controller;
        private readonly IGradosService _service;
        private readonly Grados _Objeto;
        ...
        public UTGradosController()
        {
            _service = new UTGradosServiceFake();
            _controller = new GradosController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Grados v = (Grados)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Grados>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Grados>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Grados).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Grados"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Grados() { id = i });
      //
      //      // Assert
