...
{
    public  class UTInstitucionEducativaController: ITestCaseOrderer
    {
        private readonly InstitucionEducativaController _controller;
        private readonly IInstitucionEducativaService _service;
        private readonly InstitucionEducativa _Objeto;
        ...
        public UTInstitucionEducativaController()
        {
            _service = new UTInstitucionEducativaServiceFake();
            _controller = new InstitucionEducativaController();
            
             _Objeto = new InstitucionEducativa()
            {
                id=0,
ID_Rector=1,
ID_ETC=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            InstitucionEducativa v = (InstitucionEducativa)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            InstitucionEducativa c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<InstitucionEducativa>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<InstitucionEducativa>(okResult.Value);
            Assert.Equal(i, (okResult.Value as InstitucionEducativa).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("InstitucionEducativa"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new InstitucionEducativa() { id = i });
      //
      //      // Assert
