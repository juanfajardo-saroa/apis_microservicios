...
using System;
using System.Linq;
using SISPAE_API_SistemaEducativo.WebAPI.Controllers;
...
{
    public  class UTGradosSedesJornadasController: ITestCaseOrderer
    {
        private readonly GradosSedesJornadasController _controller;
        private readonly IGradosSedesJornadasService _service;
        private readonly GradosSedesJornadas _Objeto;
        ...
        public UTGradosSedesJornadasController()
        {
            _service = new UTGradosSedesJornadasServiceFake();
            _controller = new GradosSedesJornadasController();
            
             _Objeto = new GradosSedesJornadas()
            {
                id=0,
ID_SedeJornada=1,
ID_Grado=1,
...
CantlndigVicDis=1,
CantSisbenAB=1,
CantDiscapacitados=1,
CantIndigenasDiscapacidad=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            GradosSedesJornadas v = (GradosSedesJornadas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            GradosSedesJornadas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<GradosSedesJornadas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<GradosSedesJornadas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as GradosSedesJornadas).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_SedeJornada=2;
_Objeto.ID_Grado=2;
_Objeto.Matricula=1;
_Objeto.CantlndigVicDis=1;
_Objeto.CantSisbenAB=1;
_Objeto.CantDiscapacitados=1;
_Objeto.CantIndigenasDiscapacidad=1;
_Objeto.CambioMatricula=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("GradosSedesJornadas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new GradosSedesJornadas() { id = i });
      //
      //      // Assert
