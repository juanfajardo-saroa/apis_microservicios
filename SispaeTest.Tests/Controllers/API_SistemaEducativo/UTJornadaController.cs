...
namespace SISPAE.Tests.Controllers
{
    public  class UTJornadaController: ITestCaseOrderer
    {
        ...
        public UTJornadaController()
        {
            _service = new UTJornadaServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Jornada v = (Jornada)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Jornada>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Jornada>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Jornada).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Jornada"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Jornada() { id = i });
      //
      //      // Assert
