...
{
    public  class UTSedesModelosOperacionController: ITestCaseOrderer
    {
        private readonly SedesModelosOperacionController _controller;
        private readonly ISedesModelosOperacionService _service;
        private readonly SedesModelosOperacion _Objeto;
        ...
        public UTSedesModelosOperacionController()
        {
            _service = new UTSedesModelosOperacionServiceFake();
            _controller = new SedesModelosOperacionController();
            
             _Objeto = new SedesModelosOperacion()
            {
                id=0,
ID_sede=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            SedesModelosOperacion v = (SedesModelosOperacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            SedesModelosOperacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<SedesModelosOperacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<SedesModelosOperacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as SedesModelosOperacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("SedesModelosOperacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new SedesModelosOperacion() { id = i });
      //
      //      // Assert
