...
{
    public  class UTGruposAnalisisController: ITestCaseOrderer
    {
        private readonly GruposAnalisisController _controller;
        private readonly IGruposAnalisisService _service;
        private readonly GruposAnalisis _Objeto;
        ...
        public UTGruposAnalisisController()
        {
            _service = new UTGruposAnalisisServiceFake();
            _controller = new GruposAnalisisController();
            
             _Objeto = new GruposAnalisis()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            GruposAnalisis v = (GruposAnalisis)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            GruposAnalisis c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<GruposAnalisis>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<GruposAnalisis>(okResult.Value);
            Assert.Equal(i, (okResult.Value as GruposAnalisis).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("GruposAnalisis"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new GruposAnalisis() { id = i });
      //
      //      // Assert
