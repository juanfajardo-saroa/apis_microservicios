...
{
    public  class UTAlimentosNoSIPSAController: ITestCaseOrderer
    {
        private readonly AlimentosNoSIPSAController _controller;
        private readonly IAlimentosNoSIPSAService _service;
        private readonly AlimentosNoSIPSA _Objeto;
        ...
        public UTAlimentosNoSIPSAController()
        {
            _service = new UTAlimentosNoSIPSAServiceFake();
            _controller = new AlimentosNoSIPSAController();
            
             _Objeto = new AlimentosNoSIPSA()
            {
                id=0,
ID_AlimentosICBF=1,
ID_ETC=1,
ID_ClasificacionNoSIPSA=1,
CodigoSIPSA="a",
NombreArticulo="a",
ID_TipoUnidad=1,
Cantidad=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosNoSIPSA v = (AlimentosNoSIPSA)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlimentosNoSIPSA c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosNoSIPSA>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosNoSIPSA>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosNoSIPSA).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_AlimentosICBF=2;
_Objeto.ID_ETC=2;
_Objeto.ID_ClasificacionNoSIPSA=2;
_Objeto.CodigoSIPSA="a";
_Objeto.NombreArticulo="a";
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlimentosNoSIPSA"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlimentosNoSIPSA() { id = i });
      //
      //      // Assert
