...
{
    public  class UTNutrientesAlimentosController: ITestCaseOrderer
    {
        private readonly NutrientesAlimentosController _controller;
        private readonly INutrientesAlimentosService _service;
        private readonly NutrientesAlimentos _Objeto;
        ...
        public UTNutrientesAlimentosController()
        {
            _service = new UTNutrientesAlimentosServiceFake();
            _controller = new NutrientesAlimentosController();
            
             _Objeto = new NutrientesAlimentos()
            {
                id=0,
ID_Nutriente=1,
Aporte=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            NutrientesAlimentos v = (NutrientesAlimentos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            NutrientesAlimentos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<NutrientesAlimentos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<NutrientesAlimentos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as NutrientesAlimentos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("NutrientesAlimentos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new NutrientesAlimentos() { id = i });
      //
      //      // Assert
