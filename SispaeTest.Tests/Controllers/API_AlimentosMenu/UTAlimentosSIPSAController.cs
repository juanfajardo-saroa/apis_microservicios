...
{
    public  class UTAlimentosSIPSAController: ITestCaseOrderer
    {
        private readonly AlimentosSIPSAController _controller;
        private readonly IAlimentosSIPSAService _service;
        private readonly AlimentosSIPSA _Objeto;
        ...
        public UTAlimentosSIPSAController()
        {
            _service = new UTAlimentosSIPSAServiceFake();
            _controller = new AlimentosSIPSAController();
            
             _Objeto = new AlimentosSIPSA()
            {
                id=0,
ID_AlimentolCBF=1,
CodigoSIPSA=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosSIPSA v = (AlimentosSIPSA)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlimentosSIPSA c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosSIPSA>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosSIPSA>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosSIPSA).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlimentosSIPSA"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlimentosSIPSA() { id = i });
      //
      //      // Assert
