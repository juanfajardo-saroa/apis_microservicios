...
{
    public  class UTTiposAlimentosController: ITestCaseOrderer
    {
        private readonly TiposAlimentosController _controller;
        private readonly ITiposAlimentosService _service;
        private readonly TiposAlimentos _Objeto;
        ...
        public UTTiposAlimentosController()
        {
            _service = new UTTiposAlimentosServiceFake();
            _controller = new TiposAlimentosController();
            
             _Objeto = new TiposAlimentos()
            {
                id=0,
Nombre=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposAlimentos v = (TiposAlimentos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposAlimentos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposAlimentos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposAlimentos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposAlimentos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposAlimentos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposAlimentos() { id = i });
      //
      //      // Assert
