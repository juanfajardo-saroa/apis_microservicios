...
{
    public  class UTMenusVisitasController: ITestCaseOrderer
    {
        private readonly MenusVisitasController _controller;
        private readonly IMenusVisitasService _service;
        private readonly MenusVisitas _Objeto;
        ...
        public UTMenusVisitasController()
        {
            _service = new UTMenusVisitasServiceFake();
            _controller = new MenusVisitasController();
            
             _Objeto = new MenusVisitas()
            {
                id=0,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MenusVisitas v = (MenusVisitas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MenusVisitas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MenusVisitas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MenusVisitas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MenusVisitas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MenusVisitas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MenusVisitas() { id = i });
      //
      //      // Assert
