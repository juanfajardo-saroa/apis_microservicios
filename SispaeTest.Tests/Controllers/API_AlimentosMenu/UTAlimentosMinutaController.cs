...
using System;
using System.Linq;
using SISPAE_API_AlimentosMenu.WebAPI.Controllers;
...
{
    public class UTAlimentosMinutaController : ITestCaseOrderer
    {
        private readonly AlimentosMinutaController _controller;
        private readonly IAlimentosMinutaService _service;
        private readonly AlimentosMinuta _Objeto;
        ...
        public UTAlimentosMinutaController()
        {
            _service = new UTAlimentosMinutaServiceFake();
            _controller = new AlimentosMinutaController();

            _Objeto = new AlimentosMinuta()
            {
                id = 0,
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosMinuta v = (AlimentosMinuta)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            AlimentosMinuta c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosMinuta>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosMinuta>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosMinuta).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_MinutaPatronAlimento = 2;
            _Objeto.ID_TipoComponente = 2;
            _Objeto.ID_GrupoAlimento = 2;
            _Objeto.frecuencia = 1;
            _Objeto.gramoPesoBruto = 1;
            _Objeto.gramoPesoNeto = 1;
            _Objeto.gramoPesoPorcionServida = 1;
            _Objeto.normativa = "a";
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("AlimentosMinuta"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new AlimentosMinuta() { id = i });
        //
        //      // Assert
