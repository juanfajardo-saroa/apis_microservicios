...
{
    public  class UTTiposRacionController: ITestCaseOrderer
    {
        private readonly TiposRacionController _controller;
        private readonly ITiposRacionService _service;
        private readonly TiposRacion _Objeto;
        ...
        public UTTiposRacionController()
        {
            _service = new UTTiposRacionServiceFake();
            _controller = new TiposRacionController();
            
             _Objeto = new TiposRacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposRacion v = (TiposRacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposRacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposRacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposRacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposRacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposRacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposRacion() { id = i });
      //
      //      // Assert
