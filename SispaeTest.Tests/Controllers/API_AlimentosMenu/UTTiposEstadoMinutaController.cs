...
{
    public  class UTTiposEstadoMinutaController: ITestCaseOrderer
    {
        private readonly TiposEstadoMinutaController _controller;
        private readonly ITiposEstadoMinutaService _service;
        private readonly TiposEstadoMinuta _Objeto;
        ...
        public UTTiposEstadoMinutaController()
        {
            _service = new UTTiposEstadoMinutaServiceFake();
            _controller = new TiposEstadoMinutaController();
            
             _Objeto = new TiposEstadoMinuta()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadoMinuta v = (TiposEstadoMinuta)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadoMinuta c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadoMinuta>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadoMinuta>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadoMinuta).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadoMinuta"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadoMinuta() { id = i });
      //
      //      // Assert
