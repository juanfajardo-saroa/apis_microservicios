...
{
    public  class UTClasificacionesNoSIPSAController: ITestCaseOrderer
    {
        private readonly ClasificacionesNoSIPSAController _controller;
        private readonly IClasificacionesNoSIPSAService _service;
        private readonly ClasificacionesNoSIPSA _Objeto;
        ...
        public UTClasificacionesNoSIPSAController()
        {
            _service = new UTClasificacionesNoSIPSAServiceFake();
            _controller = new ClasificacionesNoSIPSAController();
            
             _Objeto = new ClasificacionesNoSIPSA()
            {
                id=0,
Nombre="aaa",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ClasificacionesNoSIPSA v = (ClasificacionesNoSIPSA)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ClasificacionesNoSIPSA c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ClasificacionesNoSIPSA>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ClasificacionesNoSIPSA>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ClasificacionesNoSIPSA).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ClasificacionesNoSIPSA"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ClasificacionesNoSIPSA() { id = i });
      //
      //      // Assert
