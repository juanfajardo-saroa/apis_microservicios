...
{
    public  class UTTiposMenuController: ITestCaseOrderer
    {
        private readonly TiposMenuController _controller;
        private readonly ITiposMenuService _service;
        private readonly TiposMenu _Objeto;
        ...
        public UTTiposMenuController()
        {
            _service = new UTTiposMenuServiceFake();
            _controller = new TiposMenuController();
            
             _Objeto = new TiposMenu()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposMenu v = (TiposMenu)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposMenu c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposMenu>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposMenu>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposMenu).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposMenu"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposMenu() { id = i });
      //
      //      // Assert
