...
{
    public  class UTTiposNutrientesController: ITestCaseOrderer
    {
        private readonly TiposNutrientesController _controller;
        private readonly ITiposNutrientesService _service;
        private readonly TiposNutrientes _Objeto;
        ...
        public UTTiposNutrientesController()
        {
            _service = new UTTiposNutrientesServiceFake();
            _controller = new TiposNutrientesController();
            
             _Objeto = new TiposNutrientes()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposNutrientes v = (TiposNutrientes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposNutrientes c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposNutrientes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposNutrientes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposNutrientes).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposNutrientes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposNutrientes() { id = i });
      //
      //      // Assert
