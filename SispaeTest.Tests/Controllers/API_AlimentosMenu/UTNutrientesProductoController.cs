...
{
    public  class UTNutrientesProductoController: ITestCaseOrderer
    {
        private readonly NutrientesProductoController _controller;
        private readonly INutrientesProductoService _service;
        private readonly NutrientesProducto _Objeto;
        ...
        public UTNutrientesProductoController()
        {
            _service = new UTNutrientesProductoServiceFake();
            _controller = new NutrientesProductoController();
            
             _Objeto = new NutrientesProducto()
            {
                id=0,
ID_Nutriente=1,
Aporte=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            NutrientesProducto v = (NutrientesProducto)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            NutrientesProducto c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<NutrientesProducto>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<NutrientesProducto>(okResult.Value);
            Assert.Equal(i, (okResult.Value as NutrientesProducto).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("NutrientesProducto"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new NutrientesProducto() { id = i });
      //
      //      // Assert
