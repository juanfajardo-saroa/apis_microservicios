...
namespace SISPAE.Tests.Controllers
    {
    public class UTGrupoAlimentosController : ITestCaseOrderer
        {
        private readonly GrupoAlimentosController _controller;
        private readonly IGrupoAlimentosService _service;
        private readonly GrupoAlimentos _Objeto;
        ...
        public UTGrupoAlimentosController()
            {
            _service = new UTGrupoAlimentosServiceFake();
            _controller = new GrupoAlimentosController();

            _Objeto = new GrupoAlimentos()
                {
                id = 0,
                Nombre = "A",
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
            ...
            GrupoAlimentos v = (GrupoAlimentos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
            ...
            //Obtenemos un objeto
            GrupoAlimentos c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
            ...
            var i = (IEnumerable<GrupoAlimentos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
            ...
            // Assert
            Assert.IsType<GrupoAlimentos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as GrupoAlimentos).id);
            }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("GrupoAlimentos"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new GrupoAlimentos() { id = i });
        //
        //      // Assert
