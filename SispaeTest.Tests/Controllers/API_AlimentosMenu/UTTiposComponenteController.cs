...
{
    public class UTTiposComponenteController : ITestCaseOrderer
    {
        private readonly TiposComponenteController _controller;
        private readonly ITiposComponenteService _service;
        private readonly TiposComponente _Objeto;
        ...
        public UTTiposComponenteController()
        {
            _service = new UTTiposComponenteServiceFake();
            _controller = new TiposComponenteController();

            _Objeto = new TiposComponente()
            {
                id = 0,
                Nombre = "a",
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            TiposComponente v = (TiposComponente)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            TiposComponente c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposComponente>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposComponente>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposComponente).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("TiposComponente"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new TiposComponente() { id = i });
        //
        //      // Assert
