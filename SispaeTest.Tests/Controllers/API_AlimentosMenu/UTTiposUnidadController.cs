...
{
    public  class UTTiposUnidadController: ITestCaseOrderer
    {
        private readonly TiposUnidadController _controller;
        private readonly ITiposUnidadService _service;
        private readonly TiposUnidad _Objeto;
        ...
        public UTTiposUnidadController()
        {
            _service = new UTTiposUnidadServiceFake();
            _controller = new TiposUnidadController();
            
             _Objeto = new TiposUnidad()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposUnidad v = (TiposUnidad)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposUnidad c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposUnidad>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposUnidad>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposUnidad).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposUnidad"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposUnidad() { id = i });
      //
      //      // Assert
