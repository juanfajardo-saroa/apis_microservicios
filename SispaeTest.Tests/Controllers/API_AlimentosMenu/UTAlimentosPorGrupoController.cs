...
{
    public  class UTAlimentosPorGrupoController: ITestCaseOrderer
    {
        private readonly AlimentosPorGrupoController _controller;
        private readonly IAlimentosPorGrupoService _service;
        private readonly AlimentosPorGrupo _Objeto;
        ...
        public UTAlimentosPorGrupoController()
        {
            _service = new UTAlimentosPorGrupoServiceFake();
            _controller = new AlimentosPorGrupoController();
            
             _Objeto = new AlimentosPorGrupo()
            {
                id=0,
ID_TipoComponente=1,
ID_Menu=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosPorGrupo v = (AlimentosPorGrupo)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlimentosPorGrupo c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosPorGrupo>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosPorGrupo>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosPorGrupo).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlimentosPorGrupo"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlimentosPorGrupo() { id = i });
      //
      //      // Assert
