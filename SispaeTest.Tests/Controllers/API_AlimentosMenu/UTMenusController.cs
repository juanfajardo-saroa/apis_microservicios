...
namespace SISPAE.Tests.Controllers
{
    public  class UTMenusController: ITestCaseOrderer
    {
        ...
        public UTMenusController()
        {
            _service = new UTMenusServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Menus v = (Menus)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Menus>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Menus>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Menus).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoMenu=2;
_Objeto.ID_TipoRacion=2;
_Objeto.ID_ETC=2;
_Objeto.TotalCostoMenu=1;
_Objeto.CostoTransporte=1;
_Objeto.CostoAlimentos=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Menus"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Menus() { id = i });
      //
      //      // Assert
