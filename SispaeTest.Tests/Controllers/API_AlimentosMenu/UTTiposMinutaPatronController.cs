...
{
    public  class UTTiposMinutaPatronController: ITestCaseOrderer
    {
        private readonly TiposMinutaPatronController _controller;
        private readonly ITiposMinutaPatronService _service;
        private readonly TiposMinutaPatron _Objeto;
        ...
        public UTTiposMinutaPatronController()
        {
            _service = new UTTiposMinutaPatronServiceFake();
            _controller = new TiposMinutaPatronController();
            
             _Objeto = new TiposMinutaPatron()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposMinutaPatron v = (TiposMinutaPatron)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposMinutaPatron c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposMinutaPatron>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposMinutaPatron>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposMinutaPatron).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposMinutaPatron"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposMinutaPatron() { id = i });
      //
      //      // Assert
