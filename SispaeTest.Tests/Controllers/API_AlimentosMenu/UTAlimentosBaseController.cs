...
{
    public  class UTAlimentosBaseController: ITestCaseOrderer
    {
        private readonly AlimentosBaseController _controller;
        private readonly IAlimentosBaseService _service;
        private readonly AlimentosBase _Objeto;
        ...
        public UTAlimentosBaseController()
        {
            _service = new UTAlimentosBaseServiceFake();
            _controller = new AlimentosBaseController();
            
             _Objeto = new AlimentosBase()
            {
                id=0,
ID_TipoComponente=1,
ID_TipoRacion=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosBase v = (AlimentosBase)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlimentosBase c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosBase>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosBase>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosBase).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlimentosBase"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlimentosBase() { id = i });
      //
      //      // Assert
