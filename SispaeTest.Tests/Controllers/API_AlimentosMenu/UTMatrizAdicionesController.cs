...
{
    public  class UTMatrizAdicionesController: ITestCaseOrderer
    {
        private readonly MatrizAdicionesController _controller;
        private readonly IMatrizAdicionesService _service;
        private readonly MatrizAdiciones _Objeto;
        ...
        public UTMatrizAdicionesController()
        {
            _service = new UTMatrizAdicionesServiceFake();
            _controller = new MatrizAdicionesController();
            
             _Objeto = new MatrizAdiciones()
            {
                id=0,
ID_TipoRacion=1,
ID_AlimentolCBF=1,
ID_Adicion=1,
ID_ComponentesAdicion=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MatrizAdiciones v = (MatrizAdiciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MatrizAdiciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MatrizAdiciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MatrizAdiciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MatrizAdiciones).id);
        }
...
_Objeto.ID_AlimentolCBF=2;
_Objeto.ID_Adicion=2;
_Objeto.ID_ComponentesAdicion=2;
_Objeto.ID_TipoGrupoEtario=2;
_Objeto.CodigoSIPSA=1;
_Objeto.PesoNeto=1;
_Objeto.PesoBruto=1;
_Objeto.PesoServido=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MatrizAdiciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MatrizAdiciones() { id = i });
      //
      //      // Assert
