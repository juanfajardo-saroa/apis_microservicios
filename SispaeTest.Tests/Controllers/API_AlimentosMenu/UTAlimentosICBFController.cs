...
{
    public  class UTAlimentosICBFController: ITestCaseOrderer
    {
        private readonly AlimentosICBFController _controller;
        private readonly IAlimentosICBFService _service;
        private readonly AlimentosICBF _Objeto;
        ...
        public UTAlimentosICBFController()
        {
            _service = new UTAlimentosICBFServiceFake();
            _controller = new AlimentosICBFController();
            
             _Objeto = new AlimentosICBF()
            {
                id=0,
ID_GrupoAlimento=1,
ID_TipoAlimento=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosICBF v = (AlimentosICBF)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlimentosICBF c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosICBF>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosICBF>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosICBF).id);
        }
...
_Objeto.CodigolCBF="a";
_Objeto.CienGramos=1;
_Objeto.CienGramosPN=1;
_Objeto.CienGramosPS=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlimentosICBF"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlimentosICBF() { id = i });
      //
      //      // Assert
