...
{
    public  class UTComponenteAdicionController: ITestCaseOrderer
    {
        private readonly ComponenteAdicionController _controller;
        private readonly IComponenteAdicionService _service;
        private readonly ComponenteAdicion _Objeto;
        ...
        public UTComponenteAdicionController()
        {
            _service = new UTComponenteAdicionServiceFake();
            _controller = new ComponenteAdicionController();
            
             _Objeto = new ComponenteAdicion()
            {
                id=0,
ID_Adicion=1,
ID_AlimentoSIPSA=1,
ID_AlimentoNoSIPSA=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ComponenteAdicion v = (ComponenteAdicion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ComponenteAdicion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ComponenteAdicion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ComponenteAdicion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ComponenteAdicion).id);
        }
...
_Objeto.ID_AlimentoSIPSA=2;
_Objeto.ID_AlimentoNoSIPSA=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ComponenteAdicion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ComponenteAdicion() { id = i });
      //
      //      // Assert
