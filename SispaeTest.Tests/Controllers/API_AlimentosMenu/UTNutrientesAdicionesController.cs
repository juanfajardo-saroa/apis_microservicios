...
{
    public  class UTNutrientesAdicionesController: ITestCaseOrderer
    {
        private readonly NutrientesAdicionesController _controller;
        private readonly INutrientesAdicionesService _service;
        private readonly NutrientesAdiciones _Objeto;
        ...
        public UTNutrientesAdicionesController()
        {
            _service = new UTNutrientesAdicionesServiceFake();
            _controller = new NutrientesAdicionesController();
            
             _Objeto = new NutrientesAdiciones()
            {
                id=0,
ID_Nutriente=1,
Aporte=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            NutrientesAdiciones v = (NutrientesAdiciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            NutrientesAdiciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<NutrientesAdiciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<NutrientesAdiciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as NutrientesAdiciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("NutrientesAdiciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new NutrientesAdiciones() { id = i });
      //
      //      // Assert
