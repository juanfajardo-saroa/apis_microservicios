...
{
    public class UTNutrientesController : ITestCaseOrderer
    {
        private readonly NutrientesController _controller;
        private readonly INutrientesService _service;
        private readonly Nutrientes _Objeto;
        ...
        public UTNutrientesController()
        {
            _service = new UTNutrientesServiceFake();
            _controller = new NutrientesController();

            _Objeto = new Nutrientes()
            {
                id = 0,
                ID_tiponutriente = 1,
                Nombre = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            Nutrientes v = (Nutrientes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            Nutrientes c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Nutrientes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Nutrientes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Nutrientes).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("Nutrientes"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new Nutrientes() { id = i });
        //
        //      // Assert
