...
{
    public  class UTAdicionesController: ITestCaseOrderer
    {
        private readonly AdicionesController _controller;
        private readonly IAdicionesService _service;
        private readonly Adiciones _Objeto;
        ...
        public UTAdicionesController()
        {
            _service = new UTAdicionesServiceFake();
            _controller = new AdicionesController();
            
             _Objeto = new Adiciones()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Adiciones v = (Adiciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Adiciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Adiciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Adiciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Adiciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Adiciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Adiciones() { id = i });
      //
      //      // Assert
