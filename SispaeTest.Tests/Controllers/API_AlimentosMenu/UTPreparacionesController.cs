...
{
    public  class UTPreparacionesController: ITestCaseOrderer
    {
        private readonly PreparacionesController _controller;
        private readonly IPreparacionesService _service;
        private readonly Preparaciones _Objeto;
        ...
        public UTPreparacionesController()
        {
            _service = new UTPreparacionesServiceFake();
            _controller = new PreparacionesController();
            
             _Objeto = new Preparaciones()
            {
                id=0,
ID_AlimentosBase=1,
ID_Adicion=1,
Nombre="a",
PrecioTotal=1,
TieneLeguminosa=true,
AgregadoOperador=true,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Preparaciones v = (Preparaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Preparaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Preparaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Preparaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Preparaciones).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_AlimentosBase=2;
_Objeto.ID_Adicion=2;
_Objeto.Nombre="a";
_Objeto.PrecioTotal=1;
_Objeto.TieneLeguminosa=true;
_Objeto.AgregadoOperador=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Preparaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Preparaciones() { id = i });
      //
      //      // Assert
