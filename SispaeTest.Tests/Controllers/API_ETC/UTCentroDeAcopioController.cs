...
{
    public  class UTCentroDeAcopioController: ITestCaseOrderer
    {
        private readonly CentroDeAcopioController _controller;
        private readonly ICentroDeAcopioService _service;
        private readonly CentroDeAcopio _Objeto;
        ...
        public UTCentroDeAcopioController()
        {
            _service = new UTCentroDeAcopioServiceFake();
            _controller = new CentroDeAcopioController();
            
             _Objeto = new CentroDeAcopio()
            {
                id=0,
ID_CPobladosZona=1,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CentroDeAcopio v = (CentroDeAcopio)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CentroDeAcopio c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CentroDeAcopio>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CentroDeAcopio>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CentroDeAcopio).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CentroDeAcopio"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CentroDeAcopio() { id = i });
      //
      //      // Assert
