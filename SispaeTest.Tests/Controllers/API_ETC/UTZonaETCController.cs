...
{
    public  class UTZonaETCController: ITestCaseOrderer
    {
        private readonly ZonaETCController _controller;
        private readonly IZonaETCService _service;
        private readonly ZonaETC _Objeto;
        ...
        public UTZonaETCController()
        {
            _service = new UTZonaETCServiceFake();
            _controller = new ZonaETCController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ZonaETC v = (ZonaETC)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ZonaETC>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ZonaETC>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ZonaETC).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ZonaETC"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ZonaETC() { id = i });
      //
      //      // Assert
