...
{
    public class UTDiasPAEController : ITestCaseOrderer
    {
        private readonly DiasPAEController _controller;
        private readonly IDiasPAEService _service;
        private readonly DiasPAE _Objeto;
        ...
        public UTDiasPAEController()
        {
            _service = new UTDiasPAEServiceFake();
            _controller = new DiasPAEController();
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            DiasPAE v = (DiasPAE)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DiasPAE>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DiasPAE>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DiasPAE).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("DiasPAE"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new DiasPAE() { id = i });
        //
        //      // Assert
