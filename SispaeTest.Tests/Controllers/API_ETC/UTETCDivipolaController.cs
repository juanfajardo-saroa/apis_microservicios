...
{
    public  class UTETCDivipolaController: ITestCaseOrderer
    {
        private readonly ETCDivipolaController _controller;
        private readonly IETCDivipolaService _service;
        private readonly ETCDivipola _Objeto;
        ...
        public UTETCDivipolaController()
        {
            _service = new UTETCDivipolaServiceFake();
            _controller = new ETCDivipolaController();
            
             _Objeto = new ETCDivipola()
            {
                id=0,
ID_ETC=1,
ID_DiviPola=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ETCDivipola v = (ETCDivipola)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ETCDivipola c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ETCDivipola>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ETCDivipola>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ETCDivipola).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ETCDivipola"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ETCDivipola() { id = i });
      //
      //      // Assert
