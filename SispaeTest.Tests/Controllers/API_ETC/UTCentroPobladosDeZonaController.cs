...
using System;
using System.Linq;
using SISPAE_API_ETC.WebAPI.Controllers;
...
{
    public class UTCentroPobladosDeZonaController : ITestCaseOrderer
    {
        private readonly CentroPobladosDeZonaController _controller;
        private readonly ICentroPobladosDeZonaService _service;
        private readonly CentroPobladosDeZona _Objeto;
        ...
        public UTCentroPobladosDeZonaController()
        {
            _service = new UTCentroPobladosDeZonaServiceFake();
            _controller = new CentroPobladosDeZonaController();

            _Objeto = new CentroPobladosDeZona()
            {
                id = 0,
                ID_DiviPola = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            CentroPobladosDeZona v = (CentroPobladosDeZona)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            CentroPobladosDeZona c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CentroPobladosDeZona>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CentroPobladosDeZona>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CentroPobladosDeZona).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("CentroPobladosDeZona"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new CentroPobladosDeZona() { id = i });
        //
        //      // Assert
