...
{
    public  class UTRectoresController: ITestCaseOrderer
    {
        private readonly RectoresController _controller;
        private readonly IRectoresService _service;
        private readonly Rectores _Objeto;
        ...
        public UTRectoresController()
        {
            _service = new UTRectoresServiceFake();
            _controller = new RectoresController();
            
             _Objeto = new Rectores()
            {
                id=0,
ID_User=1,
Nombre="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Rectores v = (Rectores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Rectores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Rectores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Rectores).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Rectores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Rectores() { id = i });
      //
      //      // Assert
