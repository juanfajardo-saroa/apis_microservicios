...
{
    public  class UTImpuestosController: ITestCaseOrderer
    {
        private readonly ImpuestosController _controller;
        private readonly IImpuestosService _service;
        private readonly Impuestos _Objeto;
        ...
        public UTImpuestosController()
        {
            _service = new UTImpuestosServiceFake();
            _controller = new ImpuestosController();
            
             _Objeto = new Impuestos()
            {
                id=0,
ID_ETC=1,
Nombre="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Impuestos v = (Impuestos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Impuestos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Impuestos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Impuestos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Impuestos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Impuestos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Impuestos() { id = i });
      //
      //      // Assert
