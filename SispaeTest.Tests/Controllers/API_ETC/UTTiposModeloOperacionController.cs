...
{
    public  class UTTiposModeloOperacionController: ITestCaseOrderer
    {
        private readonly TiposModeloOperacionController _controller;
        private readonly ITiposModeloOperacionService _service;
        private readonly TiposModeloOperacion _Objeto;
        ...
        public UTTiposModeloOperacionController()
        {
            _service = new UTTiposModeloOperacionServiceFake();
            _controller = new TiposModeloOperacionController();
            
             _Objeto = new TiposModeloOperacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposModeloOperacion v = (TiposModeloOperacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposModeloOperacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposModeloOperacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposModeloOperacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposModeloOperacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposModeloOperacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposModeloOperacion() { id = i });
      //
      //      // Assert
