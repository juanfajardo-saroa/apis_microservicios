...
{
    public  class UTETCController: ITestCaseOrderer
    {
        private readonly ETCController _controller;
        private readonly IETCService _service;
        private readonly ETC _Objeto;
        ...
        public UTETCController()
        {
            _service = new UTETCServiceFake();
            _controller = new ETCController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ETC v = (ETC)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ETC>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ETC>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ETC).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ETC"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ETC() { id = i });
      //
      //      // Assert
