...
{
    public  class UTETController: ITestCaseOrderer
    {
        private readonly ETController _controller;
        private readonly IETService _service;
        private readonly ET _Objeto;
        ...
        public UTETController()
        {
            _service = new UTETServiceFake();
            _controller = new ETController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ET v = (ET)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ET>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ET>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ET).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ET"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ET() { id = i });
      //
      //      // Assert
