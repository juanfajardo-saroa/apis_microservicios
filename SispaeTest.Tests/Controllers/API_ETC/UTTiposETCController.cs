...
{
    public  class UTTiposETCController: ITestCaseOrderer
    {
        private readonly TiposETCController _controller;
        private readonly ITiposETCService _service;
        private readonly TiposETC _Objeto;
        ...
        public UTTiposETCController()
        {
            _service = new UTTiposETCServiceFake();
            _controller = new TiposETCController();
            
             _Objeto = new TiposETC()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposETC v = (TiposETC)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposETC>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposETC>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposETC).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposETC"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposETC() { id = i });
      //
      //      // Assert
