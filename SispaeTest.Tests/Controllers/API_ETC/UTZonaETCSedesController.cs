...
{
    public  class UTZonaETCSedesController: ITestCaseOrderer
    {
        private readonly ZonaETCSedesController _controller;
        private readonly IZonaETCSedesService _service;
        private readonly ZonaETCSedes _Objeto;
        ...
        public UTZonaETCSedesController()
        {
            _service = new UTZonaETCSedesServiceFake();
            _controller = new ZonaETCSedesController();
            
             _Objeto = new ZonaETCSedes()
            {
                id=0,
ID_ZonaETC=1,
ID_Sedes=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ZonaETCSedes v = (ZonaETCSedes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ZonaETCSedes c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ZonaETCSedes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ZonaETCSedes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ZonaETCSedes).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ZonaETCSedes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ZonaETCSedes() { id = i });
      //
      //      // Assert
