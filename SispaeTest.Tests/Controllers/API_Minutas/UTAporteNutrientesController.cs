...
{
    public  class UTAporteNutrientesController: ITestCaseOrderer
    {
        private readonly AporteNutrientesController _controller;
        private readonly IAporteNutrientesService _service;
        private readonly AporteNutrientes _Objeto;
        ...
        public UTAporteNutrientesController()
        {
            _service = new UTAporteNutrientesServiceFake();
            _controller = new AporteNutrientesController();
            
             _Objeto = new AporteNutrientes()
            {
                id=0,
ID_AporteNutricional=1,
ID_Nutriente=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AporteNutrientes v = (AporteNutrientes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AporteNutrientes c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AporteNutrientes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AporteNutrientes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AporteNutrientes).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_AporteNutricional=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AporteNutrientes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AporteNutrientes() { id = i });
      //
      //      // Assert
