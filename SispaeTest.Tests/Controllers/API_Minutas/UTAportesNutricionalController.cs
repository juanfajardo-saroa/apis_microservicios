...
using System;
using System.Linq;
using SISPAE_API_Minutas.WebAPI.Controllers;
...
{
    public class UTAportesNutricionalController : ITestCaseOrderer
    {
        private readonly AportesNutricionalController _controller;
        private readonly IAportesNutricionalService _service;
        private readonly AportesNutricional _Objeto;
        ...
        public UTAportesNutricionalController()
        {
            _service = new UTAportesNutricionalServiceFake();
            _controller = new AportesNutricionalController();

            _Objeto = new AportesNutricional()
            {
                id = 0,
                ID_MinutaPatronAlimento = 1,
                PorcentajeAdecuacion = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            AportesNutricional v = (AportesNutricional)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            AportesNutricional c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AportesNutricional>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AportesNutricional>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AportesNutricional).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.AporteMinimoRecomendado = 1;
            _Objeto.PorcentajeAdecuacion = 1;
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("AportesNutricional"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new AportesNutricional() { id = i });
        //
        //      // Assert
