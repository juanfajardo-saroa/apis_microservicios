...
{
    public  class UTReglasValidacionController: ITestCaseOrderer
    {
        private readonly ReglasValidacionController _controller;
        private readonly IReglasValidacionService _service;
        private readonly ReglasValidacion _Objeto;
        ...
        public UTReglasValidacionController()
        {
            _service = new UTReglasValidacionServiceFake();
            _controller = new ReglasValidacionController();
            
             _Objeto = new ReglasValidacion()
            {
                id=0,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ReglasValidacion v = (ReglasValidacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ReglasValidacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ReglasValidacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ReglasValidacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ReglasValidacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ReglasValidacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ReglasValidacion() { id = i });
      //
      //      // Assert
