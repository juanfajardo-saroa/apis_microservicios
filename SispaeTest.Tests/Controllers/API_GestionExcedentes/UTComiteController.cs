...
{
    public  class UTComiteController: ITestCaseOrderer
    {
        private readonly ComiteController _controller;
        private readonly IComiteService _service;
        private readonly Comite _Objeto;
        ...
        public UTComiteController()
        {
            _service = new UTComiteServiceFake();
            _controller = new ComiteController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Comite v = (Comite)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Comite>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Comite>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Comite).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_lE=2;
_Objeto.ID_Rector=2;
_Objeto.NombreComite="a";
_Objeto.Fecha=DateTime.Now;
_Objeto.DecisionesTomadas=1;
_Objeto.ActaFormalizacionPath=1;
_Objeto.PlanTrabajoPath=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Comite"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Comite() { id = i });
      //
      //      // Assert
