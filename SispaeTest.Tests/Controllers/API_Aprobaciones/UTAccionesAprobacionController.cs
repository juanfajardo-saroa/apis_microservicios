...
{
    public  class UTAccionesAprobacionController: ITestCaseOrderer
    {
        private readonly AccionesAprobacionController _controller;
        private readonly IAccionesAprobacionService _service;
        private readonly AccionesAprobacion _Objeto;
        ...
        public UTAccionesAprobacionController()
        {
            _service = new UTAccionesAprobacionServiceFake();
            _controller = new AccionesAprobacionController();
            
             _Objeto = new AccionesAprobacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AccionesAprobacion v = (AccionesAprobacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AccionesAprobacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AccionesAprobacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AccionesAprobacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AccionesAprobacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AccionesAprobacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AccionesAprobacion() { id = i });
      //
      //      // Assert
