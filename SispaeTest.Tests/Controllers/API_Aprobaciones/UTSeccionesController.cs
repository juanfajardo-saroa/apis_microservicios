...
{
    public  class UTSeccionesController: ITestCaseOrderer
    {
        private readonly SeccionesController _controller;
        private readonly ISeccionesService _service;
        private readonly Secciones _Objeto;
        ...
        public UTSeccionesController()
        {
            _service = new UTSeccionesServiceFake();
            _controller = new SeccionesController();
            
             _Objeto = new Secciones()
            {
                id=0,
Nombre="a",
id_Submodulos=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Secciones v = (Secciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Secciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Secciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Secciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Secciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Secciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Secciones() { id = i });
      //
      //      // Assert
