...
using System;
using System.Linq;
using SISPAE_API_Aprobaciones.WebAPI.Controllers;
...
namespace SISPAE.Tests.Controllers
{
    public  class UTAprobacionesController: ITestCaseOrderer
    {
        ...
        public UTAprobacionesController()
        {
            _service = new UTAprobacionesServiceFake();
            _controller = new AprobacionesController();
            
             _Objeto = new Aprobaciones()
            {
                id=0,
ID_ETC=1,
ID_User="8",
ID_AccionAprobacion=1,
Id_Secciones=1,
DocumentoParaAprobar="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Aprobaciones v = (Aprobaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Aprobaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Aprobaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Aprobaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Aprobaciones).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_ETC=2;
_Objeto.ID_User="2";
_Objeto.ID_AccionAprobacion=2;
_Objeto.Id_Secciones=2;
_Objeto.DocumentoParaAprobar="a";
_Objeto.FechaAprobacion=DateTime.Now;
_Objeto.Fecha=DateTime.Now;
_Objeto.Accion="a";
_Objeto.Observaciones="a";
_Objeto.Id_Ubicacion=2;
_Objeto.UbicacionOrigen="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Aprobaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Aprobaciones() { id = i });
      //
      //      // Assert
