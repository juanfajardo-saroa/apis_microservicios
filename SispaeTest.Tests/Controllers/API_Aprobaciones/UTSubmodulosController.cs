...
{
    public  class UTSubmodulosController: ITestCaseOrderer
    {
        private readonly SubmodulosController _controller;
        private readonly ISubmodulosService _service;
        private readonly Submodulos _Objeto;
        ...
        public UTSubmodulosController()
        {
            _service = new UTSubmodulosServiceFake();
            _controller = new SubmodulosController();
            
             _Objeto = new Submodulos()
            {
                id=0,
Nombre="a",
id_Subsistemas=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Submodulos v = (Submodulos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Submodulos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Submodulos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Submodulos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Submodulos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Submodulos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Submodulos() { id = i });
      //
      //      // Assert
