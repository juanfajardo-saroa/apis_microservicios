...
{
    public  class UTUbicacionesController: ITestCaseOrderer
    {
        private readonly UbicacionesController _controller;
        private readonly IUbicacionesService _service;
        private readonly Ubicaciones _Objeto;
        ...
        public UTUbicacionesController()
        {
            _service = new UTUbicacionesServiceFake();
            _controller = new UbicacionesController();
            
             _Objeto = new Ubicaciones()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Ubicaciones v = (Ubicaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Ubicaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Ubicaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Ubicaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Ubicaciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Ubicaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Ubicaciones() { id = i });
      //
      //      // Assert
