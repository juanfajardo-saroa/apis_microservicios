...
{
    public  class UTSubsistemasController: ITestCaseOrderer
    {
        private readonly SubsistemasController _controller;
        private readonly ISubsistemasService _service;
        private readonly Subsistemas _Objeto;
        ...
        public UTSubsistemasController()
        {
            _service = new UTSubsistemasServiceFake();
            _controller = new SubsistemasController();
            
             _Objeto = new Subsistemas()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Subsistemas v = (Subsistemas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Subsistemas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Subsistemas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Subsistemas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Subsistemas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Subsistemas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Subsistemas() { id = i });
      //
      //      // Assert
