...
{
    public  class UTCategoriaContenidoController: ITestCaseOrderer
    {
        private readonly CategoriaContenidoController _controller;
        private readonly ICategoriaContenidoService _service;
        private readonly CategoriaContenido _Objeto;
        ...
        public UTCategoriaContenidoController()
        {
            _service = new UTCategoriaContenidoServiceFake();
            _controller = new CategoriaContenidoController();
            
             _Objeto = new CategoriaContenido()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CategoriaContenido v = (CategoriaContenido)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CategoriaContenido c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CategoriaContenido>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CategoriaContenido>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CategoriaContenido).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CategoriaContenido"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CategoriaContenido() { id = i });
      //
      //      // Assert
