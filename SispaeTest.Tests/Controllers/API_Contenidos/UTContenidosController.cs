...
using System;
using System.Linq;
using SISPAE_API_Contenidos.WebAPI.Controllers;
...
{
    public  class UTContenidosController: ITestCaseOrderer
    {
        private readonly ContenidosController _controller;
        private readonly IContenidosService _service;
        private readonly Contenidos _Objeto;
        ...
        public UTContenidosController()
        {
            _service = new UTContenidosServiceFake();
            _controller = new ContenidosController();
            
             _Objeto = new Contenidos()
            {
                id=0,
ID_ETC=1,
ID_Categoria=1,
...
TextoContenido="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Contenidos v = (Contenidos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Contenidos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Contenidos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Contenidos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Contenidos).id);
        }
...
_Objeto.TextoContenido="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Contenidos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Contenidos() { id = i });
      //
      //      // Assert
