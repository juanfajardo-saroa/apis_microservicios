...
{
    public  class UTMultimediasController: ITestCaseOrderer
    {
        private readonly MultimediasController _controller;
        private readonly IMultimediasService _service;
        private readonly Multimedias _Objeto;
        ...
        public UTMultimediasController()
        {
            _service = new UTMultimediasServiceFake();
            _controller = new MultimediasController();
            
             _Objeto = new Multimedias()
            {
                id=0,
Nombre="a",
PATH="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Multimedias v = (Multimedias)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Multimedias c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Multimedias>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Multimedias>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Multimedias).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Multimedias"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Multimedias() { id = i });
      //
      //      // Assert
