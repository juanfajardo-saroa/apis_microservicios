...
{
    public  class UTTipoEstadoPriorizacionController: ITestCaseOrderer
    {
        private readonly TipoEstadoPriorizacionController _controller;
        private readonly ITipoEstadoPriorizacionService _service;
        private readonly TipoEstadoPriorizacion _Objeto;
        ...
        public UTTipoEstadoPriorizacionController()
        {
            _service = new UTTipoEstadoPriorizacionServiceFake();
            _controller = new TipoEstadoPriorizacionController();
            
             _Objeto = new TipoEstadoPriorizacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoEstadoPriorizacion v = (TipoEstadoPriorizacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoEstadoPriorizacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoEstadoPriorizacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoEstadoPriorizacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoEstadoPriorizacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoEstadoPriorizacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoEstadoPriorizacion() { id = i });
      //
      //      // Assert
