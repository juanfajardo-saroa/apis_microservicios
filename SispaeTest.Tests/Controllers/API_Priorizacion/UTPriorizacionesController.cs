...
using System;
using System.Linq;
using SISPAE_API_Priorizacion.WebAPI.Controllers;
...
{
    public  class UTPriorizacionesController: ITestCaseOrderer
    {
        private readonly PriorizacionesController _controller;
        private readonly IPriorizacionesService _service;
        private readonly Priorizaciones _Objeto;
        ...
        public UTPriorizacionesController()
        {
            _service = new UTPriorizacionesServiceFake();
            _controller = new PriorizacionesController();
            
             _Objeto = new Priorizaciones()
            {
                id=0,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Priorizaciones v = (Priorizaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Priorizaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Priorizaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Priorizaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Priorizaciones).id);
        }
...
_Objeto.ID_TipoEstadoPriorizacion=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Priorizaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Priorizaciones() { id = i });
      //
      //      // Assert
