...
{
    public  class UTTiposModalidadRacionController: ITestCaseOrderer
    {
        private readonly TiposModalidadRacionController _controller;
        private readonly ITiposModalidadRacionService _service;
        private readonly TiposModalidadRacion _Objeto;
        ...
        public UTTiposModalidadRacionController()
        {
            _service = new UTTiposModalidadRacionServiceFake();
            _controller = new TiposModalidadRacionController();
            
             _Objeto = new TiposModalidadRacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposModalidadRacion v = (TiposModalidadRacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposModalidadRacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposModalidadRacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposModalidadRacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposModalidadRacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposModalidadRacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposModalidadRacion() { id = i });
      //
      //      // Assert
