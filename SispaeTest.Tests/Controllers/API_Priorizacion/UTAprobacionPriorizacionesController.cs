...
{
    public  class UTAprobacionPriorizacionesController: ITestCaseOrderer
    {
        private readonly AprobacionPriorizacionesController _controller;
        private readonly IAprobacionPriorizacionesService _service;
        private readonly AprobacionPriorizaciones _Objeto;
        ...
        public UTAprobacionPriorizacionesController()
        {
            _service = new UTAprobacionPriorizacionesServiceFake();
            _controller = new AprobacionPriorizacionesController();
            
             _Objeto = new AprobacionPriorizaciones()
            {
                id=0,
ID_Aprobacion=1,
ID_Priorizacion=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AprobacionPriorizaciones v = (AprobacionPriorizaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AprobacionPriorizaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AprobacionPriorizaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AprobacionPriorizaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AprobacionPriorizaciones).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Aprobacion=1;
_Objeto.ID_Priorizacion=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AprobacionPriorizaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AprobacionPriorizaciones() { id = i });
      //
      //      // Assert
