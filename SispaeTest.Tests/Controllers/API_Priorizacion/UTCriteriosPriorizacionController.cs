...
{
    public  class UTCriteriosPriorizacionController: ITestCaseOrderer
    {
        private readonly CriteriosPriorizacionController _controller;
        private readonly ICriteriosPriorizacionService _service;
        private readonly CriteriosPriorizacion _Objeto;
        ...
        public UTCriteriosPriorizacionController()
        {
            _service = new UTCriteriosPriorizacionServiceFake();
            _controller = new CriteriosPriorizacionController();
            
             _Objeto = new CriteriosPriorizacion()
            {
                id=0,
Prioridad=1,
Nombre="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CriteriosPriorizacion v = (CriteriosPriorizacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CriteriosPriorizacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CriteriosPriorizacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CriteriosPriorizacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CriteriosPriorizacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CriteriosPriorizacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CriteriosPriorizacion() { id = i });
      //
      //      // Assert
