...
{
    public  class UTAuditoriaContratosController: ITestCaseOrderer
    {
        private readonly AuditoriaContratosController _controller;
        private readonly IAuditoriaContratosService _service;
        private readonly AuditoriaContratos _Objeto;
        ...
        public UTAuditoriaContratosController()
        {
            _service = new UTAuditoriaContratosServiceFake();
            _controller = new AuditoriaContratosController();
            
             _Objeto = new AuditoriaContratos()
            {
                id=0,
ID_User="a",
ID_Contrato=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaContratos v = (AuditoriaContratos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaContratos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaContratos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaContratos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaContratos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaContratos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaContratos() { id = i });
      //
      //      // Assert
