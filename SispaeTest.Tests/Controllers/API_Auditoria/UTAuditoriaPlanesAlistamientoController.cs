...
using System;
using System.Linq;
using SISPAE_API_Auditoria.WebAPI.Controllers;
...
{
    public  class UTAuditoriaPlanesAlistamientoController: ITestCaseOrderer
    {
        private readonly AuditoriaPlanesAlistamientoController _controller;
        private readonly IAuditoriaPlanesAlistamientoService _service;
        private readonly AuditoriaPlanesAlistamiento _Objeto;
        ...
        public UTAuditoriaPlanesAlistamientoController()
        {
            _service = new UTAuditoriaPlanesAlistamientoServiceFake();
            _controller = new AuditoriaPlanesAlistamientoController();
            
             _Objeto = new AuditoriaPlanesAlistamiento()
            {
                id=0,
ID_User=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaPlanesAlistamiento v = (AuditoriaPlanesAlistamiento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaPlanesAlistamiento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaPlanesAlistamiento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaPlanesAlistamiento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaPlanesAlistamiento).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_User=2;
_Objeto.ID_PlanAlistamiento=2;
_Objeto.FechaCambio=DateTime.Now;
_Objeto.ID_TipoOperacion=2;
_Objeto.Valor="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaPlanesAlistamiento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaPlanesAlistamiento() { id = i });
      //
      //      // Assert
