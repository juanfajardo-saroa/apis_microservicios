...
{
    public  class UTAuditoriaSegRacionesController: ITestCaseOrderer
    {
        private readonly AuditoriaSegRacionesController _controller;
        private readonly IAuditoriaSegRacionesService _service;
        private readonly AuditoriaSegRaciones _Objeto;
        ...
        public UTAuditoriaSegRacionesController()
        {
            _service = new UTAuditoriaSegRacionesServiceFake();
            _controller = new AuditoriaSegRacionesController();
            
             _Objeto = new AuditoriaSegRaciones()
            {
                id=0,
ID_User="a",
ID_QuincenaEntregaRacion=1,
ID_TipoOperacion=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaSegRaciones v = (AuditoriaSegRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaSegRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaSegRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaSegRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaSegRaciones).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_User="a";
_Objeto.ID_QuincenaEntregaRacion=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaSegRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaSegRaciones() { id = i });
      //
      //      // Assert
