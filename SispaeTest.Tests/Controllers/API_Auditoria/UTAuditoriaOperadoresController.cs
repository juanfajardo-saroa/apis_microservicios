...
{
    public  class UTAuditoriaOperadoresController: ITestCaseOrderer
    {
        private readonly AuditoriaOperadoresController _controller;
        private readonly IAuditoriaOperadoresService _service;
        private readonly AuditoriaOperadores _Objeto;
        ...
        public UTAuditoriaOperadoresController()
        {
            _service = new UTAuditoriaOperadoresServiceFake();
            _controller = new AuditoriaOperadoresController();
            
             _Objeto = new AuditoriaOperadores()
            {
                id=0,
ID_User=1,
ID_Operador=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaOperadores v = (AuditoriaOperadores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaOperadores c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaOperadores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaOperadores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaOperadores).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaOperadores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaOperadores() { id = i });
      //
      //      // Assert
