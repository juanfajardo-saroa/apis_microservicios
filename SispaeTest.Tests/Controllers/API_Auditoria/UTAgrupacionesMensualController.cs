...
{
    public  class UTAgrupacionesMensualController: ITestCaseOrderer
    {
        private readonly AgrupacionesMensualController _controller;
        private readonly IAgrupacionesMensualService _service;
        private readonly AgrupacionesMensual _Objeto;
        ...
        public UTAgrupacionesMensualController()
        {
            _service = new UTAgrupacionesMensualServiceFake();
            _controller = new AgrupacionesMensualController();
            
             _Objeto = new AgrupacionesMensual()
            {
                id=0,
ID_TipoEstadoValidacionEntrega=1,
ID_Rector=1,
ID_SedeJornada=1,
ID_Operador=1,
ID_Contrato=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AgrupacionesMensual v = (AgrupacionesMensual)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AgrupacionesMensual c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AgrupacionesMensual>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AgrupacionesMensual>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AgrupacionesMensual).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoEstadoValidacionEntrega=2;
_Objeto.ID_Rector=2;
_Objeto.ID_SedeJornada=2;
_Objeto.ID_Operador=2;
_Objeto.ID_Contrato=2;
_Objeto.Mes=DateTime.Now;
_Objeto.SoporteEntrega="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AgrupacionesMensual"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AgrupacionesMensual() { id = i });
      //
      //      // Assert
