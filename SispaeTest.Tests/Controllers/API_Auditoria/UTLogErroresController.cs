...
{
    public  class UTLogErroresController: ITestCaseOrderer
    {
        private readonly LogErroresController _controller;
        private readonly ILogErroresService _service;
        private readonly LogErrores _Objeto;
        ...
        public UTLogErroresController()
        {
            _service = new UTLogErroresServiceFake();
            _controller = new LogErroresController();
            
             _Objeto = new LogErrores()
            {
                id=0,
ID_User=1,
Fecha=DateTime.Now,
Operacion="a",
ParametrosOperacion="a",
DetallesError="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            LogErrores v = (LogErrores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            LogErrores c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<LogErrores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<LogErrores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as LogErrores).id);
        }
...
_Objeto.Operacion="a";
_Objeto.ParametrosOperacion="a";
_Objeto.DetallesError="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("LogErrores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new LogErrores() { id = i });
      //
      //      // Assert
