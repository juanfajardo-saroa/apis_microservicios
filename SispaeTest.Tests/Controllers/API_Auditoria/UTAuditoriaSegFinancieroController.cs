...
{
    public  class UTAuditoriaSegFinancieroController: ITestCaseOrderer
    {
        private readonly AuditoriaSegFinancieroController _controller;
        private readonly IAuditoriaSegFinancieroService _service;
        private readonly AuditoriaSegFinanciero _Objeto;
        ...
        public UTAuditoriaSegFinancieroController()
        {
            _service = new UTAuditoriaSegFinancieroServiceFake();
            _controller = new AuditoriaSegFinancieroController();
            
             _Objeto = new AuditoriaSegFinanciero()
            {
                id=0,
ID_User="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaSegFinanciero v = (AuditoriaSegFinanciero)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaSegFinanciero c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaSegFinanciero>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaSegFinanciero>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaSegFinanciero).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaSegFinanciero"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaSegFinanciero() { id = i });
      //
      //      // Assert
