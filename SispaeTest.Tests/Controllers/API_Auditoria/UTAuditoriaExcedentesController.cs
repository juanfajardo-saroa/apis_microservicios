...
{
    public  class UTAuditoriaExcedentesController: ITestCaseOrderer
    {
        private readonly AuditoriaExcedentesController _controller;
        private readonly IAuditoriaExcedentesService _service;
        private readonly AuditoriaExcedentes _Objeto;
        ...
        public UTAuditoriaExcedentesController()
        {
            _service = new UTAuditoriaExcedentesServiceFake();
            _controller = new AuditoriaExcedentesController();
            
             _Objeto = new AuditoriaExcedentes()
            {
                id=0,
ID_User=1,
ID_ExcedenteRacion=1,
ID_TipoOperacion=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaExcedentes v = (AuditoriaExcedentes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaExcedentes c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaExcedentes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaExcedentes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaExcedentes).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaExcedentes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaExcedentes() { id = i });
      //
      //      // Assert
