...
{
    public  class UTAuditoriaPriorizacionesController: ITestCaseOrderer
    {
        private readonly AuditoriaPriorizacionesController _controller;
        private readonly IAuditoriaPriorizacionesService _service;
        private readonly AuditoriaPriorizaciones _Objeto;
        ...
        public UTAuditoriaPriorizacionesController()
        {
            _service = new UTAuditoriaPriorizacionesServiceFake();
            _controller = new AuditoriaPriorizacionesController();
            
             _Objeto = new AuditoriaPriorizaciones()
            {
                id=0,
ID_User=1,
ID_Priorizacion=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaPriorizaciones v = (AuditoriaPriorizaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaPriorizaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaPriorizaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaPriorizaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaPriorizaciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaPriorizaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaPriorizaciones() { id = i });
      //
      //      // Assert
