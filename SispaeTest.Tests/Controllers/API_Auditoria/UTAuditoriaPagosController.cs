...
{
    public  class UTAuditoriaPagosController: ITestCaseOrderer
    {
        private readonly AuditoriaPagosController _controller;
        private readonly IAuditoriaPagosService _service;
        private readonly AuditoriaPagos _Objeto;
        ...
        public UTAuditoriaPagosController()
        {
            _service = new UTAuditoriaPagosServiceFake();
            _controller = new AuditoriaPagosController();
            
             _Objeto = new AuditoriaPagos()
            {
                id=0,
ID_User=1,
ID_Pago=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaPagos v = (AuditoriaPagos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaPagos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaPagos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaPagos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaPagos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaPagos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaPagos() { id = i });
      //
      //      // Assert
