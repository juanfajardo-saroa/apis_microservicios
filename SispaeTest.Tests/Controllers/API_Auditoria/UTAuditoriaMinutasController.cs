...
{
    public  class UTAuditoriaMinutasController: ITestCaseOrderer
    {
        private readonly AuditoriaMinutasController _controller;
        private readonly IAuditoriaMinutasService _service;
        private readonly AuditoriaMinutas _Objeto;
        ...
        public UTAuditoriaMinutasController()
        {
            _service = new UTAuditoriaMinutasServiceFake();
            _controller = new AuditoriaMinutasController();
            
             _Objeto = new AuditoriaMinutas()
            {
                id=0,
ID_User="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AuditoriaMinutas v = (AuditoriaMinutas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AuditoriaMinutas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AuditoriaMinutas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AuditoriaMinutas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AuditoriaMinutas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AuditoriaMinutas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AuditoriaMinutas() { id = i });
      //
      //      // Assert
