...
{
    public  class UTTiposTransporteController: ITestCaseOrderer
    {
        private readonly TiposTransporteController _controller;
        private readonly ITiposTransporteService _service;
        private readonly TiposTransporte _Objeto;
        ...
        public UTTiposTransporteController()
        {
            _service = new UTTiposTransporteServiceFake();
            _controller = new TiposTransporteController();
            
             _Objeto = new TiposTransporte()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposTransporte v = (TiposTransporte)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposTransporte c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposTransporte>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposTransporte>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposTransporte).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposTransporte"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposTransporte() { id = i });
      //
      //      // Assert
