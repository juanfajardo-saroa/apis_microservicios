...
{
    public  class UTTrayectosController: ITestCaseOrderer
    {
        private readonly TrayectosController _controller;
        private readonly ITrayectosService _service;
        private readonly Trayectos _Objeto;
        ...
        public UTTrayectosController()
        {
            _service = new UTTrayectosServiceFake();
            _controller = new TrayectosController();
            
             _Objeto = new Trayectos()
            {
                id=0,
ID_MedioTransporte= 1,
NumPosicion=1,
Costo=1,
Kilometros=1,
Horas=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Trayectos v = (Trayectos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Trayectos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Trayectos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Trayectos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Trayectos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoTransporte=2;
_Objeto.NumPosicion=1;
_Objeto.Costo=1;
_Objeto.Kilometros=1;
_Objeto.Horas=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Trayectos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Trayectos() { id = i });
      //
      //      // Assert
