...
{
    public  class UTTrayectosSedeController: ITestCaseOrderer
    {
        private readonly TrayectosSedeController _controller;
        private readonly ITrayectosSedeService _service;
        private readonly TrayectosSede _Objeto;
        ...
        public UTTrayectosSedeController()
        {
            _service = new UTTrayectosSedeServiceFake();
            _controller = new TrayectosSedeController();
            
             _Objeto = new TrayectosSede()
            {
                id=0,
ID_Trayecto=1,
ID_AnalisisAcceso=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TrayectosSede v = (TrayectosSede)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TrayectosSede c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TrayectosSede>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TrayectosSede>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TrayectosSede).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Trayecto=2;
_Objeto.ID_AnalisisAcceso=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TrayectosSede"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TrayectosSede() { id = i });
      //
      //      // Assert
