...
using System;
using System.Linq;
using SISPAE_API_Acceso.WebAPI.Controllers;
...
{
    public  class UTAnalisisAccesosController: ITestCaseOrderer
    {
        private readonly AnalisisAccesosController _controller;
        private readonly IAnalisisAccesosService _service;
        private readonly AnalisisAccesos _Objeto;
        ...
        public UTAnalisisAccesosController()
        {
            _service = new UTAnalisisAccesosServiceFake();
            _controller = new AnalisisAccesosController();
            
             _Objeto = new AnalisisAccesos()
            {
                id=0,
ID_CaracteristicasSede=1,
ID_TipoAcceso=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AnalisisAccesos v = (AnalisisAccesos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AnalisisAccesos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AnalisisAccesos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AnalisisAccesos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AnalisisAccesos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_CaracteristicasSede=1;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AnalisisAccesos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AnalisisAccesos() { id = i });
      //
      //      // Assert
