...
{
    public  class UTMedioTransporteController: ITestCaseOrderer
    {
        private readonly MedioTransporteController _controller;
        private readonly IMedioTransporteService _service;
        private readonly MedioTransporte _Objeto;
        ...
        public UTMedioTransporteController()
        {
            _service = new UTMedioTransporteServiceFake();
            _controller = new MedioTransporteController();
            
             _Objeto = new MedioTransporte()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MedioTransporte v = (MedioTransporte)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MedioTransporte c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MedioTransporte>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MedioTransporte>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MedioTransporte).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MedioTransporte"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MedioTransporte() { id = i });
      //
      //      // Assert
