...
{
    public class UTTiposAccesoController : ITestCaseOrderer
    {
        private readonly TiposAccesoController _controller;
        private readonly ITiposAccesoService _service;
        private readonly TiposAcceso _Objeto;
        ...
        public UTTiposAccesoController()
        {
            _service = new UTTiposAccesoServiceFake();
            _controller = new TiposAccesoController();

            _Objeto = new TiposAcceso()
            {
                id = 0,
                Nombre = "a",
                Valor = 1,
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            TiposAcceso v = (TiposAcceso)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            TiposAcceso c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposAcceso>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposAcceso>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposAcceso).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("TiposAcceso"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new TiposAcceso() { id = i });
        //
        //      // Assert
