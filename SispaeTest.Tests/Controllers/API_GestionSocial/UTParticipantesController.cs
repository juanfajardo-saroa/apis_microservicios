...
namespace SISPAE.Tests.Controllers
{
    public  class UTParticipantesController: ITestCaseOrderer
    {
        ...
        public UTParticipantesController()
        {
            _service = new UTParticipantesServiceFake();
            _controller = new ParticipantesController();
            
             _Objeto = new Participantes()
            {
                id=0,
ID_Comite=1,
ID_TipoParticipante=1,
ID_Grado=1,
Activo=true,
Cargolnstitucion="a",
FechaPersonero=DateTime.Now,
Nombre="a",
Apellido="a",
Celular="a",
Correo="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Participantes v = (Participantes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Participantes c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Participantes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Participantes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Participantes).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_Comite=2;
_Objeto.ID_TipoParticipante=2;
_Objeto.ID_Grado=2;
_Objeto.Activo=true;
_Objeto.Cargolnstitucion="a";
_Objeto.FechaPersonero=DateTime.Now;
_Objeto.Nombre="a";
_Objeto.Apellido="a";
_Objeto.Celular="a";
_Objeto.Correo="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Participantes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Participantes() { id = i });
      //
      //      // Assert
