...
using System;
using System.Linq;
using SISPAE_API_GestionSocial.WebAPI.Controllers;
...
{
    public  class UTMesasPublicasController: ITestCaseOrderer
    {
        private readonly MesasPublicasController _controller;
        private readonly IMesasPublicasService _service;
        private readonly MesasPublicas _Objeto;
        ...
        public UTMesasPublicasController()
        {
            _service = new UTMesasPublicasServiceFake();
            _controller = new MesasPublicasController();
            
             _Objeto = new MesasPublicas()
            {
                id=0,
ID_ETC=1,
ID_UsuarioEntidad=1,
ID_EstadoValidacion=1,
ID_Vigencia=1,
TemasTratados=1,
DecisionesTomadas=1,
FechaAprobacion=1,
ObservacionesLiderPAE=1,
SoporteMesaPath=1,
DescripcionTiposParticipantes=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MesasPublicas v = (MesasPublicas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MesasPublicas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MesasPublicas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MesasPublicas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MesasPublicas).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_ETC=2;
_Objeto.ID_UsuarioEntidad=2;
_Objeto.ID_EstadoValidacion=2;
_Objeto.ID_Vigencia=2;
_Objeto.TemasTratados=1;
_Objeto.DecisionesTomadas=1;
_Objeto.FechaAprobacion=1;
_Objeto.ObservacionesLiderPAE=1;
_Objeto.SoporteMesaPath=1;
_Objeto.DescripcionTiposParticipantes=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MesasPublicas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MesasPublicas() { id = i });
      //
      //      // Assert
