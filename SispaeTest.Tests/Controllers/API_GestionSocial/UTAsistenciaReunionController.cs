...
{
    public  class UTAsistenciaReunionController: ITestCaseOrderer
    {
        private readonly AsistenciaReunionController _controller;
        private readonly IAsistenciaReunionService _service;
        private readonly AsistenciaReunion _Objeto;
        ...
        public UTAsistenciaReunionController()
        {
            _service = new UTAsistenciaReunionServiceFake();
            _controller = new AsistenciaReunionController();
            
             _Objeto = new AsistenciaReunion()
            {
                id=0,
ID_Participante=1,
ID_ReunionComite=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AsistenciaReunion v = (AsistenciaReunion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AsistenciaReunion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AsistenciaReunion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AsistenciaReunion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AsistenciaReunion).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Participante=2;
_Objeto.ID_ReunionComite=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AsistenciaReunion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AsistenciaReunion() { id = i });
      //
      //      // Assert
