...
{
    public  class UTReunionesComiteController: ITestCaseOrderer
    {
        private readonly ReunionesComiteController _controller;
        private readonly IReunionesComiteService _service;
        private readonly ReunionesComite _Objeto;
        ...
        public UTReunionesComiteController()
        {
            _service = new UTReunionesComiteServiceFake();
            _controller = new ReunionesComiteController();
            
             _Objeto = new ReunionesComite()
            {
                id=0,
ID_Comite=1,
...
DecisionesAcordadas="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ReunionesComite v = (ReunionesComite)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ReunionesComite c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ReunionesComite>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ReunionesComite>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ReunionesComite).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_Comite=2;
_Objeto.FechaReunion=DateTime.Now;
_Objeto.auditoria="a";
_Objeto.TemaTrabajo="a";
_Objeto.DecisionesAcordadas="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ReunionesComite"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ReunionesComite() { id = i });
      //
      //      // Assert
