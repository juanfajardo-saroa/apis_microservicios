...
{
    public  class UTPlantaBodegasController: ITestCaseOrderer
    {
        private readonly PlantaBodegasController _controller;
        private readonly IPlantaBodegasService _service;
        private readonly PlantaBodegas _Objeto;
        ...
        public UTPlantaBodegasController()
        {
            _service = new UTPlantaBodegasServiceFake();
            _controller = new PlantaBodegasController();
            
             _Objeto = new PlantaBodegas()
            {
                id=0,
ID_TipoPlantaBodega=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PlantaBodegas v = (PlantaBodegas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PlantaBodegas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PlantaBodegas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PlantaBodegas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PlantaBodegas).id);
        }
...
_Objeto.Latitude=1;
_Objeto.Telefono="a";
_Objeto.NombreContacto="a";
_Objeto.ApellidoContacto="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PlantaBodegas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PlantaBodegas() { id = i });
      //
      //      // Assert
