...
{
    public  class UTTiposPlantaBodegaController: ITestCaseOrderer
    {
        private readonly TiposPlantaBodegaController _controller;
        private readonly ITiposPlantaBodegaService _service;
        private readonly TiposPlantaBodega _Objeto;
        ...
        public UTTiposPlantaBodegaController()
        {
            _service = new UTTiposPlantaBodegaServiceFake();
            _controller = new TiposPlantaBodegaController();
            
             _Objeto = new TiposPlantaBodega()
            {
                id=0,
Nombre="aaa",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposPlantaBodega v = (TiposPlantaBodega)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposPlantaBodega c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposPlantaBodega>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposPlantaBodega>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposPlantaBodega).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposPlantaBodega"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposPlantaBodega() { id = i });
      //
      //      // Assert
