...
{
    public  class UTPresentacionesController: ITestCaseOrderer
    {
        private readonly PresentacionesController _controller;
        private readonly IPresentacionesService _service;
        private readonly Presentaciones _Objeto;
        ...
        public UTPresentacionesController()
        {
            _service = new UTPresentacionesServiceFake();
            _controller = new PresentacionesController();
            
             _Objeto = new Presentaciones()
            {
                id=0,
ID_Producto=1,
ID_TipoGrupoEtareo=1,
PesoNeto=1,
PesoBruto=1,
PesoServido=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Presentaciones v = (Presentaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Presentaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Presentaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Presentaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Presentaciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Presentaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Presentaciones() { id = i });
      //
      //      // Assert
