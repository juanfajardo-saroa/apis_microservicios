...
{
    public  class UTPlantasBodegasDocumentosPAController: ITestCaseOrderer
    {
        private readonly PlantasBodegasDocumentosPAController _controller;
        private readonly IPlantasBodegasDocumentosPAService _service;
        private readonly PlantasBodegasDocumentosPA _Objeto;
        ...
        public UTPlantasBodegasDocumentosPAController()
        {
            _service = new UTPlantasBodegasDocumentosPAServiceFake();
            _controller = new PlantasBodegasDocumentosPAController();
            
             _Objeto = new PlantasBodegasDocumentosPA()
            {
                id=0,
ID_PlantaBodegas=1,
ID_DocumentoPA=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PlantasBodegasDocumentosPA v = (PlantasBodegasDocumentosPA)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PlantasBodegasDocumentosPA c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PlantasBodegasDocumentosPA>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PlantasBodegasDocumentosPA>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PlantasBodegasDocumentosPA).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_PlantaBodegas=2;
_Objeto.ID_DocumentoPA=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PlantasBodegasDocumentosPA"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PlantasBodegasDocumentosPA() { id = i });
      //
      //      // Assert
