...
{
    public  class UTMinutaPatronProductosController: ITestCaseOrderer
    {
        private readonly MinutaPatronProductosController _controller;
        private readonly IMinutaPatronProductosService _service;
        private readonly MinutaPatronProductos _Objeto;
        ...
        public UTMinutaPatronProductosController()
        {
            _service = new UTMinutaPatronProductosServiceFake();
            _controller = new MinutaPatronProductosController();
            
             _Objeto = new MinutaPatronProductos()
            {
                ID=0,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MinutaPatronProductos v = (MinutaPatronProductos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MinutaPatronProductos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MinutaPatronProductos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MinutaPatronProductos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MinutaPatronProductos).ID);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MinutaPatronProductos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MinutaPatronProductos() { id = i });
      //
      //      // Assert
