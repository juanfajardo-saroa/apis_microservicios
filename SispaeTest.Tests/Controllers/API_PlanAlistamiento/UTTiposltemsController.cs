...
{
    public  class UTTiposltemsController: ITestCaseOrderer
    {
        private readonly TiposltemsController _controller;
        private readonly ITiposltemsService _service;
        private readonly Tiposltems _Objeto;
        ...
        public UTTiposltemsController()
        {
            _service = new UTTiposltemsServiceFake();
            _controller = new TiposltemsController();
            
             _Objeto = new Tiposltems()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Tiposltems v = (Tiposltems)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Tiposltems c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Tiposltems>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Tiposltems>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Tiposltems).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Tiposltems"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Tiposltems() { id = i });
      //
      //      // Assert
