...
{
    public  class UTRutasController: ITestCaseOrderer
    {
        private readonly RutasController _controller;
        private readonly IRutasService _service;
        private readonly Rutas _Objeto;
        ...
        public UTRutasController()
        {
            _service = new UTRutasServiceFake();
            _controller = new RutasController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Rutas v = (Rutas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Rutas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Rutas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Rutas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Rutas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Rutas() { id = i });
      //
      //      // Assert
