...
{
    public  class UTTiposDocumentosPAController: ITestCaseOrderer
    {
        private readonly TiposDocumentosPAController _controller;
        private readonly ITiposDocumentosPAService _service;
        private readonly TiposDocumentosPA _Objeto;
        ...
        public UTTiposDocumentosPAController()
        {
            _service = new UTTiposDocumentosPAServiceFake();
            _controller = new TiposDocumentosPAController();
            
             _Objeto = new TiposDocumentosPA()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposDocumentosPA v = (TiposDocumentosPA)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposDocumentosPA c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposDocumentosPA>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposDocumentosPA>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposDocumentosPA).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposDocumentosPA"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposDocumentosPA() { id = i });
      //
      //      // Assert
