...
{
    public  class UTProductosIntercambioController: ITestCaseOrderer
    {
        private readonly ProductosIntercambioController _controller;
        private readonly IProductosIntercambioService _service;
        private readonly ProductosIntercambio _Objeto;
        ...
        public UTProductosIntercambioController()
        {
            _service = new UTProductosIntercambioServiceFake();
            _controller = new ProductosIntercambioController();
            
             _Objeto = new ProductosIntercambio()
            {
                id=0,
ID_ProductoBase=1,
ID_Productolntercambio=1,
CantBase=1,
Cantintercambio=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ProductosIntercambio v = (ProductosIntercambio)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ProductosIntercambio c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ProductosIntercambio>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ProductosIntercambio>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ProductosIntercambio).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_ProductoBase=2;
_Objeto.ID_Productolntercambio=2;
_Objeto.CantBase=1;
_Objeto.Cantintercambio=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ProductosIntercambio"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ProductosIntercambio() { id = i });
      //
      //      // Assert
