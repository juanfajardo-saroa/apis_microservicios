...
using System;
using System.Linq;
using SISPAE_API_PlanAlistamiento.WebAPI.Controllers;
...
{
    public  class UTPlanesAlistamientosController: ITestCaseOrderer
    {
        private readonly PlanesAlistamientosController _controller;
        private readonly IPlanesAlistamientosService _service;
        private readonly PlanesAlistamientos _Objeto;
        ...
        public UTPlanesAlistamientosController()
        {
            _service = new UTPlanesAlistamientosServiceFake();
            _controller = new PlanesAlistamientosController();
            
             _Objeto = new PlanesAlistamientos()
            {
                ID=0,
ID_EstadoBodegas=1,
ID_EstadoDocumentacion=1,
ID_EstadoMenus=1,
ID_EstadoRutas=1,
ID_EstadoActaInicio=1,
ID_TipoEstadoAlistamiento=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PlanesAlistamientos v = (PlanesAlistamientos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PlanesAlistamientos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PlanesAlistamientos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PlanesAlistamientos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PlanesAlistamientos).ID);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_EstadoBodegas=1;
_Objeto.ID_EstadoDocumentacion=1;
_Objeto.ID_EstadoMenus=2;
_Objeto.ID_EstadoRutas=1;
_Objeto.ID_EstadoActaInicio=2;
_Objeto.ID_TipoEstadoAlistamiento=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PlanesAlistamientos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PlanesAlistamientos() { id = i });
      //
      //      // Assert
