...
{
    public  class UTRutasSedesController: ITestCaseOrderer
    {
        private readonly RutasSedesController _controller;
        private readonly IRutasSedesService _service;
        private readonly RutasSedes _Objeto;
        ...
        public UTRutasSedesController()
        {
            _service = new UTRutasSedesServiceFake();
            _controller = new RutasSedesController();
            
             _Objeto = new RutasSedes()
            {
                id=0,
ID_Ruta=1,
ID_Sede=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            RutasSedes v = (RutasSedes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            RutasSedes c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<RutasSedes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<RutasSedes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as RutasSedes).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_Ruta=2;
_Objeto.ID_Sede=2;
_Objeto.Numeracion=1;
_Objeto.RecibeGas=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("RutasSedes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new RutasSedes() { id = i });
      //
      //      // Assert
