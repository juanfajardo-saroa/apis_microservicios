...
{
    public  class UTAlimentosPlanController: ITestCaseOrderer
    {
        private readonly AlimentosPlanController _controller;
        private readonly IAlimentosPlanService _service;
        private readonly AlimentosPlan _Objeto;
        ...
        public UTAlimentosPlanController()
        {
            _service = new UTAlimentosPlanServiceFake();
            _controller = new AlimentosPlanController();
            
             _Objeto = new AlimentosPlan()
            {
                ID=0,
ID_MenuPlanAlistamiento=1,
ID_TipoComponente=1,
ID_Preparacion=1,
ID_Producto=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            AlimentosPlan v = (AlimentosPlan)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            AlimentosPlan c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AlimentosPlan>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AlimentosPlan>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AlimentosPlan).ID);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_MenuPlanAlistamiento=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("AlimentosPlan"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new AlimentosPlan() { id = i });
      //
      //      // Assert
