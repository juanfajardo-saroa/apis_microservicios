...
{
    public  class UTEntregaProductosController: ITestCaseOrderer
    {
        private readonly EntregaProductosController _controller;
        private readonly IEntregaProductosService _service;
        private readonly EntregaProductos _Objeto;
        ...
        public UTEntregaProductosController()
        {
            _service = new UTEntregaProductosServiceFake();
            _controller = new EntregaProductosController();
            
             _Objeto = new EntregaProductos()
            {
                id=0,
ID_Ruta=1,
ID_TipoPeriocidad=1,
ID_TipoDiaSemanaEntrega1=1,
ID_TipoDiaSemanaEntrega2=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            EntregaProductos v = (EntregaProductos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            EntregaProductos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<EntregaProductos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<EntregaProductos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as EntregaProductos).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_Ruta=2;
_Objeto.ID_TipoPeriocidad=2;
_Objeto.ID_TipoDiaSemanaEntrega1=2;
_Objeto.ID_TipoDiaSemanaEntrega2=2;
_Objeto.ID_TipoProductoRuta=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("EntregaProductos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new EntregaProductos() { id = i });
      //
      //      // Assert
