...
{
    public  class UTTiposEstadosAlistamientoController: ITestCaseOrderer
    {
        private readonly TiposEstadosAlistamientoController _controller;
        private readonly ITiposEstadosAlistamientoService _service;
        private readonly TiposEstadosAlistamiento _Objeto;
        ...
        public UTTiposEstadosAlistamientoController()
        {
            _service = new UTTiposEstadosAlistamientoServiceFake();
            _controller = new TiposEstadosAlistamientoController();
            
             _Objeto = new TiposEstadosAlistamiento()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadosAlistamiento v = (TiposEstadosAlistamiento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadosAlistamiento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadosAlistamiento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadosAlistamiento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadosAlistamiento).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadosAlistamiento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadosAlistamiento() { id = i });
      //
      //      // Assert
