...
{
    public  class UTEstadosValidacionController: ITestCaseOrderer
    {
        private readonly EstadosValidacionController _controller;
        private readonly IEstadosValidacionService _service;
        private readonly EstadosValidacion _Objeto;
        ...
        public UTEstadosValidacionController()
        {
            _service = new UTEstadosValidacionServiceFake();
            _controller = new EstadosValidacionController();
            
             _Objeto = new EstadosValidacion()
            {
                ID=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            EstadosValidacion v = (EstadosValidacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            EstadosValidacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<EstadosValidacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<EstadosValidacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as EstadosValidacion).ID);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("EstadosValidacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new EstadosValidacion() { id = i });
      //
      //      // Assert
