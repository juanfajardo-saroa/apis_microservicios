...
{
    public  class UTPlanAlistamientoController: ITestCaseOrderer
    {
        private readonly PlanAlistamientoController _controller;
        private readonly IPlanAlistamientoService _service;
        private readonly PlanAlistamiento _Objeto;
        ...
        public UTPlanAlistamientoController()
        {
            _service = new UTPlanAlistamientoServiceFake();
            _controller = new PlanAlistamientoController();
            
             _Objeto = new PlanAlistamiento()
            {
                ID=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PlanAlistamiento v = (PlanAlistamiento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PlanAlistamiento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PlanAlistamiento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PlanAlistamiento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PlanAlistamiento).ID);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PlanAlistamiento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PlanAlistamiento() { id = i });
      //
      //      // Assert
