...
{
    public  class UTItemsController: ITestCaseOrderer
    {
        private readonly ItemsController _controller;
        private readonly IItemsService _service;
        private readonly Items _Objeto;
        ...
        public UTItemsController()
        {
            _service = new UTItemsServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Items v = (Items)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Items>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Items>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Items).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Items"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Items() { id = i });
      //
      //      // Assert
