...
{
    public  class UTSemanasController: ITestCaseOrderer
    {
        private readonly SemanasController _controller;
        private readonly ISemanasService _service;
        private readonly Semanas _Objeto;
        ...
        public UTSemanasController()
        {
            _service = new UTSemanasServiceFake();
            _controller = new SemanasController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Semanas v = (Semanas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Semanas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Semanas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Semanas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Semanas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Semanas() { id = i });
      //
      //      // Assert
