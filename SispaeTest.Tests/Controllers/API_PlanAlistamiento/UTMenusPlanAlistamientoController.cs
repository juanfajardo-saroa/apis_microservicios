...
{
    public  class UTMenusPlanAlistamientoController: ITestCaseOrderer
    {
        private readonly MenusPlanAlistamientoController _controller;
        private readonly IMenusPlanAlistamientoService _service;
        private readonly MenusPlanAlistamiento _Objeto;
        ...
        public UTMenusPlanAlistamientoController()
        {
            _service = new UTMenusPlanAlistamientoServiceFake();
            _controller = new MenusPlanAlistamientoController();
            
             _Objeto = new MenusPlanAlistamiento()
            {
                ID=0,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MenusPlanAlistamiento v = (MenusPlanAlistamiento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.ID = v.ID;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            MenusPlanAlistamiento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MenusPlanAlistamiento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MenusPlanAlistamiento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MenusPlanAlistamiento).ID);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MenusPlanAlistamiento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MenusPlanAlistamiento() { id = i });
      //
      //      // Assert
