...
{
    public  class UTDocumentosPAController: ITestCaseOrderer
    {
        private readonly DocumentosPAController _controller;
        private readonly IDocumentosPAService _service;
        private readonly DocumentosPA _Objeto;
        ...
        public UTDocumentosPAController()
        {
            _service = new UTDocumentosPAServiceFake();
            _controller = new DocumentosPAController();
            
             _Objeto = new DocumentosPA()
            {
                id=0,
ID_TipoDocumentoPA=1,
ID_Estado=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DocumentosPA v = (DocumentosPA)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DocumentosPA c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DocumentosPA>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DocumentosPA>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DocumentosPA).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DocumentosPA"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DocumentosPA() { id = i });
      //
      //      // Assert
