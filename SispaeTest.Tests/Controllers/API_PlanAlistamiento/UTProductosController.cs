...
namespace SISPAE.Tests.Controllers
{
    public  class UTProductosController: ITestCaseOrderer
    {
        ...
        public UTProductosController()
        {
            _service = new UTProductosServiceFake();
...
ID_Operador=1,
ID_GrupoAlimento=1,
PathlmagenProducto="a",
PathlmagenEstudioNutricional="a",
PathlmagenRegistroSanitario="a",
MateriaPrima=true,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Productos v = (Productos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Productos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Productos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Productos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Productos).id);
        }
...
_Objeto.PathlmagenProducto="a";
_Objeto.PathlmagenEstudioNutricional="a";
_Objeto.PathlmagenRegistroSanitario="a";
_Objeto.MateriaPrima=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Productos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Productos() { id = i });
      //
      //      // Assert
