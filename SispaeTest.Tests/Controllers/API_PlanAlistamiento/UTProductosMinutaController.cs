...
{
    public  class UTProductosMinutaController: ITestCaseOrderer
    {
        private readonly ProductosMinutaController _controller;
        private readonly IProductosMinutaService _service;
        private readonly ProductosMinuta _Objeto;
        ...
        public UTProductosMinutaController()
        {
            _service = new UTProductosMinutaServiceFake();
            _controller = new ProductosMinutaController();
            
             _Objeto = new ProductosMinuta()
            {
                id=0,
ID_MinutaPatronProducto=1,
ID_TipoComponente=1,
ID_GrupoAlimento=1,
frecuencia=1,
gramoPesoNeto=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ProductosMinuta v = (ProductosMinuta)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ProductosMinuta c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ProductosMinuta>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ProductosMinuta>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ProductosMinuta).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_MinutaPatronProducto=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ProductosMinuta"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ProductosMinuta() { id = i });
      //
      //      // Assert
