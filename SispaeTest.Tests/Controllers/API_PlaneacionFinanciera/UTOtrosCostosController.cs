...
{
    public class UTOtrosCostosController : ITestCaseOrderer
    {
        private readonly OtrosCostosController _controller;
        private readonly IOtrosCostosService _service;
        private readonly OtrosCostos _Objeto;
        ...
        public UTOtrosCostosController()
        {
            _service = new UTOtrosCostosServiceFake();
            _controller = new OtrosCostosController();

            _Objeto = new OtrosCostos()
            {
                id = 0,
                ID_ETC = 1,
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            OtrosCostos v = (OtrosCostos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            OtrosCostos c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<OtrosCostos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<OtrosCostos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as OtrosCostos).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("OtrosCostos"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new OtrosCostos() { id = i });
        //
        //      // Assert
