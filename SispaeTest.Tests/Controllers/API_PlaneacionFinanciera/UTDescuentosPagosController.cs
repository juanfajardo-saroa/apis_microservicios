...
{
    public  class UTDescuentosPagosController: ITestCaseOrderer
    {
        private readonly DescuentosPagosController _controller;
        private readonly IDescuentosPagosService _service;
        private readonly DescuentosPagos _Objeto;
        ...
        public UTDescuentosPagosController()
        {
            _service = new UTDescuentosPagosServiceFake();
            _controller = new DescuentosPagosController();
            
             _Objeto = new DescuentosPagos()
            {
                id=0,
ID_TipoDescuento=1,
Valor=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DescuentosPagos v = (DescuentosPagos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DescuentosPagos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DescuentosPagos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DescuentosPagos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DescuentosPagos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DescuentosPagos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DescuentosPagos() { id = i });
      //
      //      // Assert
