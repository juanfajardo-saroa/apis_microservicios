...
namespace SISPAE.Tests.Controllers
{
    public  class UTCostosController: ITestCaseOrderer
    {
        ...
        public UTCostosController()
        {
            _service = new UTCostosServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Costos v = (Costos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Costos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Costos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Costos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Costos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Costos() { id = i });
      //
      //      // Assert
