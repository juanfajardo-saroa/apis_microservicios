...
{
    public  class UTCostoTransporteETCController: ITestCaseOrderer
    {
        private readonly CostoTransporteETCController _controller;
        private readonly ICostoTransporteETCService _service;
        private readonly CostoTransporteETC _Objeto;
        ...
        public UTCostoTransporteETCController()
        {
            _service = new UTCostoTransporteETCServiceFake();
            _controller = new CostoTransporteETCController();
            
             _Objeto = new CostoTransporteETC()
            {
                id=0,
ID_ETC=1,
ID_TipoRacion=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CostoTransporteETC v = (CostoTransporteETC)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CostoTransporteETC c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CostoTransporteETC>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CostoTransporteETC>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CostoTransporteETC).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CostoTransporteETC"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CostoTransporteETC() { id = i });
      //
      //      // Assert
