...
{
    public  class UTCostoServPublicosController: ITestCaseOrderer
    {
        private readonly CostoServPublicosController _controller;
        private readonly ICostoServPublicosService _service;
        private readonly CostoServPublicos _Objeto;
        ...
        public UTCostoServPublicosController()
        {
            _service = new UTCostoServPublicosServiceFake();
            _controller = new CostoServPublicosController();
            
             _Objeto = new CostoServPublicos()
            {
                id=0,
ID_ETC=1,
Agua=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CostoServPublicos v = (CostoServPublicos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CostoServPublicos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CostoServPublicos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CostoServPublicos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CostoServPublicos).id);
        }
...
_Objeto.Energia=1;
_Objeto.Gas=1;
_Objeto.AseoBasuras=1;
_Objeto.CostoServPublicos=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CostoServPublicos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CostoServPublicos() { id = i });
      //
      //      // Assert
