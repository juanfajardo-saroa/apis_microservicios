...
{
    public  class UTTiposIngresoController: ITestCaseOrderer
    {
        private readonly TiposIngresoController _controller;
        private readonly ITiposIngresoService _service;
        private readonly TiposIngreso _Objeto;
        ...
        public UTTiposIngresoController()
        {
            _service = new UTTiposIngresoServiceFake();
            _controller = new TiposIngresoController();
            
             _Objeto = new TiposIngreso()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposIngreso v = (TiposIngreso)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposIngreso c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposIngreso>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposIngreso>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposIngreso).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposIngreso"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposIngreso() { id = i });
      //
      //      // Assert
