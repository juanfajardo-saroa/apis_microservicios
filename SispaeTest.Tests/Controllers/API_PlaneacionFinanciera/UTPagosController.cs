...
namespace SISPAE.Tests.Controllers
{
    public  class UTPagosController: ITestCaseOrderer
    {
        ...
        public UTPagosController()
        {
            _service = new UTPagosServiceFake();
...
PATHSoportePago="a",
ValorTotalPago=1,
JustificacionTardio="a",
MesPago=DateTime.Now,
ID_TiposEstadosPago=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Pagos v = (Pagos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Pagos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Pagos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Pagos).id);
        }
...
_Objeto.FechaPago=DateTime.Now;
_Objeto.PATHSoportePago="a";
_Objeto.ValorTotalPago=1;
_Objeto.JustificacionTardio="a";
_Objeto.MesPago=DateTime.Now;
_Objeto.ID_TiposEstadosPago=2;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Pagos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Pagos() { id = i });
      //
      //      // Assert
