...
{
    public  class UTCostoPersonalController: ITestCaseOrderer
    {
        private readonly CostoPersonalController _controller;
        private readonly ICostoPersonalService _service;
        private readonly CostoPersonal _Objeto;
        ...
        public UTCostoPersonalController()
        {
            _service = new UTCostoPersonalServiceFake();
            _controller = new CostoPersonalController();
            
             _Objeto = new CostoPersonal()
            {
                id=0,
ID_etc=1,
NumCoordinadores=1,
SalarioCoordinador=1,
ID_TipoRemunManipuladoras=1,
RemunComplemento=1,
RemunAlmuerzo=1,
CostoPersonal=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CostoPersonal v = (CostoPersonal)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CostoPersonal c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CostoPersonal>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CostoPersonal>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CostoPersonal).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_etc=2;
_Objeto.NumCoordinadores=1;
_Objeto.SalarioCoordinador=1;
_Objeto.ID_TipoRemunManipuladoras=2;
_Objeto.RemunComplemento=1;
_Objeto.RemunAlmuerzo=1;
_Objeto.CostoPersonal=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CostoPersonal"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CostoPersonal() { id = i });
      //
      //      // Assert
