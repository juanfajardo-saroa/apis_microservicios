...
{
    public  class UTCostosRacionesController: ITestCaseOrderer
    {
        private readonly CostosRacionesController _controller;
        private readonly ICostosRacionesService _service;
        private readonly CostosRaciones _Objeto;
        ...
        public UTCostosRacionesController()
        {
            _service = new UTCostosRacionesServiceFake();
            _controller = new CostosRacionesController();
            
             _Objeto = new CostosRaciones()
            {
                id=0,
ID_ETC=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CostosRaciones v = (CostosRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CostosRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CostosRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CostosRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CostosRaciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CostosRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CostosRaciones() { id = i });
      //
      //      // Assert
