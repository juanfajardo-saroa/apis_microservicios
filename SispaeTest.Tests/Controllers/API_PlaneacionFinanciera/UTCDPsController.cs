...
{
    public class UTCDPsController : ITestCaseOrderer
    {
        private readonly CDPsController _controller;
        private readonly ICDPsService _service;
        private readonly CDPs _Objeto;
        ...
        public UTCDPsController()
        {
            _service = new UTCDPsServiceFake();
            _controller = new CDPsController();

            _Objeto = new CDPs()
            {
                id = 0,
                ID_FuenteFinanciacion = 1,
                NumeroCDP = 1,
                FechaCDP = 1,
                PAHTArchivoCDP = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            CDPs v = (CDPs)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CDPs>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CDPs>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CDPs).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_FuenteFinanciacion = 2;
            _Objeto.NumeroCDP = 1;
            _Objeto.FechaCDP = 1;
            _Objeto.PAHTArchivoCDP = 1;
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("CDPs"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new CDPs() { id = i });
        //
        //      // Assert
