...
{
    public  class UTTipoDescuentoController: ITestCaseOrderer
    {
        private readonly TipoDescuentoController _controller;
        private readonly ITipoDescuentoService _service;
        private readonly TipoDescuento _Objeto;
        ...
        public UTTipoDescuentoController()
        {
            _service = new UTTipoDescuentoServiceFake();
            _controller = new TipoDescuentoController();
            
             _Objeto = new TipoDescuento()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoDescuento v = (TipoDescuento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoDescuento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoDescuento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoDescuento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoDescuento).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoDescuento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoDescuento() { id = i });
      //
      //      // Assert
