...
namespace SISPAE.Tests.Controllers
{
    public  class UTIngresosController: ITestCaseOrderer
    {
        ...
        public UTIngresosController()
        {
            _service = new UTIngresosServiceFake();
            _controller = new IngresosController();
            
             _Objeto = new Ingresos()
            {
                id=0,
ID_ETC=1,
ID_TipoIngreso=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Ingresos v = (Ingresos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Ingresos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Ingresos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Ingresos).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_ETC=1;
_Objeto.ID_TipoIngreso=2;
_Objeto.ID_FuenteIngreso=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Ingresos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Ingresos() { id = i });
      //
      //      // Assert
