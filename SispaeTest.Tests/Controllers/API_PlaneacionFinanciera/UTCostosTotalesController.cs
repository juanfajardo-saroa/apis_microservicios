...
using System;
using System.Linq;
using SISPAE_API_PlaneacionFinanciera.WebAPI.Controllers;
...
{
    public  class UTCostosTotalesController: ITestCaseOrderer
    {
        private readonly CostosTotalesController _controller;
        private readonly ICostosTotalesService _service;
        private readonly CostosTotales _Objeto;
        ...
        public UTCostosTotalesController()
        {
            _service = new UTCostosTotalesServiceFake();
            _controller = new CostosTotalesController();
            
             _Objeto = new CostosTotales()
            {
                id=0,
ID_ETC=1,
ID_TipoModeloOperacion=1,
CostoTotalOtros=1,
CostoTotalRaciones=1,
CostoTotal=1,
CoberturaRecaudados=1,
CoberturaRecaudadosReconocidos=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CostosTotales v = (CostosTotales)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CostosTotales c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CostosTotales>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CostosTotales>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CostosTotales).id);
        }
...
_Objeto.CostoTotalOtros=1;
_Objeto.CostoTotalRaciones=1;
_Objeto.CostoTotal=1;
_Objeto.CoberturaRecaudados=1;
_Objeto.CoberturaRecaudadosReconocidos=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CostosTotales"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CostosTotales() { id = i });
      //
      //      // Assert
