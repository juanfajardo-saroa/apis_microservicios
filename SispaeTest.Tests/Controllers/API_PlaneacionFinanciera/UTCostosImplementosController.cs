...
{
    public  class UTCostosImplementosController: ITestCaseOrderer
    {
        private readonly CostosImplementosController _controller;
        private readonly ICostosImplementosService _service;
        private readonly CostosImplementos _Objeto;
        ...
        public UTCostosImplementosController()
        {
            _service = new UTCostosImplementosServiceFake();
            _controller = new CostosImplementosController();
            
             _Objeto = new CostosImplementos()
            {
                id=0,
ID_ETC=1,
MenajeCocina=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CostosImplementos v = (CostosImplementos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CostosImplementos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CostosImplementos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CostosImplementos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CostosImplementos).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.ID_ETC=2;
_Objeto.MenajeCocina=1;
_Objeto.MenajeComedor=1;
_Objeto.DotacionComedor=1;
_Objeto.ProductosLimpieza=1;
_Objeto.ImplementosAseo=1;
_Objeto.CostoImplementos=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CostosImplementos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CostosImplementos() { id = i });
      //
      //      // Assert
