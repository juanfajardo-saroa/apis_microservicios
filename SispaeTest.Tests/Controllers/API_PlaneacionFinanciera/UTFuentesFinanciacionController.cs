...
{
    public class UTFuentesFinanciacionController : ITestCaseOrderer
    {
        private readonly FuentesFinanciacionController _controller;
        private readonly IFuentesFinanciacionService _service;
        private readonly FuentesFinanciacion _Objeto;
        ...
        public UTFuentesFinanciacionController()
        {
            _service = new UTFuentesFinanciacionServiceFake();
            _controller = new FuentesFinanciacionController();

            _Objeto = new FuentesFinanciacion()
            {
                id = 0,
                ID_InfomacionPresupuestal = 1,
                ID_Modificacion = 1,
                ID_Fuentelngreso = 1,
                Valor = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            FuentesFinanciacion v = (FuentesFinanciacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            FuentesFinanciacion c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<FuentesFinanciacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<FuentesFinanciacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as FuentesFinanciacion).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_InfomacionPresupuestal = 1;
            _Objeto.ID_Modificacion = 1;
            _Objeto.ID_Fuentelngreso = 1;
            _Objeto.Valor = 1;
            _Objeto.auditoria = "a";
            _Objeto._nombremaquina = "aa";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("FuentesFinanciacion"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new FuentesFinanciacion() { id = i });
        //
        //      // Assert
