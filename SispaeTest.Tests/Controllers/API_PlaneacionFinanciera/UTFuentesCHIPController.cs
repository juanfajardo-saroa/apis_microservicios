...
{
    public  class UTFuentesCHIPController: ITestCaseOrderer
    {
        private readonly FuentesCHIPController _controller;
        private readonly IFuentesCHIPService _service;
        private readonly FuentesCHIP _Objeto;
        ...
        public UTFuentesCHIPController()
        {
            _service = new UTFuentesCHIPServiceFake();
            _controller = new FuentesCHIPController();
            
             _Objeto = new FuentesCHIP()
            {
                id=0,
TipoFuenteSIGEPAE="a",
NombreCHIP="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            FuentesCHIP v = (FuentesCHIP)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            FuentesCHIP c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<FuentesCHIP>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<FuentesCHIP>(okResult.Value);
            Assert.Equal(i, (okResult.Value as FuentesCHIP).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.TipoFuenteSIGEPAE="a";
_Objeto.NombreCHIP="a";
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("FuentesCHIP"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new FuentesCHIP() { id = i });
      //
      //      // Assert
