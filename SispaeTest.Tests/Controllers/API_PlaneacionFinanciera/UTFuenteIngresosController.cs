...
{
    public class UTFuenteIngresosController : ITestCaseOrderer
    {
        private readonly FuenteIngresosController _controller;
        private readonly IFuenteIngresosService _service;
        private readonly FuenteIngresos _Objeto;
        ...
        public UTFuenteIngresosController()
        {
            _service = new UTFuenteIngresosServiceFake();
            _controller = new FuenteIngresosController();

            _Objeto = new FuenteIngresos()
            {
                id = 0,
                Nombre = "a",
                FuenteSIGEPAE = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            FuenteIngresos v = (FuenteIngresos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            FuenteIngresos c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<FuenteIngresos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<FuenteIngresos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as FuenteIngresos).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("FuenteIngresos"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new FuenteIngresos() { id = i });
        //
        //      // Assert
