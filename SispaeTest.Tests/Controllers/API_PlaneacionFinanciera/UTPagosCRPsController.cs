...
{
    public  class UTPagosCRPsController: ITestCaseOrderer
    {
        private readonly PagosCRPsController _controller;
        private readonly IPagosCRPsService _service;
        private readonly PagosCRPs _Objeto;
        ...
        public UTPagosCRPsController()
        {
            _service = new UTPagosCRPsServiceFake();
            _controller = new PagosCRPsController();
            
             _Objeto = new PagosCRPs()
            {
                id=0,
ID_CRP=1,
ValorPago=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PagosCRPs v = (PagosCRPs)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PagosCRPs c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PagosCRPs>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PagosCRPs>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PagosCRPs).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PagosCRPs"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PagosCRPs() { id = i });
      //
      //      // Assert
