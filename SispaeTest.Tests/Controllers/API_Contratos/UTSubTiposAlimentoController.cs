...
{
    public  class UTSubTiposAlimentoController: ITestCaseOrderer
    {
        private readonly SubTiposAlimentoController _controller;
        private readonly ISubTiposAlimentoService _service;
        private readonly SubTiposAlimento _Objeto;
        ...
        public UTSubTiposAlimentoController()
        {
            _service = new UTSubTiposAlimentoServiceFake();
            _controller = new SubTiposAlimentoController();
            
             _Objeto = new SubTiposAlimento()
            {
                id=0,
Nombre=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            SubTiposAlimento v = (SubTiposAlimento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            SubTiposAlimento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<SubTiposAlimento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<SubTiposAlimento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as SubTiposAlimento).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("SubTiposAlimento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new SubTiposAlimento() { id = i });
      //
      //      // Assert
