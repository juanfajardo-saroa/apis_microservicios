...
{
    public  class UTTiposEstadosContratoController: ITestCaseOrderer
    {
        private readonly TiposEstadosContratoController _controller;
        private readonly ITiposEstadosContratoService _service;
        private readonly TiposEstadosContrato _Objeto;
        ...
        public UTTiposEstadosContratoController()
        {
            _service = new UTTiposEstadosContratoServiceFake();
            _controller = new TiposEstadosContratoController();
            
             _Objeto = new TiposEstadosContrato()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadosContrato v = (TiposEstadosContrato)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadosContrato c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadosContrato>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadosContrato>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadosContrato).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadosContrato"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadosContrato() { id = i });
      //
      //      // Assert
