...
{
    public  class UTPriorizacionesContratoController: ITestCaseOrderer
    {
        private readonly PriorizacionesContratoController _controller;
        private readonly IPriorizacionesContratoService _service;
        private readonly PriorizacionesContrato _Objeto;
        ...
        public UTPriorizacionesContratoController()
        {
            _service = new UTPriorizacionesContratoServiceFake();
            _controller = new PriorizacionesContratoController();
            
             _Objeto = new PriorizacionesContrato()
            {
                id=0,
ID_Contrato=1,
ID_GradoSedeJornada=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PriorizacionesContrato v = (PriorizacionesContrato)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PriorizacionesContrato c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PriorizacionesContrato>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PriorizacionesContrato>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PriorizacionesContrato).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PriorizacionesContrato"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PriorizacionesContrato() { id = i });
      //
      //      // Assert
