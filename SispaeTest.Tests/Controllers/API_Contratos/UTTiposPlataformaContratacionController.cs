...
{
    public  class UTTiposPlataformaContratacionController: ITestCaseOrderer
    {
        private readonly TiposPlataformaContratacionController _controller;
        private readonly ITiposPlataformaContratacionService _service;
        private readonly TiposPlataformaContratacion _Objeto;
        ...
        public UTTiposPlataformaContratacionController()
        {
            _service = new UTTiposPlataformaContratacionServiceFake();
            _controller = new TiposPlataformaContratacionController();
            
             _Objeto = new TiposPlataformaContratacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposPlataformaContratacion v = (TiposPlataformaContratacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposPlataformaContratacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposPlataformaContratacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposPlataformaContratacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposPlataformaContratacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposPlataformaContratacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposPlataformaContratacion() { id = i });
      //
      //      // Assert
