...
{
    public  class UTTiposPolizasController: ITestCaseOrderer
    {
        private readonly TiposPolizasController _controller;
        private readonly ITiposPolizasService _service;
        private readonly TiposPolizas _Objeto;
        ...
        public UTTiposPolizasController()
        {
            _service = new UTTiposPolizasServiceFake();
            _controller = new TiposPolizasController();
            
             _Objeto = new TiposPolizas()
            {
                id=0,
Nombre="a",
CodigoCHIP="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposPolizas v = (TiposPolizas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposPolizas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposPolizas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposPolizas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposPolizas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposPolizas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposPolizas() { id = i });
      //
      //      // Assert
