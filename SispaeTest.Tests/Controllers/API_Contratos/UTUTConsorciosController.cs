...
{
    public  class UTUTConsorciosController: ITestCaseOrderer
    {
        private readonly UTConsorciosController _controller;
        private readonly IUTConsorciosService _service;
        private readonly UTConsorcios _Objeto;
        ...
        public UTUTConsorciosController()
        {
            _service = new UTUTConsorciosServiceFake();
            _controller = new UTConsorciosController();
            
             _Objeto = new UTConsorcios()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            UTConsorcios v = (UTConsorcios)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            UTConsorcios c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<UTConsorcios>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<UTConsorcios>(okResult.Value);
            Assert.Equal(i, (okResult.Value as UTConsorcios).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("UTConsorcios"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new UTConsorcios() { id = i });
      //
      //      // Assert
