...
namespace SISPAE.Tests.Controllers
{
    public  class UTContratosController: ITestCaseOrderer
    {
        ...
        public UTContratosController()
        {
            _service = new UTContratosServiceFake();
            _controller = new ContratosController();
            
             _Objeto = new Contratos()
            {
                id=0,
ID_TipoContratoCHIP=1,
ID_TipoConceptoGasto=1,
ID_ETC=1,
ID_ET=1,
ID_MinutaPatronAlimento=1,
ID_Operador=1,
ID_TipoCategoriaContrato=1,
ID_EstadoContrato=1,
ID_UTConsorcio=1,
ID_PlanAlistamiento=1,
ID_Vigencia=1,
NumeroContrato="a",
ObjetoContrato="a",
ConAnticipo=true,
FechalnicioContrato=DateTime.Now,
FechaFinalContrato=DateTime.Now,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Contratos v = (Contratos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Contratos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Contratos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Contratos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Contratos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoContratoCHIP=1;
_Objeto.ID_TipoConceptoGasto=1;
_Objeto.ID_ETC=1;
_Objeto.ID_ET=1;
_Objeto.ID_MinutaPatronAlimento=1;
_Objeto.ID_Operador=1;
_Objeto.ID_TipoCategoriaContrato=1;
_Objeto.ID_EstadoContrato=2;
_Objeto.ID_UTConsorcio=1;
_Objeto.ID_PlanAlistamiento=1;
_Objeto.ID_Vigencia=2;
_Objeto.NumeroContrato="a";
_Objeto.ObjetoContrato="a";
_Objeto.ConAnticipo=true;
_Objeto.FechalnicioContrato=DateTime.Now;
_Objeto.FechaFinalContrato=DateTime.Now;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Contratos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Contratos() { id = i });
      //
      //      // Assert
