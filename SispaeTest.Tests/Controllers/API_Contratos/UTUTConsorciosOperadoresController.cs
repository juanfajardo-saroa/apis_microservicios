...
{
    public class UTUTConsorciosOperadoresController : ITestCaseOrderer
    {
        private readonly UTConsorciosOperadoresController _controller;
        private readonly IUTConsorciosOperadoresService _service;
        private readonly UTConsorciosOperadores _Objeto;
        ...
        public UTUTConsorciosOperadoresController()
        {
            _service = new UTUTConsorciosOperadoresServiceFake();
            _controller = new UTConsorciosOperadoresController();

            _Objeto = new UTConsorciosOperadores()
            {
                id = 0,
                ID_Operador = 1,
                ID_consorcio = 1,
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            UTConsorciosOperadores v = (UTConsorciosOperadores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            UTConsorciosOperadores c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<UTConsorciosOperadores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<UTConsorciosOperadores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as UTConsorciosOperadores).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.CantidadParticipacion = 1;
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("UTConsorciosOperadores"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new UTConsorciosOperadores() { id = i });
        //
        //      // Assert
