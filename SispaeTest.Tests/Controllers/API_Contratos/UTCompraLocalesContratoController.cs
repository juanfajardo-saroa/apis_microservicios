...
{
    public  class UTCompraLocalesContratoController: ITestCaseOrderer
    {
        private readonly CompraLocalesContratoController _controller;
        private readonly ICompraLocalesContratoService _service;
        private readonly CompraLocalesContrato _Objeto;
        ...
        public UTCompraLocalesContratoController()
        {
            _service = new UTCompraLocalesContratoServiceFake();
            _controller = new CompraLocalesContratoController();
            
             _Objeto = new CompraLocalesContrato()
            {
                id=0,
ID_contrato=1,
ID_TipoReglaCompraLocal=1,
ID_TipoCriterioEvaluacion=1,
ID_TipoPeriodicidad=1,
PorcentajeMinimo=1,
NumeroEmpresasMinimo=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CompraLocalesContrato v = (CompraLocalesContrato)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CompraLocalesContrato c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CompraLocalesContrato>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CompraLocalesContrato>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CompraLocalesContrato).id);
        }
...
_Objeto.ID_TipoReglaCompraLocal=2;
_Objeto.ID_TipoCriterioEvaluacion=2;
_Objeto.ID_TipoPeriodicidad=2;
_Objeto.PorcentajeMinimo=1;
_Objeto.NumeroEmpresasMinimo=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CompraLocalesContrato"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CompraLocalesContrato() { id = i });
      //
      //      // Assert
