...
{
    public class UTModificacionesController : ITestCaseOrderer
    {
        private readonly ModificacionesController _controller;
        private readonly IModificacionesService _service;
        private readonly Modificaciones _Objeto;
        ...
        public UTModificacionesController()
        {
            _service = new UTModificacionesServiceFake();
            _controller = new ModificacionesController();

            _Objeto = new Modificaciones()
            {
                id = 0,
                ID_Contrato = 1,
                ID_TipoModificacion = 1,
                NumeroDiasProrroga = DateTime.Now,
                FechaTerminacionProrroga = 1,
                ValorAdicionReduccion = 1,
                SoporteModificacionPath = "a",
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            Modificaciones v = (Modificaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            Modificaciones c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Modificaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Modificaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Modificaciones).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_TipoModificacion = 2;
            _Objeto.NumeroDiasProrroga = DateTime.Now;
            _Objeto.ValorAdicionReduccion = 1;
            _Objeto.SoporteModificacionPath = "a";
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("Modificaciones"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new Modificaciones() { id = i });
        //
        //      // Assert
