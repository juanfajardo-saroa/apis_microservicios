...
{
    public class UTPolizasController : ITestCaseOrderer
    {
        private readonly PolizasController _controller;
        private readonly IPolizasService _service;
        private readonly Polizas _Objeto;
        ...
        public UTPolizasController()
        {
            _service = new UTPolizasServiceFake();
            _controller = new PolizasController();
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            Polizas v = (Polizas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Polizas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Polizas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Polizas).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Contrato = 1;
            _Objeto.ID_TipoPoliza = 1;
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("Polizas"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new Polizas() { id = i });
        //
        //      // Assert
