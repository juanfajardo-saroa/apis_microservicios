...
{
    public  class UTCaracteristicasFinancierasController: ITestCaseOrderer
    {
        private readonly CaracteristicasFinancierasController _controller;
        private readonly ICaracteristicasFinancierasService _service;
        private readonly CaracteristicasFinancieras _Objeto;
        ...
        public UTCaracteristicasFinancierasController()
        {
            _service = new UTCaracteristicasFinancierasServiceFake();
            _controller = new CaracteristicasFinancierasController();
            
             _Objeto = new CaracteristicasFinancieras()
            {
                id=0,
ID_Contrato=1,
ID_TipoModeloOperacion=1,
ID_TipoModalidadRacion=1,
ID_TipoRacion=1,
ID_Jornada=1,
PrecioRacion=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CaracteristicasFinancieras v = (CaracteristicasFinancieras)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CaracteristicasFinancieras c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CaracteristicasFinancieras>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CaracteristicasFinancieras>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CaracteristicasFinancieras).id);
        }
...
_Objeto.ID_TipoModeloOperacion=2;
_Objeto.ID_TipoModalidadRacion=2;
_Objeto.ID_TipoRacion=2;
_Objeto.ID_Jornada=2;
_Objeto.PrecioRacion=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CaracteristicasFinancieras"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CaracteristicasFinancieras() { id = i });
      //
      //      // Assert
