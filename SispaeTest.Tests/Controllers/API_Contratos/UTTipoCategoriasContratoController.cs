...
{
    public  class UTTipoCategoriasContratoController: ITestCaseOrderer
    {
        private readonly TipoCategoriasContratoController _controller;
        private readonly ITipoCategoriasContratoService _service;
        private readonly TipoCategoriasContrato _Objeto;
        ...
        public UTTipoCategoriasContratoController()
        {
            _service = new UTTipoCategoriasContratoServiceFake();
            _controller = new TipoCategoriasContratoController();
            
             _Objeto = new TipoCategoriasContrato()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoCategoriasContrato v = (TipoCategoriasContrato)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoCategoriasContrato c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoCategoriasContrato>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoCategoriasContrato>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoCategoriasContrato).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoCategoriasContrato"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoCategoriasContrato() { id = i });
      //
      //      // Assert
