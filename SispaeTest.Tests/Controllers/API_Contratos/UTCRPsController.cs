...
{
    public class UTCRPsController : ITestCaseOrderer
    {
        private readonly CRPsController _controller;
        private readonly ICRPsService _service;
        private readonly CRPs _Objeto;
        ...
        public UTCRPsController()
        {
            _service = new UTCRPsServiceFake();
            _controller = new CRPsController();
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            CRPs v = (CRPs)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CRPs>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CRPs>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CRPs).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("CRPs"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new CRPs() { id = i });
        //
        //      // Assert
