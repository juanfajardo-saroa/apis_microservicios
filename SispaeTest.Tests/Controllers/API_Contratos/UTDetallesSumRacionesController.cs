...
{
    public  class UTDetallesSumRacionesController: ITestCaseOrderer
    {
        private readonly DetallesSumRacionesController _controller;
        private readonly IDetallesSumRacionesService _service;
        private readonly DetallesSumRaciones _Objeto;
        ...
        public UTDetallesSumRacionesController()
        {
            _service = new UTDetallesSumRacionesServiceFake();
            _controller = new DetallesSumRacionesController();
            
             _Objeto = new DetallesSumRaciones()
            {
                id=0,
ID_Contrato=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DetallesSumRaciones v = (DetallesSumRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DetallesSumRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DetallesSumRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DetallesSumRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DetallesSumRaciones).id);
        }
...
_Objeto.MesesSuministro=1;
_Objeto.ContratoPAEC=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DetallesSumRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DetallesSumRaciones() { id = i });
      //
      //      // Assert
