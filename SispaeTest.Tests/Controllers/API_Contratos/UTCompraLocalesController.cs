...
{
    public  class UTCompraLocalesController: ITestCaseOrderer
    {
        private readonly CompraLocalesController _controller;
        private readonly ICompraLocalesService _service;
        private readonly CompraLocales _Objeto;
        ...
        public UTCompraLocalesController()
        {
            _service = new UTCompraLocalesServiceFake();
            _controller = new CompraLocalesController();
            
             _Objeto = new CompraLocales()
            {
                id=0,
ID_Proveedor=1,
ID_Operador=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            CompraLocales v = (CompraLocales)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            CompraLocales c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<CompraLocales>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<CompraLocales>(okResult.Value);
            Assert.Equal(i, (okResult.Value as CompraLocales).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Proveedor=2;
_Objeto.ID_Operador=2;
_Objeto.ID_Contrato=2;
_Objeto.ID_AgrupacionMensual=2;
_Objeto.TotalKg=1;
_Objeto.TotalProductos=1;
_Objeto.ValorFactura=1;
_Objeto.FacturaPDFPATH=1;
_Objeto.CumpleCriterio=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("CompraLocales"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new CompraLocales() { id = i });
      //
      //      // Assert
