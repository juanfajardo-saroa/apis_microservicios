...
{
    public  class UTTiposContratoCHIPController: ITestCaseOrderer
    {
        private readonly TiposContratoCHIPController _controller;
        private readonly ITiposContratoCHIPService _service;
        private readonly TiposContratoCHIP _Objeto;
        ...
        public UTTiposContratoCHIPController()
        {
            _service = new UTTiposContratoCHIPServiceFake();
            _controller = new TiposContratoCHIPController();
            
             _Objeto = new TiposContratoCHIP()
            {
                id=0,
Nombre="a",
CodigoCHIP=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposContratoCHIP v = (TiposContratoCHIP)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposContratoCHIP c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposContratoCHIP>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposContratoCHIP>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposContratoCHIP).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposContratoCHIP"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposContratoCHIP() { id = i });
      //
      //      // Assert
