...
{
    public  class UTDetallesSumServiciosController: ITestCaseOrderer
    {
        private readonly DetallesSumServiciosController _controller;
        private readonly IDetallesSumServiciosService _service;
        private readonly DetallesSumServicios _Objeto;
        ...
        public UTDetallesSumServiciosController()
        {
            _service = new UTDetallesSumServiciosServiceFake();
            _controller = new DetallesSumServiciosController();
            
             _Objeto = new DetallesSumServicios()
            {
                id=0,
ID_Contrato=1,
NombreServicio="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DetallesSumServicios v = (DetallesSumServicios)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DetallesSumServicios c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DetallesSumServicios>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DetallesSumServicios>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DetallesSumServicios).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DetallesSumServicios"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DetallesSumServicios() { id = i });
      //
      //      // Assert
