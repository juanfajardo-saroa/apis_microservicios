...
{
    public  class UTPlanAnticiposController: ITestCaseOrderer
    {
        private readonly PlanAnticiposController _controller;
        private readonly IPlanAnticiposService _service;
        private readonly PlanAnticipos _Objeto;
        ...
        public UTPlanAnticiposController()
        {
            _service = new UTPlanAnticiposServiceFake();
            _controller = new PlanAnticiposController();
            
             _Objeto = new PlanAnticipos()
            {
                id=0,
ID_AnticipoContrato=1,
Periodo="a",
Valor=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            PlanAnticipos v = (PlanAnticipos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            PlanAnticipos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<PlanAnticipos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<PlanAnticipos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as PlanAnticipos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("PlanAnticipos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new PlanAnticipos() { id = i });
      //
      //      // Assert
