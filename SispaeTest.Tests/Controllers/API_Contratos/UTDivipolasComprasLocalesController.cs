...
{
    public  class UTDivipolasComprasLocalesController: ITestCaseOrderer
    {
        private readonly DivipolasComprasLocalesController _controller;
        private readonly IDivipolasComprasLocalesService _service;
        private readonly DivipolasComprasLocales _Objeto;
        ...
        public UTDivipolasComprasLocalesController()
        {
            _service = new UTDivipolasComprasLocalesServiceFake();
            _controller = new DivipolasComprasLocalesController();
            
             _Objeto = new DivipolasComprasLocales()
            {
                id=0,
ID_ComprasLocales=1,
ID_divipola=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DivipolasComprasLocales v = (DivipolasComprasLocales)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DivipolasComprasLocales c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DivipolasComprasLocales>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DivipolasComprasLocales>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DivipolasComprasLocales).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DivipolasComprasLocales"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DivipolasComprasLocales() { id = i });
      //
      //      // Assert
