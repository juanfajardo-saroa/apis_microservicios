...
{
    public  class UTDetallesSumDotacionController: ITestCaseOrderer
    {
        private readonly DetallesSumDotacionController _controller;
        private readonly IDetallesSumDotacionService _service;
        private readonly DetallesSumDotacion _Objeto;
        ...
        public UTDetallesSumDotacionController()
        {
            _service = new UTDetallesSumDotacionServiceFake();
            _controller = new DetallesSumDotacionController();
            
             _Objeto = new DetallesSumDotacion()
            {
                id=0,
ID_Contrato=1,
NombreProducto="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DetallesSumDotacion v = (DetallesSumDotacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DetallesSumDotacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DetallesSumDotacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DetallesSumDotacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DetallesSumDotacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DetallesSumDotacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DetallesSumDotacion() { id = i });
      //
      //      // Assert
