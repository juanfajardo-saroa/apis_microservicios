...
{
    public class UTDetallesSumLogisticoController : ITestCaseOrderer
    {
        private readonly DetallesSumLogisticoController _controller;
        private readonly IDetallesSumLogisticoService _service;
        private readonly DetallesSumLogistico _Objeto;
        ...
        public UTDetallesSumLogisticoController()
        {
            _service = new UTDetallesSumLogisticoServiceFake();
            _controller = new DetallesSumLogisticoController();

            _Objeto = new DetallesSumLogistico()
            {
                id = 0,
                ID_contrato = 1,

                TotalRacionesContratadas = 1,
                CostoUnitarioEnsambleOperacion = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            DetallesSumLogistico v = (DetallesSumLogistico)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            DetallesSumLogistico c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DetallesSumLogistico>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DetallesSumLogistico>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DetallesSumLogistico).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.TotalRacionesContratadas = 1;
            _Objeto.CostoUnitarioEnsambleOperacion = 1;
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("DetallesSumLogistico"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new DetallesSumLogistico() { id = i });
        //
        //      // Assert
