...
{
    public class UTContratosDataVariableController : ITestCaseOrderer
    {
        private readonly ContratosDataVariableController _controller;
        private readonly IContratosDataVariableService _service;
        private readonly ContratosDataVariable _Objeto;
        ...
        public UTContratosDataVariableController()
        {
            _service = new UTContratosDataVariableServiceFake();
            _controller = new ContratosDataVariableController();

            _Objeto = new ContratosDataVariable()
            {
                id = 0,
                ID_Contrato = 1,
                ID_Modificacion = 1,
                Actual = 1,
                FechaTerminacionContrato = 1,
                ValorTotalContrato = 1,
                NumeroDiasSuministro = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            ContratosDataVariable v = (ContratosDataVariable)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            ContratosDataVariable c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ContratosDataVariable>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ContratosDataVariable>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ContratosDataVariable).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            ...
            _Objeto.ID_Modificacion = 2;
            _Objeto.Actual = 1;
            _Objeto.FechaTerminacionContrato = 1;
            _Objeto.ValorTotalContrato = 1;
            _Objeto.NumeroDiasSuministro = 1;
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("ContratosDataVariable"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new ContratosDataVariable() { id = i });
        //
        //      // Assert
