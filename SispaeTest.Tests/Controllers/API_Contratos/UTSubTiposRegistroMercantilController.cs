...
{
    public  class UTSubTiposRegistroMercantilController: ITestCaseOrderer
    {
        private readonly SubTiposRegistroMercantilController _controller;
        private readonly ISubTiposRegistroMercantilService _service;
        private readonly SubTiposRegistroMercantil _Objeto;
        ...
        public UTSubTiposRegistroMercantilController()
        {
            _service = new UTSubTiposRegistroMercantilServiceFake();
            _controller = new SubTiposRegistroMercantilController();
            
             _Objeto = new SubTiposRegistroMercantil()
            {
                id=0,
ID_TipoRegistroMercantil=1,
Nombre="a",
CodigoCHIP=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            SubTiposRegistroMercantil v = (SubTiposRegistroMercantil)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            SubTiposRegistroMercantil c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<SubTiposRegistroMercantil>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<SubTiposRegistroMercantil>(okResult.Value);
            Assert.Equal(i, (okResult.Value as SubTiposRegistroMercantil).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoRegistroMercantil=2;
_Objeto.Nombre="a";
_Objeto.CodigoCHIP=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("SubTiposRegistroMercantil"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new SubTiposRegistroMercantil() { id = i });
      //
      //      // Assert
