...
{
    public  class UTTiposPeriodicidadController: ITestCaseOrderer
    {
        private readonly TiposPeriodicidadController _controller;
        private readonly ITiposPeriodicidadService _service;
        private readonly TiposPeriodicidad _Objeto;
        ...
        public UTTiposPeriodicidadController()
        {
            _service = new UTTiposPeriodicidadServiceFake();
            _controller = new TiposPeriodicidadController();
            
             _Objeto = new TiposPeriodicidad()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposPeriodicidad v = (TiposPeriodicidad)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposPeriodicidad c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposPeriodicidad>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposPeriodicidad>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposPeriodicidad).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposPeriodicidad"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposPeriodicidad() { id = i });
      //
      //      // Assert
