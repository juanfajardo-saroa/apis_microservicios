...
{
    public  class UTDetallesSumMaPriOperadorController: ITestCaseOrderer
    {
        private readonly DetallesSumMaPriOperadorController _controller;
        private readonly IDetallesSumMaPriOperadorService _service;
        private readonly DetallesSumMaPriOperador _Objeto;
        ...
        public UTDetallesSumMaPriOperadorController()
        {
            _service = new UTDetallesSumMaPriOperadorServiceFake();
            _controller = new DetallesSumMaPriOperadorController();
            
             _Objeto = new DetallesSumMaPriOperador()
            {
                id=0,
ID_Contrato=1,
ID_GrupoAlimento=1,
ID_TipoGrupoEtario=1,
ID_TipoUnidad=1,
DiasSuministro=1,
NombreAlimento="a",
Gramaje=1,
UnidadesContratadas=1,
ValorUnitario=1,
ValorTotal=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DetallesSumMaPriOperador v = (DetallesSumMaPriOperador)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DetallesSumMaPriOperador c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DetallesSumMaPriOperador>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DetallesSumMaPriOperador>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DetallesSumMaPriOperador).id);
        }
...
_Objeto.ID_GrupoAlimento=2;
_Objeto.ID_TipoGrupoEtario=1;
_Objeto.ID_TipoUnidad=2;
_Objeto.DiasSuministro=1;
_Objeto.NombreAlimento="a";
_Objeto.Gramaje=1;
_Objeto.UnidadesContratadas=1;
_Objeto.ValorUnitario=1;
_Objeto.ValorTotal=1;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DetallesSumMaPriOperador"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DetallesSumMaPriOperador() { id = i });
      //
      //      // Assert
