...
{
    public class UTSedesBeneficiariasController : ITestCaseOrderer
    {
        private readonly SedesBeneficiariasController _controller;
        private readonly ISedesBeneficiariasService _service;
        private readonly SedesBeneficiarias _Objeto;
        ...
        public UTSedesBeneficiariasController()
        {
            _service = new UTSedesBeneficiariasServiceFake();
            _controller = new SedesBeneficiariasController();

            _Objeto = new SedesBeneficiarias()
            {
                id = 0,
                ID_sede= 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            SedesBeneficiarias v = (SedesBeneficiarias)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            SedesBeneficiarias c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<SedesBeneficiarias>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<SedesBeneficiarias>(okResult.Value);
            Assert.Equal(i, (okResult.Value as SedesBeneficiarias).id);
        }
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("SedesBeneficiarias"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new SedesBeneficiarias() { id = i });
        //
        //      // Assert
