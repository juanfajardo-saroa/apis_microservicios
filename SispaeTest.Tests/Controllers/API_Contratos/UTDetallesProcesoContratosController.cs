...
{
    public  class UTDetallesProcesoContratosController: ITestCaseOrderer
    {
        private readonly DetallesProcesoContratosController _controller;
        private readonly IDetallesProcesoContratosService _service;
        private readonly DetallesProcesoContratos _Objeto;
        ...
        public UTDetallesProcesoContratosController()
        {
            _service = new UTDetallesProcesoContratosServiceFake();
            _controller = new DetallesProcesoContratosController();
            
             _Objeto = new DetallesProcesoContratos()
            {
                id=0,
ID_Contrato=1,
ID_TipoContratacion=1,
ID_PlataformaContrato=1,
PublicadorSECOP=true,
NumeroProcesoRegistradoSECOP="a",
LinkContratoSECOP="a",
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            DetallesProcesoContratos v = (DetallesProcesoContratos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            DetallesProcesoContratos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<DetallesProcesoContratos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<DetallesProcesoContratos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as DetallesProcesoContratos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_Contrato=2;
_Objeto.ID_TipoContratacion=2;
_Objeto.ID_PlataformaContrato=1;
_Objeto.PublicadorSECOP=true;
_Objeto.NumeroProcesoRegistradoSECOP="a";
_Objeto.LinkContratoSECOP="a";
_Objeto.FechaAdjudicacion=DateTime.Now;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("DetallesProcesoContratos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new DetallesProcesoContratos() { id = i });
      //
      //      // Assert
