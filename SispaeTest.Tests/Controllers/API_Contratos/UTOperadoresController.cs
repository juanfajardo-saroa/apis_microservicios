...
using System;
using System.Linq;
using SISPAE_API_Contratos.WebAPI.Controllers;
...
{
    public  class UTOperadoresController: ITestCaseOrderer
    {
        private readonly OperadoresController _controller;
        private readonly IOperadoresService _service;
        private readonly Operadores _Objeto;
        ...
        public UTOperadoresController()
        {
            _service = new UTOperadoresServiceFake();
            _controller = new OperadoresController();
            
             _Objeto = new Operadores()
            {
                id=0,
ID_TipoEstadoOperador=1,
ID_SubTipoRegistroMercantil=1,
ID_Divipola=1,
ID_UsuarioEntidad=1,
ID_Tipoldentificacion=1,
NombreRazonSocial="a",
Nit="a",
DV=1,
RUTPath="a",
NombreRepresentanteLegal="a",
ApellidoRepresentanteLegal="a",
Numeroldentificacion=1,
Correo="a",
Telefono="a",
Direccion="a",
ProveedorPAE=true,
OperadorMAER=true,
CertificadoMAERPath="a",
OperadorMAIP=true,
OperadorMAEM=true,
OperadorPAEC=true,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Operadores v = (Operadores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Operadores c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Operadores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Operadores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Operadores).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoEstadoOperador=2;
_Objeto.ID_SubTipoRegistroMercantil=2;
_Objeto.ID_Divipola=2;
_Objeto.ID_UsuarioEntidad=1;
_Objeto.ID_Tipoldentificacion=2;
_Objeto.NombreRazonSocial="a";
_Objeto.Nit="a";
_Objeto.DV=1;
_Objeto.RUTPath="a";
_Objeto.NombreRepresentanteLegal="a";
_Objeto.ApellidoRepresentanteLegal="a";
_Objeto.Numeroldentificacion=1;
_Objeto.Correo="a";
_Objeto.Telefono="a";
_Objeto.Direccion="a";
_Objeto.ProveedorPAE=true;
_Objeto.OperadorMAER=true;
_Objeto.CertificadoMAERPath="a";
_Objeto.OperadorMAIP=true;
_Objeto.OperadorMAEM=true;
_Objeto.OperadorPAEC=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Operadores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Operadores() { id = i });
      //
      //      // Assert
