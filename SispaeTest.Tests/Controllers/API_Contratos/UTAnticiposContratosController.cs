...
{
    public class UTAnticiposContratosController : ITestCaseOrderer
    {
        private readonly AnticiposContratosController _controller;
        private readonly IAnticiposContratosService _service;
        private readonly AnticiposContratos _Objeto;
        ...
        public UTAnticiposContratosController()
        {
            _service = new UTAnticiposContratosServiceFake();
            _controller = new AnticiposContratosController();

            _Objeto = new AnticiposContratos()
            {
                id = 0,
                ID_tipoperiodicidad = 1,
                ValorAnticipo = 1,
                PorcentajeAnticipo = 1,
                TipoPeriodicidadld = 1,
                NumeroPagos = 1,
                auditoria = "a",
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            AnticiposContratos v = (AnticiposContratos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            AnticiposContratos c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<AnticiposContratos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<AnticiposContratos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as AnticiposContratos).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_tipoperiodicidad = 1;
            _Objeto.ValorAnticipo = 1;
            _Objeto.PorcentajeAnticipo = 1;
            _Objeto.TipoPeriodicidadld = 1;
            _Objeto.NumeroPagos = 1;
            _Objeto.auditoria = "a";
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("AnticiposContratos"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new AnticiposContratos() { id = i });
        //
        //      // Assert
