...
{
    public  class UTTipoModificacionContratoController: ITestCaseOrderer
    {
        private readonly TipoModificacionContratoController _controller;
        private readonly ITipoModificacionContratoService _service;
        private readonly TipoModificacionContrato _Objeto;
        ...
        public UTTipoModificacionContratoController()
        {
            _service = new UTTipoModificacionContratoServiceFake();
            _controller = new TipoModificacionContratoController();
            
             _Objeto = new TipoModificacionContrato()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoModificacionContrato v = (TipoModificacionContrato)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoModificacionContrato c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoModificacionContrato>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoModificacionContrato>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoModificacionContrato).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoModificacionContrato"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoModificacionContrato() { id = i });
      //
      //      // Assert
