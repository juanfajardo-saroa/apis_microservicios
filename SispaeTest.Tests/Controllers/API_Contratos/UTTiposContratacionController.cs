...
{
    public  class UTTiposContratacionController: ITestCaseOrderer
    {
        private readonly TiposContratacionController _controller;
        private readonly ITiposContratacionService _service;
        private readonly TiposContratacion _Objeto;
        ...
        public UTTiposContratacionController()
        {
            _service = new UTTiposContratacionServiceFake();
            _controller = new TiposContratacionController();
            
             _Objeto = new TiposContratacion()
            {
                id=0,
Nombre="a",
CodigoCHIP=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposContratacion v = (TiposContratacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposContratacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposContratacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposContratacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposContratacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposContratacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposContratacion() { id = i });
      //
      //      // Assert
