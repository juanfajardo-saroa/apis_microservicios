...
{
    public  class UTTiposConceptoGastoController: ITestCaseOrderer
    {
        private readonly TiposConceptoGastoController _controller;
        private readonly ITiposConceptoGastoService _service;
        private readonly TiposConceptoGasto _Objeto;
        ...
        public UTTiposConceptoGastoController()
        {
            _service = new UTTiposConceptoGastoServiceFake();
            _controller = new TiposConceptoGastoController();
            
             _Objeto = new TiposConceptoGasto()
            {
                id=0,
Nombre="a",
CodigoCHIP="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposConceptoGasto v = (TiposConceptoGasto)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposConceptoGasto c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposConceptoGasto>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposConceptoGasto>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposConceptoGasto).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposConceptoGasto"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposConceptoGasto() { id = i });
      //
      //      // Assert
