...
{
    public class UTMinutaPatronAlimentosController : ITestCaseOrderer
    {
        private readonly MinutaPatronAlimentosController _controller;
        private readonly IMinutaPatronAlimentosService _service;
        private readonly MinutaPatronAlimentos _Objeto;
        ...
        public UTMinutaPatronAlimentosController()
        {
            _service = new UTMinutaPatronAlimentosServiceFake();
            _controller = new MinutaPatronAlimentosController();

            _Objeto = new MinutaPatronAlimentos()
            {
                id = 0,
                Nombre = "a",
                ID_TipoMinutaPatron = 1,
                ID_TipoEstadoMinuta = 1,
        ...
        */
        public void T01_InsertarUnregistro()
        {
            ...
            MinutaPatronAlimentos v = (MinutaPatronAlimentos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto()
        {
            ...
            //Obtenemos un objeto
            MinutaPatronAlimentos c = _service.GetById(i);
     ...
     */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MinutaPatronAlimentos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MinutaPatronAlimentos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MinutaPatronAlimentos).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.Nombre = "a";
            _Objeto.ID_TipoMinutaPatron = 2;
            _Objeto.ID_TipoEstadoMinuta = 2;
       ...
       */
        ...
        //
        //      // Assert
        //      if (!_service.ValidateForeignKey("MinutaPatronAlimentos"))
       ...
       */
        ...
        //
        //      // Act
        //      var okResponse = _controller.Delete(new MinutaPatronAlimentos() { id = i });
        //
        //      // Assert
