...
using System;
using System.Linq;
using SISPAE_API_Configuracion.WebAPI.Controllers;
...
{
    public  class UTExcedentesRacionesController: ITestCaseOrderer
    {
        private readonly ExcedentesRacionesController _controller;
        private readonly IExcedentesRacionesService _service;
        private readonly ExcedentesRaciones _Objeto;
        ...
        public UTExcedentesRacionesController()
        {
            _service = new UTExcedentesRacionesServiceFake();
            _controller = new ExcedentesRacionesController();
            
             _Objeto = new ExcedentesRaciones()
            {
                id=0,
ID_Comite=1,
ID_GradoSedeJornada=1,
ID_TipoDestinoRacion=1,
FechaReporte=DateTime.Now,
CantExcedentes=1,
auditoria="a",
Justificacion="a",
Id_TipoEstadoExcedentesRaciones=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            ExcedentesRaciones v = (ExcedentesRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            ExcedentesRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<ExcedentesRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<ExcedentesRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as ExcedentesRaciones).id);
        }
...
_Objeto.ID_TipoDestinoRacion=2;
_Objeto.FechaReporte=DateTime.Now;
_Objeto.CantExcedentes=1;
_Objeto.auditoria="a";
_Objeto.Justificacion="a";
_Objeto.Id_TipoEstadoExcedentesRaciones=2;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("ExcedentesRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new ExcedentesRaciones() { id = i });
      //
      //      // Assert
