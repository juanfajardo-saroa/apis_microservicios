...
{
    public  class UTTiposRegistroMercantilController: ITestCaseOrderer
    {
        private readonly TiposRegistroMercantilController _controller;
        private readonly ITiposRegistroMercantilService _service;
        private readonly TiposRegistroMercantil _Objeto;
        ...
        public UTTiposRegistroMercantilController()
        {
            _service = new UTTiposRegistroMercantilServiceFake();
            _controller = new TiposRegistroMercantilController();
            
             _Objeto = new TiposRegistroMercantil()
            {
                id=0,
Nombre="a",
CodigoSHIP=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposRegistroMercantil v = (TiposRegistroMercantil)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposRegistroMercantil c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposRegistroMercantil>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposRegistroMercantil>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposRegistroMercantil).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposRegistroMercantil"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposRegistroMercantil() { id = i });
      //
      //      // Assert
