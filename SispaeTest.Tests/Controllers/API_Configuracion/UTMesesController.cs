...
{
    public  class UTMesesController: ITestCaseOrderer
    {
        private readonly MesesController _controller;
        private readonly IMesesService _service;
        private readonly Meses _Objeto;
        ...
        public UTMesesController()
        {
            _service = new UTMesesServiceFake();
            _controller = new MesesController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Meses v = (Meses)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Meses>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Meses>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Meses).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Meses"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Meses() { id = i });
      //
      //      // Assert
