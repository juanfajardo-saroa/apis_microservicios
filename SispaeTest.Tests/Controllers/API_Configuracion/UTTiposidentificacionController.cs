...
{
    public  class UTTiposidentificacionController: ITestCaseOrderer
    {
        private readonly TiposidentificacionController _controller;
        private readonly ITiposidentificacionService _service;
        private readonly Tiposidentificacion _Objeto;
        ...
        public UTTiposidentificacionController()
        {
            _service = new UTTiposidentificacionServiceFake();
            _controller = new TiposidentificacionController();
            
             _Objeto = new Tiposidentificacion()
            {
                id=0,
Nombre="a",
CodigoCHIP=1,
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Tiposidentificacion v = (Tiposidentificacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Tiposidentificacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Tiposidentificacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Tiposidentificacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Tiposidentificacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Tiposidentificacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Tiposidentificacion() { id = i });
      //
      //      // Assert
