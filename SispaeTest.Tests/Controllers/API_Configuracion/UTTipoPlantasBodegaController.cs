...
{
    public  class UTTipoPlantasBodegaController: ITestCaseOrderer
    {
        private readonly TipoPlantasBodegaController _controller;
        private readonly ITipoPlantasBodegaService _service;
        private readonly TipoPlantasBodega _Objeto;
        ...
        public UTTipoPlantasBodegaController()
        {
            _service = new UTTipoPlantasBodegaServiceFake();
            _controller = new TipoPlantasBodegaController();
            
             _Objeto = new TipoPlantasBodega()
            {
                id=0,
Nombre="aaa",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoPlantasBodega v = (TipoPlantasBodega)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoPlantasBodega c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoPlantasBodega>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoPlantasBodega>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoPlantasBodega).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoPlantasBodega"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoPlantasBodega() { id = i });
      //
      //      // Assert
