...
{
    public  class UTTiposModalidadMesaController: ITestCaseOrderer
    {
        private readonly TiposModalidadMesaController _controller;
        private readonly ITiposModalidadMesaService _service;
        private readonly TiposModalidadMesa _Objeto;
        ...
        public UTTiposModalidadMesaController()
        {
            _service = new UTTiposModalidadMesaServiceFake();
            _controller = new TiposModalidadMesaController();
            
             _Objeto = new TiposModalidadMesa()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposModalidadMesa v = (TiposModalidadMesa)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposModalidadMesa c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposModalidadMesa>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposModalidadMesa>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposModalidadMesa).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposModalidadMesa"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposModalidadMesa() { id = i });
      //
      //      // Assert
