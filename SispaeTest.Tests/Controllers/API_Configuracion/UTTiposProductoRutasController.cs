...
{
    public  class UTTiposProductoRutasController: ITestCaseOrderer
    {
        private readonly TiposProductoRutasController _controller;
        private readonly ITiposProductoRutasService _service;
        private readonly TiposProductoRutas _Objeto;
        ...
        public UTTiposProductoRutasController()
        {
            _service = new UTTiposProductoRutasServiceFake();
            _controller = new TiposProductoRutasController();
            
             _Objeto = new TiposProductoRutas()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposProductoRutas v = (TiposProductoRutas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposProductoRutas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposProductoRutas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposProductoRutas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposProductoRutas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposProductoRutas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposProductoRutas() { id = i });
      //
      //      // Assert
