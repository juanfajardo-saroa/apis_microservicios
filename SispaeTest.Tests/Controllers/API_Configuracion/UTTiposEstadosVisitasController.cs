...
{
    public  class UTTiposEstadosVisitasController: ITestCaseOrderer
    {
        private readonly TiposEstadosVisitasController _controller;
        private readonly ITiposEstadosVisitasService _service;
        private readonly TiposEstadosVisitas _Objeto;
        ...
        public UTTiposEstadosVisitasController()
        {
            _service = new UTTiposEstadosVisitasServiceFake();
            _controller = new TiposEstadosVisitasController();
            
             _Objeto = new TiposEstadosVisitas()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadosVisitas v = (TiposEstadosVisitas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadosVisitas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadosVisitas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadosVisitas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadosVisitas).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadosVisitas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadosVisitas() { id = i });
      //
      //      // Assert
