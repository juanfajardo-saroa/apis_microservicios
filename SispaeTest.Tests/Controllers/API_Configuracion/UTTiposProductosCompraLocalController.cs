...
{
    public  class UTTiposProductosCompraLocalController: ITestCaseOrderer
    {
        private readonly TiposProductosCompraLocalController _controller;
        private readonly ITiposProductosCompraLocalService _service;
        private readonly TiposProductosCompraLocal _Objeto;
        ...
        public UTTiposProductosCompraLocalController()
        {
            _service = new UTTiposProductosCompraLocalServiceFake();
            _controller = new TiposProductosCompraLocalController();
            
             _Objeto = new TiposProductosCompraLocal()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposProductosCompraLocal v = (TiposProductosCompraLocal)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposProductosCompraLocal c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposProductosCompraLocal>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposProductosCompraLocal>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposProductosCompraLocal).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposProductosCompraLocal"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposProductosCompraLocal() { id = i });
      //
      //      // Assert
