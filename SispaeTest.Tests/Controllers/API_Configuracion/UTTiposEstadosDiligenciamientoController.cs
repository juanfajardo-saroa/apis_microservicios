...
{
    public  class UTTiposEstadosDiligenciamientoController: ITestCaseOrderer
    {
        private readonly TiposEstadosDiligenciamientoController _controller;
        private readonly ITiposEstadosDiligenciamientoService _service;
        private readonly TiposEstadosDiligenciamiento _Objeto;
        ...
        public UTTiposEstadosDiligenciamientoController()
        {
            _service = new UTTiposEstadosDiligenciamientoServiceFake();
            _controller = new TiposEstadosDiligenciamientoController();
            
             _Objeto = new TiposEstadosDiligenciamiento()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadosDiligenciamiento v = (TiposEstadosDiligenciamiento)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadosDiligenciamiento c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadosDiligenciamiento>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadosDiligenciamiento>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadosDiligenciamiento).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadosDiligenciamiento"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadosDiligenciamiento() { id = i });
      //
      //      // Assert
