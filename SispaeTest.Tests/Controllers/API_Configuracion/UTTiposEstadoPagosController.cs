...
{
    public  class UTTiposEstadoPagosController: ITestCaseOrderer
    {
        private readonly TiposEstadoPagosController _controller;
        private readonly ITiposEstadoPagosService _service;
        private readonly TiposEstadoPagos _Objeto;
        ...
        public UTTiposEstadoPagosController()
        {
            _service = new UTTiposEstadoPagosServiceFake();
            _controller = new TiposEstadoPagosController();
            
             _Objeto = new TiposEstadoPagos()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadoPagos v = (TiposEstadoPagos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadoPagos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadoPagos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadoPagos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadoPagos).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadoPagos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadoPagos() { id = i });
      //
      //      // Assert
