...
{
    public  class UTTiposCriterioEvaluacionController: ITestCaseOrderer
    {
        private readonly TiposCriterioEvaluacionController _controller;
        private readonly ITiposCriterioEvaluacionService _service;
        private readonly TiposCriterioEvaluacion _Objeto;
        ...
        public UTTiposCriterioEvaluacionController()
        {
            _service = new UTTiposCriterioEvaluacionServiceFake();
            _controller = new TiposCriterioEvaluacionController();
            
             _Objeto = new TiposCriterioEvaluacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposCriterioEvaluacion v = (TiposCriterioEvaluacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposCriterioEvaluacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposCriterioEvaluacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposCriterioEvaluacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposCriterioEvaluacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposCriterioEvaluacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposCriterioEvaluacion() { id = i });
      //
      //      // Assert
