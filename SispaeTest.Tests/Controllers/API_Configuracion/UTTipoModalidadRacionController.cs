...
{
    public  class UTTipoModalidadRacionController: ITestCaseOrderer
    {
        private readonly TipoModalidadRacionController _controller;
        private readonly ITipoModalidadRacionService _service;
        private readonly TipoModalidadRacion _Objeto;
        ...
        public UTTipoModalidadRacionController()
        {
            _service = new UTTipoModalidadRacionServiceFake();
            _controller = new TipoModalidadRacionController();
            
             _Objeto = new TipoModalidadRacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoModalidadRacion v = (TipoModalidadRacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoModalidadRacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoModalidadRacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoModalidadRacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoModalidadRacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoModalidadRacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoModalidadRacion() { id = i });
      //
      //      // Assert
