...
{
    public  class UTTiposEstadoOperadorController: ITestCaseOrderer
    {
        private readonly TiposEstadoOperadorController _controller;
        private readonly ITiposEstadoOperadorService _service;
        private readonly TiposEstadoOperador _Objeto;
        ...
        public UTTiposEstadoOperadorController()
        {
            _service = new UTTiposEstadoOperadorServiceFake();
            _controller = new TiposEstadoOperadorController();
            
             _Objeto = new TiposEstadoOperador()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadoOperador v = (TiposEstadoOperador)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadoOperador c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadoOperador>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadoOperador>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadoOperador).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadoOperador"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadoOperador() { id = i });
      //
      //      // Assert
