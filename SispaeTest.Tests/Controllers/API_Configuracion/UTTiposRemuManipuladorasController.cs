...
{
    public  class UTTiposRemuManipuladorasController: ITestCaseOrderer
    {
        private readonly TiposRemuManipuladorasController _controller;
        private readonly ITiposRemuManipuladorasService _service;
        private readonly TiposRemuManipuladoras _Objeto;
        ...
        public UTTiposRemuManipuladorasController()
        {
            _service = new UTTiposRemuManipuladorasServiceFake();
            _controller = new TiposRemuManipuladorasController();
            
             _Objeto = new TiposRemuManipuladoras()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposRemuManipuladoras v = (TiposRemuManipuladoras)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposRemuManipuladoras c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposRemuManipuladoras>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposRemuManipuladoras>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposRemuManipuladoras).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposRemuManipuladoras"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposRemuManipuladoras() { id = i });
      //
      //      // Assert
