...
{
    public  class UTTipoEstadoExcedentesRacionesController: ITestCaseOrderer
    {
        private readonly TipoEstadoExcedentesRacionesController _controller;
        private readonly ITipoEstadoExcedentesRacionesService _service;
        private readonly TipoEstadoExcedentesRaciones _Objeto;
        ...
        public UTTipoEstadoExcedentesRacionesController()
        {
            _service = new UTTipoEstadoExcedentesRacionesServiceFake();
            _controller = new TipoEstadoExcedentesRacionesController();
            
             _Objeto = new TipoEstadoExcedentesRaciones()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoEstadoExcedentesRaciones v = (TipoEstadoExcedentesRaciones)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoEstadoExcedentesRaciones c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoEstadoExcedentesRaciones>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoEstadoExcedentesRaciones>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoEstadoExcedentesRaciones).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoEstadoExcedentesRaciones"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoEstadoExcedentesRaciones() { id = i });
      //
      //      // Assert
