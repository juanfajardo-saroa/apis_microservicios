...
{
    public  class UTTiposTiemposEntregaController: ITestCaseOrderer
    {
        private readonly TiposTiemposEntregaController _controller;
        private readonly ITiposTiemposEntregaService _service;
        private readonly TiposTiemposEntrega _Objeto;
        ...
        public UTTiposTiemposEntregaController()
        {
            _service = new UTTiposTiemposEntregaServiceFake();
            _controller = new TiposTiemposEntregaController();
            
             _Objeto = new TiposTiemposEntrega()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposTiemposEntrega v = (TiposTiemposEntrega)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposTiemposEntrega c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposTiemposEntrega>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposTiemposEntrega>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposTiemposEntrega).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposTiemposEntrega"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposTiemposEntrega() { id = i });
      //
      //      // Assert
