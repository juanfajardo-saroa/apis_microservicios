...
{
    public  class UTTiposEstadoValidacionEntregaController: ITestCaseOrderer
    {
        private readonly TiposEstadoValidacionEntregaController _controller;
        private readonly ITiposEstadoValidacionEntregaService _service;
        private readonly TiposEstadoValidacionEntrega _Objeto;
        ...
        public UTTiposEstadoValidacionEntregaController()
        {
            _service = new UTTiposEstadoValidacionEntregaServiceFake();
            _controller = new TiposEstadoValidacionEntregaController();
            
             _Objeto = new TiposEstadoValidacionEntrega()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadoValidacionEntrega v = (TiposEstadoValidacionEntrega)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadoValidacionEntrega c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadoValidacionEntrega>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadoValidacionEntrega>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadoValidacionEntrega).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadoValidacionEntrega"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadoValidacionEntrega() { id = i });
      //
      //      // Assert
