...
{
    public  class UTTipoReglaComprasLocalesController: ITestCaseOrderer
    {
        private readonly TipoReglaComprasLocalesController _controller;
        private readonly ITipoReglaComprasLocalesService _service;
        private readonly TipoReglaComprasLocales _Objeto;
        ...
        public UTTipoReglaComprasLocalesController()
        {
            _service = new UTTipoReglaComprasLocalesServiceFake();
            _controller = new TipoReglaComprasLocalesController();
            
             _Objeto = new TipoReglaComprasLocales()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoReglaComprasLocales v = (TipoReglaComprasLocales)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoReglaComprasLocales c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoReglaComprasLocales>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoReglaComprasLocales>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoReglaComprasLocales).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoReglaComprasLocales"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoReglaComprasLocales() { id = i });
      //
      //      // Assert
