...
{
    public  class UTTipoMunicipioController: ITestCaseOrderer
    {
        private readonly TipoMunicipioController _controller;
        private readonly ITipoMunicipioService _service;
        private readonly TipoMunicipio _Objeto;
        ...
        public UTTipoMunicipioController()
        {
            _service = new UTTipoMunicipioServiceFake();
            _controller = new TipoMunicipioController();
            
             _Objeto = new TipoMunicipio()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoMunicipio v = (TipoMunicipio)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoMunicipio c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoMunicipio>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoMunicipio>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoMunicipio).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoMunicipio"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoMunicipio() { id = i });
      //
      //      // Assert
