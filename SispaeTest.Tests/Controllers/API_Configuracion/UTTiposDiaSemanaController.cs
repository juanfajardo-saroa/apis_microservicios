...
{
    public  class UTTiposDiaSemanaController: ITestCaseOrderer
    {
        private readonly TiposDiaSemanaController _controller;
        private readonly ITiposDiaSemanaService _service;
        private readonly TiposDiaSemana _Objeto;
        ...
        public UTTiposDiaSemanaController()
        {
            _service = new UTTiposDiaSemanaServiceFake();
            _controller = new TiposDiaSemanaController();
            
             _Objeto = new TiposDiaSemana()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposDiaSemana v = (TiposDiaSemana)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposDiaSemana c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposDiaSemana>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposDiaSemana>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposDiaSemana).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposDiaSemana"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposDiaSemana() { id = i });
      //
      //      // Assert
