...
{
    public  class UTTiposPoblacionAtendidaController: ITestCaseOrderer
    {
        private readonly TiposPoblacionAtendidaController _controller;
        private readonly ITiposPoblacionAtendidaService _service;
        private readonly TiposPoblacionAtendida _Objeto;
        ...
        public UTTiposPoblacionAtendidaController()
        {
            _service = new UTTiposPoblacionAtendidaServiceFake();
            _controller = new TiposPoblacionAtendidaController();
            
             _Objeto = new TiposPoblacionAtendida()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposPoblacionAtendida v = (TiposPoblacionAtendida)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposPoblacionAtendida c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposPoblacionAtendida>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposPoblacionAtendida>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposPoblacionAtendida).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposPoblacionAtendida"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposPoblacionAtendida() { id = i });
      //
      //      // Assert
