...
{
    public  class UTTiposDinamizadoresController: ITestCaseOrderer
    {
        private readonly TiposDinamizadoresController _controller;
        private readonly ITiposDinamizadoresService _service;
        private readonly TiposDinamizadores _Objeto;
        ...
        public UTTiposDinamizadoresController()
        {
            _service = new UTTiposDinamizadoresServiceFake();
            _controller = new TiposDinamizadoresController();
            
             _Objeto = new TiposDinamizadores()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposDinamizadores v = (TiposDinamizadores)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposDinamizadores c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposDinamizadores>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposDinamizadores>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposDinamizadores).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposDinamizadores"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposDinamizadores() { id = i });
      //
      //      // Assert
