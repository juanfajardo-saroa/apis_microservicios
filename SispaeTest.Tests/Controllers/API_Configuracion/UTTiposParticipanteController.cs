...
{
    public  class UTTiposParticipanteController: ITestCaseOrderer
    {
        private readonly TiposParticipanteController _controller;
        private readonly ITiposParticipanteService _service;
        private readonly TiposParticipante _Objeto;
        ...
        public UTTiposParticipanteController()
        {
            _service = new UTTiposParticipanteServiceFake();
            _controller = new TiposParticipanteController();
            
             _Objeto = new TiposParticipante()
            {
                id=0,
ID_TipoDinamizador=1,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposParticipante v = (TiposParticipante)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposParticipante c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposParticipante>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposParticipante>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposParticipante).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposParticipante"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposParticipante() { id = i });
      //
      //      // Assert
