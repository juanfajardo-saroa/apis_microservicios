...
{
    public  class UTTiposOperacionController: ITestCaseOrderer
    {
        private readonly TiposOperacionController _controller;
        private readonly ITiposOperacionService _service;
        private readonly TiposOperacion _Objeto;
        ...
        public UTTiposOperacionController()
        {
            _service = new UTTiposOperacionServiceFake();
            _controller = new TiposOperacionController();
            
             _Objeto = new TiposOperacion()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposOperacion v = (TiposOperacion)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposOperacion c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposOperacion>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposOperacion>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposOperacion).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposOperacion"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposOperacion() { id = i });
      //
      //      // Assert
