...
{
    public  class UTDivipolasController: ITestCaseOrderer
    {
        private readonly DivipolasController _controller;
        private readonly IDivipolasService _service;
        private readonly Divipolas _Objeto;
        ...
        public UTDivipolasController()
        {
            _service = new UTDivipolasServiceFake();
            _controller = new DivipolasController();
            
             _Objeto = new Divipolas()
            {
                id=0,
DepartamentoCode="a",
MunicipioCode="a",
CentroPobladoCode="a",
DepartamentoNombre="a",
Nombre="a",
CentroPobladoNombre="a",
auditoria="a",
Id_TipoMunicipio=1,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Divipolas v = (Divipolas)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            Divipolas c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Divipolas>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Divipolas>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Divipolas).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.DepartamentoCode="a";
_Objeto.MunicipioCode="a";
_Objeto.CentroPobladoCode="a";
_Objeto.DepartamentoNombre="a";
_Objeto.Nombre="a";
_Objeto.CentroPobladoNombre="a";
_Objeto.auditoria="a";
_Objeto.Id_TipoMunicipio=2;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Divipolas"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Divipolas() { id = i });
      //
      //      // Assert
