...
{
    public  class UTTiposGrupoEtarioController: ITestCaseOrderer
    {
        private readonly TiposGrupoEtarioController _controller;
        private readonly ITiposGrupoEtarioService _service;
        private readonly TiposGrupoEtario _Objeto;
        ...
        public UTTiposGrupoEtarioController()
        {
            _service = new UTTiposGrupoEtarioServiceFake();
            _controller = new TiposGrupoEtarioController();
            
             _Objeto = new TiposGrupoEtario()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposGrupoEtario v = (TiposGrupoEtario)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposGrupoEtario c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposGrupoEtario>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposGrupoEtario>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposGrupoEtario).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposGrupoEtario"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposGrupoEtario() { id = i });
      //
      //      // Assert
