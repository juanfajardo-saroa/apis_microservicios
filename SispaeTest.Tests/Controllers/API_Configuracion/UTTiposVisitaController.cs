...
{
    public  class UTTiposVisitaController: ITestCaseOrderer
    {
        private readonly TiposVisitaController _controller;
        private readonly ITiposVisitaService _service;
        private readonly TiposVisita _Objeto;
        ...
        public UTTiposVisitaController()
        {
            _service = new UTTiposVisitaServiceFake();
            _controller = new TiposVisitaController();
            
             _Objeto = new TiposVisita()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposVisita v = (TiposVisita)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposVisita c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposVisita>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposVisita>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposVisita).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposVisita"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposVisita() { id = i });
      //
      //      // Assert
