...
{
    public  class UTTiposPoblacionEtnicaController: ITestCaseOrderer
    {
        private readonly TiposPoblacionEtnicaController _controller;
        private readonly ITiposPoblacionEtnicaService _service;
        private readonly TiposPoblacionEtnica _Objeto;
        ...
        public UTTiposPoblacionEtnicaController()
        {
            _service = new UTTiposPoblacionEtnicaServiceFake();
            _controller = new TiposPoblacionEtnicaController();
            
             _Objeto = new TiposPoblacionEtnica()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposPoblacionEtnica v = (TiposPoblacionEtnica)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposPoblacionEtnica c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposPoblacionEtnica>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposPoblacionEtnica>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposPoblacionEtnica).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposPoblacionEtnica"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposPoblacionEtnica() { id = i });
      //
      //      // Assert
