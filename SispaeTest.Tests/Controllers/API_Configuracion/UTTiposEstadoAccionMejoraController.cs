...
{
    public  class UTTiposEstadoAccionMejoraController: ITestCaseOrderer
    {
        private readonly TiposEstadoAccionMejoraController _controller;
        private readonly ITiposEstadoAccionMejoraService _service;
        private readonly TiposEstadoAccionMejora _Objeto;
        ...
        public UTTiposEstadoAccionMejoraController()
        {
            _service = new UTTiposEstadoAccionMejoraServiceFake();
            _controller = new TiposEstadoAccionMejoraController();
            
             _Objeto = new TiposEstadoAccionMejora()
            {
                id=0,
nombre=new byte[] { 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 },
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadoAccionMejora v = (TiposEstadoAccionMejora)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadoAccionMejora c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadoAccionMejora>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadoAccionMejora>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadoAccionMejora).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.nombre=new byte[] { 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20 };
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadoAccionMejora"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadoAccionMejora() { id = i });
      //
      //      // Assert
