...
{
    public  class UTRolPermisosController: ITestCaseOrderer
    {
        private readonly RolPermisosController _controller;
        private readonly IRolPermisosService _service;
        private readonly RolPermisos _Objeto;
        ...
        public UTRolPermisosController()
        {
            _service = new UTRolPermisosServiceFake();
            _controller = new RolPermisosController();
            
             _Objeto = new RolPermisos()
            {
                id=0,
id_Rol="1",
id_Modulo=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            RolPermisos v = (RolPermisos)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            RolPermisos c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<RolPermisos>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<RolPermisos>(okResult.Value);
            Assert.Equal(i, (okResult.Value as RolPermisos).id);
        }
...
_Objeto.Crear=true;
_Objeto.Editar=true;
_Objeto.Eliminar=true;
_Objeto.Aprobar=true;
_Objeto.Imprimir=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("RolPermisos"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new RolPermisos() { id = i });
      //
      //      // Assert
