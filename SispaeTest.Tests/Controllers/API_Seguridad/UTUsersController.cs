...
{
    public  class UTUsersController: ITestCaseOrderer
    {
        private readonly UsersController _controller;
        private readonly IUsersService _service;
        private readonly Users _Objeto;
        ...
        public UTUsersController()
        {
            _service = new UTUsersServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Users v = (Users)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Users>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Users>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Users).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.Email="a";
_Objeto.Passwordhash="a";
_Objeto.SegurityStamp="a";
_Objeto.UserName="a";
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Users"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Users() { id = i });
      //
      //      // Assert
