...
{
    public  class UTModuloController: ITestCaseOrderer
    {
        private readonly ModuloController _controller;
        private readonly IModuloService _service;
        private readonly Modulo _Objeto;
        ...
        public UTModuloController()
        {
            _service = new UTModuloServiceFake();
            _controller = new ModuloController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Modulo v = (Modulo)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Modulo>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Modulo>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Modulo).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Modulo"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Modulo() { id = i });
      //
      //      // Assert
