...
{
    public  class UTMenuRolController: ITestCaseOrderer
    {
        private readonly MenuRolController _controller;
        private readonly IMenuRolService _service;
        private readonly MenuRol _Objeto;
        ...
        public UTMenuRolController()
        {
            _service = new UTMenuRolServiceFake();
            _controller = new MenuRolController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            MenuRol v = (MenuRol)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<MenuRol>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<MenuRol>(okResult.Value);
            Assert.Equal(i, (okResult.Value as MenuRol).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("MenuRol"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new MenuRol() { id = i });
      //
      //      // Assert
