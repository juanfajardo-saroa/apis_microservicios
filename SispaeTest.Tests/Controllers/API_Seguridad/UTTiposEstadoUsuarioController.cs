...
{
    public  class UTTiposEstadoUsuarioController: ITestCaseOrderer
    {
        private readonly TiposEstadoUsuarioController _controller;
        private readonly ITiposEstadoUsuarioService _service;
        private readonly TiposEstadoUsuario _Objeto;
        ...
        public UTTiposEstadoUsuarioController()
        {
            _service = new UTTiposEstadoUsuarioServiceFake();
            _controller = new TiposEstadoUsuarioController();
            
             _Objeto = new TiposEstadoUsuario()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TiposEstadoUsuario v = (TiposEstadoUsuario)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TiposEstadoUsuario c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TiposEstadoUsuario>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TiposEstadoUsuario>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TiposEstadoUsuario).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TiposEstadoUsuario"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TiposEstadoUsuario() { id = i });
      //
      //      // Assert
