...
{
    public  class UTMensajesController: ITestCaseOrderer
    {
        private readonly MensajesController _controller;
        private readonly IMensajesService _service;
        private readonly Mensajes _Objeto;
        ...
        public UTMensajesController()
        {
            _service = new UTMensajesServiceFake();
            _controller = new MensajesController();
            
             _Objeto = new Mensajes()
            {
                id=0,
ID_UserEmisor=1,
ID_UserReceptor=1,
...
Mensajes="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Mensajes v = (Mensajes)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Mensajes>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Mensajes>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Mensajes).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_UserEmisor=2;
_Objeto.ID_UserReceptor=2;
...
_Objeto.Mensajes="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Mensajes"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Mensajes() { id = i });
      //
      //      // Assert
