...
{
    public  class UTMenuController: ITestCaseOrderer
    {
        private readonly MenuController _controller;
        private readonly IMenuService _service;
        private readonly Menu _Objeto;
        ...
        public UTMenuController()
        {
            _service = new UTMenuServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Menu v = (Menu)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Menu>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Menu>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Menu).id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.Nombre="a";
_Objeto.Controlador="a";
_Objeto.Accion="a";
_Objeto.GrupoEsquema="a";
_Objeto.Link="a";
_Objeto.Orden=1;
_Objeto.OrdenPadre=1;
_Objeto.Padre=1;
_Objeto.Icono="a";
_Objeto.EstadoMenu=true;
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Menu"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Menu() { id = i });
      //
      //      // Assert
