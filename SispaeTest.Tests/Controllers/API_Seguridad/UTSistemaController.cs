...
namespace SISPAE.Tests.Controllers
{
    public  class UTSistemaController: ITestCaseOrderer
    {
        ...
        public UTSistemaController()
        {
            _service = new UTSistemaServiceFake();
            _controller = new SistemaController();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Sistema v = (Sistema)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Sistema>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Sistema>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Sistema).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Sistema"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Sistema() { id = i });
      //
      //      // Assert
