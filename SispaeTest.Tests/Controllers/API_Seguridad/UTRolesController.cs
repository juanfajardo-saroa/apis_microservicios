...
{
    public  class UTRolesController: ITestCaseOrderer
    {
        private readonly RolesController _controller;
        private readonly IRolesService _service;
        private readonly Roles _Objeto;
        ...
        public UTRolesController()
        {
            _service = new UTRolesServiceFake();
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            Roles v = (Roles)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<Roles>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<Roles>(okResult.Value);
            Assert.Equal(i, (okResult.Value as Roles).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("Roles"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new Roles() { id = i });
      //
      //      // Assert
