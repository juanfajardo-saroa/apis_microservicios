...
{
    public  class UTTipoRolesController: ITestCaseOrderer
    {
        private readonly TipoRolesController _controller;
        private readonly ITipoRolesService _service;
        private readonly TipoRoles _Objeto;
        ...
        public UTTipoRolesController()
        {
            _service = new UTTipoRolesServiceFake();
            _controller = new TipoRolesController();
            
             _Objeto = new TipoRoles()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoRoles v = (TipoRoles)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoRoles c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoRoles>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoRoles>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoRoles).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoRoles"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoRoles() { id = i });
      //
      //      // Assert
