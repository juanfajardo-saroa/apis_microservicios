...
using System;
using System.Linq;
using SISPAE_API_Seguridad.WebAPI.Controllers;
...
{
    public  class UTUsuariosEntidadesController: ITestCaseOrderer
    {
        private readonly UsuariosEntidadesController _controller;
        private readonly IUsuariosEntidadesService _service;
        private readonly UsuariosEntidades _Objeto;
        ...
        public UTUsuariosEntidadesController()
        {
            _service = new UTUsuariosEntidadesServiceFake();
            _controller = new UsuariosEntidadesController();
            
             _Objeto = new UsuariosEntidades()
            {
                id=0,
ID_TipoEstadoUsuario=1,
ID_User=1,
ID_Roles=1,
ID_ETC=1,
ID_ET=1,
...
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            UsuariosEntidades v = (UsuariosEntidades)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            UsuariosEntidades c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<UsuariosEntidades>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<UsuariosEntidades>(okResult.Value);
            Assert.Equal(i, (okResult.Value as UsuariosEntidades).id);
        }
        ...
        */
        ...
        {
            //Arrange
            _Objeto.ID_TipoEstadoUsuario=2;
_Objeto.ID_User=2;
_Objeto.ID_Roles=2;
_Objeto.ID_ETC=2;
_Objeto.ID_ET=2;
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("UsuariosEntidades"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new UsuariosEntidades() { id = i });
      //
      //      // Assert
