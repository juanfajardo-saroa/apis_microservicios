...
{
    public  class UTTipoActorController: ITestCaseOrderer
    {
        private readonly TipoActorController _controller;
        private readonly ITipoActorService _service;
        private readonly TipoActor _Objeto;
        ...
        public UTTipoActorController()
        {
            _service = new UTTipoActorServiceFake();
            _controller = new TipoActorController();
            
             _Objeto = new TipoActor()
            {
                id=0,
Nombre="a",
auditoria="a",
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TipoActor v = (TipoActor)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.id = v.id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TipoActor c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TipoActor>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TipoActor>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TipoActor).id);
        }
...
_Objeto.auditoria="a";
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TipoActor"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TipoActor() { id = i });
      //
      //      // Assert
