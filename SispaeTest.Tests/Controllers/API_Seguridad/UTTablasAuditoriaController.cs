...
{
    public  class UTTablasAuditoriaController: ITestCaseOrderer
    {
        private readonly TablasAuditoriaController _controller;
        private readonly ITablasAuditoriaService _service;
        private readonly TablasAuditoria _Objeto;
        ...
        public UTTablasAuditoriaController()
        {
            _service = new UTTablasAuditoriaServiceFake();
            _controller = new TablasAuditoriaController();
            
             _Objeto = new TablasAuditoria()
            {
                Id=0,
Esquema="a",
Table_Name="a",
...
AuditTabla=true,
        ...
        public void T01_InsertarUnregistro()
        {
            ...
            TablasAuditoria v = (TablasAuditoria)((Microsoft.AspNetCore.Mvc.ObjectResult)okResult).Value;
            _Objeto.Id = v.Id;
        ...
        */
        public void T02_Post_Objeto() 
        {
            ...
            //Obtenemos un objeto
            TablasAuditoria c =  _service.GetById(i);
       ...
       */
        ...
        */
        public void T6_Obtener_CuandoLLama_GetAllTodosLosResultados()
        {
            ...
            var i = (IEnumerable<TablasAuditoria>)okResult.Value;
     ...
     */
        ...
        */
        public void T14_GetById_ExistenteID_ReturnamismoID()
        {
            ...
            // Assert
            Assert.IsType<TablasAuditoria>(okResult.Value);
            Assert.Equal(i, (okResult.Value as TablasAuditoria).Id);
        }
        ...
        */
        public void T15_ActualizarUnregistroInsertado()
        {
            //Arrange
            _Objeto.Esquema="a";
_Objeto.Table_Name="a";
_Objeto.Nombre="a";
_Objeto.auditoria="a";
_Objeto.AuditCampo=true;
_Objeto.AuditTabla=true;
      ...
      //
      //      // Assert
      //      if (!_service.ValidateForeignKey("TablasAuditoria"))
      ...
      //
      //      // Act
      //      var okResponse = _controller.Delete(new TablasAuditoria() { id = i });
      //
      //      // Assert
