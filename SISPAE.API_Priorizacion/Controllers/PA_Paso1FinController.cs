...
{
    [SwaggerTag("Web API para CRUD de PA_Paso1Fin .")]
    [Route("api/[controller]/[Action]")]
    [ApiController] 
    public partial class PA_Paso1FinController : ControllerBase
    {
        ...
        /// </summary>
        /// <remarks>
        /// Esta WebAPI permite consultar los registros existentes en SISPAE_API_Priorizacion de la entidad  PA_Paso1Fin!
        ...
        /// <response code="500">Oops! No puede consultar PA_Paso1Fin en este momento</response>
            ...
            public IActionResult GetAll( int? id_etc)
            {
                ...
                try
                {
                    var result = new PA_Paso1FinMs().GetPA_Paso1Fin(id_etc).Cast<PA_Paso1Fin>().AsQueryable();
                    return Ok(result);
                }
