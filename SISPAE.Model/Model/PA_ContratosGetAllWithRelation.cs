...
{
    /// <Resumen>
    /// Clase Model Base para  PA_ContratosGetAllWithRelation
    ...
    public class PA_ContratosGetAllWithRelationModelBase : ModelObject
    {
        private DateTime _createdFechalnicioContrato;

        public PA_ContratosGetAllWithRelationModelBase()
        {
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: sID_EstadoContrato 
        /// </Resumen> 
        [Display(Name = "s Estado Contrato")]
        [DataType(DataType.MultilineText)]
        public String? sID_EstadoContrato { get; set; }
