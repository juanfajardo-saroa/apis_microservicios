...
{
     /// <Resumen>
     /// Clase Model Base para  MatrizAdiciones
    ...
    public class MatrizAdicionesModelBase : ModelObject
    {
		    public MatrizAdicionesModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_ComponentesAdicion 
        /// </Resumen> 
        [Display(Name = "Componentes Adicion")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_ComponentesAdicion{ get; set; }
