...
{
     /// <Resumen>
     /// Clase Model Base para  CaracteristicasFinancieras
    ...
    public class CaracteristicasFinancierasModelBase : ModelObject
    {
		    public CaracteristicasFinancierasModelBase() 
    {  
    }  
