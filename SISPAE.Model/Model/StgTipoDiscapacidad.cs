...
{
     /// <Resumen>
     /// Clase Model Base para  StgTipoDiscapacidad
    ...
    public class StgTipoDiscapacidadModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgTipoDiscapacidadModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdTipoDiscapacidad 
        /// </Resumen> 
        [Display(Name = "Id Tipo Discapacidad")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
