...
{
     /// <Resumen>
     /// Clase Model Base para  PA_PrioSedeBeneficiarias
    ...
    public class PA_PrioSedeBeneficiariasModelBase : ModelObject
    {
		    public PA_PrioSedeBeneficiariasModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: PorcenSISBENAB 
        /// </Resumen> 
        [Display(Name = "Porcen S I S B E N A B")] 
        public Decimal? PorcenSISBENAB{ get; set; }
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Id_ModeloOperacionER 
        /// </Resumen> 
        [Display(Name = "Modelo Operacion E R")] 
        public int? Id_ModeloOperacionER{ get; set; }
