...
{
     /// <Resumen>
     /// Clase Model Base para  StgPoblacionVictimaConflicto
    ...
    public class StgPoblacionVictimaConflictoModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgPoblacionVictimaConflictoModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdPoblVictiConf 
        /// </Resumen> 
        [Display(Name = "Id Pobl Victi Conf")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(2 , ErrorMessage = " El campo {0} no debe tener mas de 2 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdPoblVictiConf{ get; set; }
