...
{
     /// <Resumen>
     /// Clase Model Base para  NutrientesClaveIntercambios
    ...
    public class NutrientesClaveIntercambiosModelBase : ModelObject
    {
		    public NutrientesClaveIntercambiosModelBase() 
    {  
    }  
