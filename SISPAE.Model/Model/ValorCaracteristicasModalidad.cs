...
{
     /// <Resumen>
     /// Clase Model Base para  ValorCaracteristicasModalidad
    ...
    public class ValorCaracteristicasModalidadModelBase : ModelObject
    {
		    public ValorCaracteristicasModalidadModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_ValorCaracteristica 
        /// </Resumen> 
        [Display(Name = "Valor Caracteristica")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_ValorCaracteristica{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_ValorCaracteristica { get; set; }
        /// 
