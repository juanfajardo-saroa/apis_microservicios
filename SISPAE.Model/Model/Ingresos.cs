...
{
     /// <Resumen>
     /// Clase Model Base para  Ingresos
    ...
    public class IngresosModelBase : ModelObject
    {
		    public IngresosModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_TipoIngreso 
        /// </Resumen> 
        ...
        public String? sID_TipoIngreso { get; set; }
        /// 
        ...
        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_FuenteIngreso { get; set; }
        /// 
