...
{
     /// <Resumen>
     /// Clase Model Base para  ListaOpciones
    ...
    public class ListaOpcionesModelBase : ModelObject
    {
		    public ListaOpcionesModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Lista 
        /// </Resumen> 
        [Display(Name = "Lista")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
