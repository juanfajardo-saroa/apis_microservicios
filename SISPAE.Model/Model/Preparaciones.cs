...
{
     /// <Resumen>
     /// Clase Model Base para  Preparaciones
    ...
    public class PreparacionesModelBase : ModelObject
    {
		private DateTime _createdFechaPreparacion; 
    public PreparacionesModelBase() 
    {  
