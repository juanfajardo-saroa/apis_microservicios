...
{
     /// <Resumen>
     /// Clase Model Base para  DocumentosPA
    ...
    public class DocumentosPAModelBase : ModelObject
    {
		    public DocumentosPAModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_TipoDocumentoPA 
        /// </Resumen> 
        [Display(Name = "Tipo Documento P A")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_TipoDocumentoPA{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_TipoDocumentoPA { get; set; }
        /// 
