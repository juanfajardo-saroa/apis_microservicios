...
{
     /// <Resumen>
     /// Clase Model Base para  StgTipoZona
    ...
    public class StgTipoZonaModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgTipoZonaModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdTipoZona 
        /// </Resumen> 
        [Display(Name = "Id Tipo Zona")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
