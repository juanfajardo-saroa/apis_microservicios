...
{
     /// <Resumen>
     /// Clase Model Base para  CostosComplementos
    ...
    public class CostosComplementosModelBase : ModelObject
    {
		    public CostosComplementosModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ValorComplemento 
        /// </Resumen> 
        [Display(Name = "Valor Complemento")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public Double ValorComplemento{ get; set; }

        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ValorComplementoCantidad 
        /// </Resumen> 
        [Display(Name = "Valor Complemento Cantidad")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public Double ValorComplementoCantidad{ get; set; }
