...
{
     /// <Resumen>
     /// Clase Model Base para  SemanaComponentes
    ...
    public class SemanaComponentesModelBase : ModelObject
    {
		    public SemanaComponentesModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: CantidadComponente 
        /// </Resumen> 
        [Display(Name = "Cantidad Componente")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
