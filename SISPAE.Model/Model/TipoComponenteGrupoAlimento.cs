...
{
     /// <Resumen>
     /// Clase Model Base para  TipoComponenteGrupoAlimento
    ...
    public class TipoComponenteGrupoAlimentoModelBase : ModelObject
    {
		    public TipoComponenteGrupoAlimentoModelBase() 
    {  
    }  
