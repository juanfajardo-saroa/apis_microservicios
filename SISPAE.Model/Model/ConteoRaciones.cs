...
{
     /// <Resumen>
     /// Clase Model Base para  ConteoRaciones
    ...
    public class ConteoRacionesModelBase : ModelObject
    {
		private DateTime _createdFechaEntrega; 
    public ConteoRacionesModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_TiposModalidadRacion 
        /// </Resumen> 
        [Display(Name = "Tipos Modalidad Racion")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_TiposModalidadRacion{ get; set; }
