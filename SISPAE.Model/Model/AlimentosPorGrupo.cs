...
{
     /// <Resumen>
     /// Clase Model Base para  AlimentosPorGrupo
    ...
    public class AlimentosPorGrupoModelBase : ModelObject
    {
		    public AlimentosPorGrupoModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_AlimentosBase 
        /// </Resumen> 
        [Display(Name = "Alimentos Base")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_AlimentosBase{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_AlimentosBase { get; set; }
        /// 
