...
namespace SISPAE.Model
{
    ...
    public class PolizasModelBase : ModelObject
    {
		private DateTime _createdFechaAprobacion; 
private DateTime _createdFechaPoliza; 
    public PolizasModelBase() 
    {  
    _createdFechaAprobacion= DateTime.MinValue; 
    _createdFechaPoliza= DateTime.MinValue; 
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_TipoPoliza 
        /// </Resumen> 
        ...
        public DateTime FechaAprobacion
                {
                     get
                     { return (_createdFechaAprobacion== DateTime.MinValue) ? DateTime.Now : _createdFechaAprobacion;
                     }
                     set { _createdFechaAprobacion = value; }

                }
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Numero 
        /// </Resumen> 
        [Display(Name = "Numero")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: FechaPoliza 
        /// </Resumen> 
        ...
        public DateTime FechaPoliza
                {
                     get
                     { return (_createdFechaPoliza== DateTime.MinValue) ? DateTime.Now : _createdFechaPoliza;
                     }
                     set { _createdFechaPoliza = value; }
