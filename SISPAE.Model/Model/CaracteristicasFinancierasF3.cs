...
{
     /// <Resumen>
     /// Clase Model Base para  CaracteristicasFinancierasF3
    ...
    public class CaracteristicasFinancierasF3ModelBase : ModelObject
    {
		    public CaracteristicasFinancierasF3ModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: PrecioComplemento 
        /// </Resumen> 
        [Display(Name = "Precio Complemento")] 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdZona 
        /// </Resumen> 
        ...
        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sIdZona { get; set; }
        /// 
 
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdNivelEducativo 
        /// </Resumen> 
        [Display(Name = "Id Nivel Educativo")] 
        public int? IdNivelEducativo{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sIdNivelEducativo { get; set; }
        /// 
