...
{
     /// <Resumen>
     /// Clase Model Base para  StgSISBEN
    ...
    public class StgSISBENModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgSISBENModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdSISBEN 
        /// </Resumen> 
        [Display(Name = "Id S I S B E N")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(5 , ErrorMessage = " El campo {0} no debe tener mas de 5 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdSISBEN{ get; set; }
