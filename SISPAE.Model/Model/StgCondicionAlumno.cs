...
{
     /// <Resumen>
     /// Clase Model Base para  StgCondicionAlumno
    ...
    public class StgCondicionAlumnoModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgCondicionAlumnoModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdCondicionAlumno 
        /// </Resumen> 
        [Display(Name = "Id Condicion Alumno")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(1 , ErrorMessage = " El campo {0} no debe tener mas de 1 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdCondicionAlumno{ get; set; }
