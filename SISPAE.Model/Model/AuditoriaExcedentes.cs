...
{
     /// <Resumen>
     /// Clase Model Base para  AuditoriaExcedentes
    ...
    public class AuditoriaExcedentesModelBase : ModelObject
    {
		private DateTime _createdFechaCambio; 
    public AuditoriaExcedentesModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_ExcedenteComplemento 
        /// </Resumen> 
        [Display(Name = "Excedente Complemento")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_ExcedenteComplemento{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_ExcedenteComplemento { get; set; }
        /// 
