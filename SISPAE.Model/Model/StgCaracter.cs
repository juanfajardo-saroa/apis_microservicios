...
{
     /// <Resumen>
     /// Clase Model Base para  StgCaracter
    ...
    public class StgCaracterModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgCaracterModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdCaracter 
        /// </Resumen> 
        [Display(Name = "Id Caracter")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
