...
{
     /// <Resumen>
     /// Clase Model Base para  StgCapacidadesExcepciones
    ...
    public class StgCapacidadesExcepcionesModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgCapacidadesExcepcionesModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdCapacidadExcep 
        /// </Resumen> 
        [Display(Name = "Id Capacidad Excep")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(1 , ErrorMessage = " El campo {0} no debe tener mas de 1 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdCapacidadExcep{ get; set; }
