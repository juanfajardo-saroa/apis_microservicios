...
{
     /// <Resumen>
     /// Clase Model Base para  MinutaAprobacionLeveHistorico
    ...
    public class MinutaAprobacionLeveHistoricoModelBase : ModelObject
    {
		private DateTime _createdFechaAprobacion; 
    public MinutaAprobacionLeveHistoricoModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_MinutaLeve 
        /// </Resumen> 
        [Display(Name = "Minuta Leve")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_MinutaLeve{ get; set; }
