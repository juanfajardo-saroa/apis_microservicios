...
{
     /// <Resumen>
     /// Clase Model Base para  StgFuenteRecurso
    ...
    public class StgFuenteRecursoModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgFuenteRecursoModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdFuenteRecurso 
        /// </Resumen> 
        [Display(Name = "Id Fuente Recurso")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(1 , ErrorMessage = " El campo {0} no debe tener mas de 1 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdFuenteRecurso{ get; set; }
