...
{
     /// <Resumen>
     /// Clase Model Base para  StgValoracion
    ...
    public class StgValoracionModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgValoracionModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdValoracion 
        /// </Resumen> 
        [Display(Name = "Id Valoracion")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
