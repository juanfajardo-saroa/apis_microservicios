...
{
     /// <Resumen>
     /// Clase Model Base para  StgSituacionAcademica
    ...
    public class StgSituacionAcademicaModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgSituacionAcademicaModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdSituacionAcademica 
        /// </Resumen> 
        [Display(Name = "Id Situacion Academica")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(2 , ErrorMessage = " El campo {0} no debe tener mas de 2 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdSituacionAcademica{ get; set; }
