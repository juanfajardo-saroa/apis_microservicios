...
{
     /// <Resumen>
     /// Clase Model Base para  DetallesSumRaciones
    ...
    public class DetallesSumRacionesModelBase : ModelObject
    {
		    public DetallesSumRacionesModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_TipoModalidadRacion { get; set; }
        /// 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Raciones 
        /// </Resumen> 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: MesesSuministro 
        /// </Resumen> 
        [Display(Name = "Meses Suministro")] 
        public int? MesesSuministro{ get; set; }

        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ContratoPAEC 
        /// </Resumen> 
        [Display(Name = "Contrato P A E C")] 
        public Boolean? ContratoPAEC{ get; set; }
