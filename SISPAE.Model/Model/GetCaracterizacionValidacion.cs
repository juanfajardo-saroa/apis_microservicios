...
{
     /// <Resumen>
     /// Clase Model Base para  GetCaracterizacionValidacion
    ...
    public class GetCaracterizacionValidacionModelBase : ModelObject
    {
		    public GetCaracterizacionValidacionModelBase() 
    {  
    }  
