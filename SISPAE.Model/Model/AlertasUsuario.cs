...
namespace SISPAE.Model
    {
    /// <Resumen>
    /// Clase Model Base para  AlertasUsuario
    ...
    public class AlertasUsuarioModelBase : ModelObject
        {
        private DateTime _createdFechaCambio;
        public AlertasUsuarioModelBase()
            {
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_Alerta 
        /// </Resumen> 
        [Display(Name = "Alerta")]
        [Required(ErrorMessage = " El Campo {0} es obligatorio, no puede estar vacio !")]
        ...
        public String? sID_Alerta { get; set; }
        /// 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_AlertaEstado 
        /// </Resumen> 
        [Display(Name = "Alerta Estado")]
        [Required(ErrorMessage = " El Campo {0} es obligatorio, no puede estar vacio !")]
        public int ID_AlertaEstado { get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_AlertaEstado { get; set; }
        /// 
