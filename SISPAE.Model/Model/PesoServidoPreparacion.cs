...
{
     /// <Resumen>
     /// Clase Model Base para  PesoServidoPreparacion
    ...
    public class PesoServidoPreparacionModelBase : ModelObject
    {
		    public PesoServidoPreparacionModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public Double PesoServido{ get; set; }
