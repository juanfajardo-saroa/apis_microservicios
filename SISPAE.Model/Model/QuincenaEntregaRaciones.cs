...
{
     /// <Resumen>
     /// Clase Model Base para  QuincenaEntregaRaciones
    ...
    public class QuincenaEntregaRacionesModelBase : ModelObject
    {
		private DateTime _createdfechaCarga; 
    public QuincenaEntregaRacionesModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_EstadoQuincena 
        /// </Resumen> 
        [Display(Name = "Estado Quincena")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_EstadoQuincena{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_EstadoQuincena { get; set; }
        /// 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: pathReporteQuincenal 
        /// </Resumen> 
        [Display(Name = "path Reporte Quincenal")] 
        [StringLength(255 , ErrorMessage = " El campo {0} no debe tener mas de 255 caracteres.")] 
        [DataType (DataType.MultilineText)]   
        public String pathReporteQuincenal{ get; set; }
