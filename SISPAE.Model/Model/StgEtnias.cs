...
{
     /// <Resumen>
     /// Clase Model Base para  StgEtnias
    ...
    public class StgEtniasModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgEtniasModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdEtnias 
        /// </Resumen> 
        [Display(Name = "Id Etnias")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(3 , ErrorMessage = " El campo {0} no debe tener mas de 3 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdEtnias{ get; set; }
