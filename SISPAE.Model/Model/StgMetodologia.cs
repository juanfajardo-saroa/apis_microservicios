...
{
     /// <Resumen>
     /// Clase Model Base para  StgMetodologia
    ...
    public class StgMetodologiaModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgMetodologiaModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdMetodologia 
        /// </Resumen> 
        [Display(Name = "Id Metodologia")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
