...
{
     /// <Resumen>
     /// Clase Model Base para  Multimedias
    ...
    public class MultimediasModelBase : ModelObject
    {
		    public MultimediasModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: PATH 
        /// </Resumen> 
        [Display(Name = "P A T H")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
