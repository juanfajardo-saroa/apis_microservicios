...
namespace SISPAE.Model
{
    ...
    public class MenuModelBase : ModelObject
    {
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IconoPAE 
        /// </Resumen> 
        [Display(Name = "Icono P A E")] 
        [StringLength(50 , ErrorMessage = " El campo {0} no debe tener mas de 50 caracteres.")] 
        [DataType (DataType.Text)]   
        public String? IconoPAE{ get; set; }

        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: EstadoMenu 
        /// </Resumen> 
