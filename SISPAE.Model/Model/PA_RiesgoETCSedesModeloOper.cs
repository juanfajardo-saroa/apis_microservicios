...
{
     /// <Resumen>
     /// Clase Model Base para  PA_RiesgoETCSedesModeloOper
    ...
    public class PA_RiesgoETCSedesModeloOperModelBase : ModelObject
    {
		    public PA_RiesgoETCSedesModeloOperModelBase() 
    {  
    }  
