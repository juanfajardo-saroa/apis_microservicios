...
{
     /// <Resumen>
     /// Clase Model Base para  AuditoriaPlanesAlistamiento
    ...
    public class AuditoriaPlanesAlistamientoModelBase : ModelObject
    {
		private DateTime _createdFechaCambio; 
    public AuditoriaPlanesAlistamientoModelBase() 
    {  
