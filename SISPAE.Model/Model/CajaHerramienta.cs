...
{
     /// <Resumen>
     /// Clase Model Base para  CajaHerramienta
    ...
    public class CajaHerramientaModelBase : ModelObject
    {
		private DateTime _createdFechaActualizacion; 
    public CajaHerramientaModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: id_AnexoRecurso 
        /// </Resumen> 
        [Display(Name = "Anexo Recurso")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int id_AnexoRecurso{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sid_AnexoRecurso { get; set; }
        /// 
 
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: PATHArchivo 
        /// </Resumen> 
        [Display(Name = "P A T H Archivo")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        ...
        public DateTime FechaActualizacion
                {
                     get
                     { return (_createdFechaActualizacion== DateTime.MinValue) ? DateTime.Now : _createdFechaActualizacion;
                     }
                     set { _createdFechaActualizacion = value; }
