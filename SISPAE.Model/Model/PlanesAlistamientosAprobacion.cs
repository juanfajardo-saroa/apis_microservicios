...
{
     /// <Resumen>
     /// Clase Model Base para  PlanesAlistamientosAprobacion
    ...
    public class PlanesAlistamientosAprobacionModelBase : ModelObject
    {
		private DateTime _createdFechaAprobacion; 
    public PlanesAlistamientosAprobacionModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_EstadoAlistamiento 
        /// </Resumen> 
        [Display(Name = "Estado Alistamiento")] 
        public int? ID_EstadoAlistamiento{ get; set; }
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_EstadoDocumento 
        /// </Resumen> 
        [Display(Name = "Estado Documento")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_EstadoDocumento{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_EstadoDocumento { get; set; }
        /// 
