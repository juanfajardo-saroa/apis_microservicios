...
{
     /// <Resumen>
     /// Clase Model Base para  PA_QuincenaEntregaRacionesGetxGradoH
    ...
    public class PA_QuincenaEntregaRacionesGetxGradoHModelBase : ModelObject
    {
		private DateTime _createdFechaEntrega; 
    public PA_QuincenaEntregaRacionesGetxGradoHModelBase() 
    {  
