...
{
     /// <Resumen>
     /// Clase Model Base para  OperadoresAprobacion
    ...
    public class OperadoresAprobacionModelBase : ModelObject
    {
		private DateTime _createdFechaAprobacion; 
    public OperadoresAprobacionModelBase() 
    {  
...
#region Public Members 
        ...
        ///    
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_OperadorAprobacion 
        /// </Resumen> 
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_OperadorAprobacion 
        /// </Resumen> 
        [Display(Name = "Operador Aprobacion")] 
        ...
        public int ID_OperadorAprobacion{ get; set; }
