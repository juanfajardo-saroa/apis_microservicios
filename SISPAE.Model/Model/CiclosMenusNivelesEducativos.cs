...
{
     /// <Resumen>
     /// Clase Model Base para  CiclosMenusNivelesEducativos
    ...
    public class CiclosMenusNivelesEducativosModelBase : ModelObject
    {
		    public CiclosMenusNivelesEducativosModelBase() 
    {  
    }  
