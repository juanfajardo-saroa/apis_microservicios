...
{
     /// <Resumen>
     /// Clase Model Base para  PlanAlistamientoDocumentosPA
    ...
    public class PlanAlistamientoDocumentosPAModelBase : ModelObject
    {
		private DateTime _createdFechaVersion; 
    public PlanAlistamientoDocumentosPAModelBase() 
    {  
