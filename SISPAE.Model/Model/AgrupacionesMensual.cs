...
{
     /// <Resumen>
     /// Clase Model Base para  AgrupacionesMensual
    ...
    public class AgrupacionesMensualModelBase : ModelObject
    {
		private DateTime _createdMes; 
    public AgrupacionesMensualModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_TipoEstadoValidacionEntrega 
        /// </Resumen> 
        [Display(Name = "Tipo Estado Validacion Entrega")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_TipoEstadoValidacionEntrega{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_TipoEstadoValidacionEntrega { get; set; }
        /// 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: SoporteEntrega 
        /// </Resumen> 
        [Display(Name = "Soporte Entrega")] 
        [StringLength(250 , ErrorMessage = " El campo {0} no debe tener mas de 250 caracteres.")] 
        [DataType (DataType.MultilineText)]   
        public String? SoporteEntrega{ get; set; }
