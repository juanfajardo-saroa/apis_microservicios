...
{
     /// <Resumen>
     /// Clase Model Base para  TiposAcceso
    ...
    public class TiposAccesoModelBase : ModelObject
    {
		    public TiposAccesoModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: TipoAccesoId 
        /// </Resumen> 
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: TipoAccesoId 
        /// </Resumen> 
       
        [Display(Name = "Tipo Acceso Id")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
