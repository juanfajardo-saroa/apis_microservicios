...
{
     /// <Resumen>
     /// Clase Model Base para  StgAnexo3a
    ...
    public class StgAnexo3aModelBase : ModelObject
    {
		    public StgAnexo3aModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        public int? NOMBRE_CARGO{ get; set; }
        ...
        [StringLength(30 , ErrorMessage = " El campo {0} no debe tener mas de 30 caracteres.")] 
        [DataType (DataType.Text)]   
