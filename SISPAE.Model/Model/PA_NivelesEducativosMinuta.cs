...
{
     /// <Resumen>
     /// Clase Model Base para  PA_NivelesEducativosMinuta
    ...
    public class PA_NivelesEducativosMinutaModelBase : ModelObject
    {
		    public PA_NivelesEducativosMinutaModelBase() 
    {  
    }  
