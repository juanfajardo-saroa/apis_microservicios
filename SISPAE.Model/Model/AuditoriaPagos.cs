...
{
     /// <Resumen>
     /// Clase Model Base para  AuditoriaPagos
    ...
    public class AuditoriaPagosModelBase : ModelObject
    {
		private DateTime _createdFechaCambio; 
    public AuditoriaPagosModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_Pago 
        /// </Resumen> 
        [Display(Name = "Pago")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        ...
        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_Pago { get; set; }
        /// 
