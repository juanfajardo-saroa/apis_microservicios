...
{
     /// <Resumen>
     /// Clase Model Base para  ExcedentesRaciones
    ...
    public class ExcedentesRacionesModelBase : ModelObject
    {
		private DateTime _createdFechaReporte; 
    public ExcedentesRacionesModelBase() 
    {  
...
#region Public Members 
        ...
        /// </Resumen> 
        [Display(Name = "Tipo Destino Racion")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_TipoDestinoRacion{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_TipoDestinoRacion { get; set; }
        /// 
        ...
        /// </Resumen> 
        [Display(Name = "Tipo Estado Excedentes Raciones")] 
        public int? Id_TipoEstadoExcedentesRaciones{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sId_TipoEstadoExcedentesRaciones { get; set; }
        /// 
