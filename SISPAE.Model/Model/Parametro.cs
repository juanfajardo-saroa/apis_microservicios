...
{
     /// <Resumen>
     /// Clase Model Base para  Parametro
    ...
    public class ParametroModelBase : ModelObject
    {
		    public ParametroModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: unidad 
        /// </Resumen> 
        [Display(Name = "unidad")] 
        [StringLength(255 , ErrorMessage = " El campo {0} no debe tener mas de 255 caracteres.")] 
        [DataType (DataType.MultilineText)]   
