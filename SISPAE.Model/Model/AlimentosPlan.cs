...
{
     /// <Resumen>
     /// Clase Model Base para  AlimentosPlan
    ...
    public class AlimentosPlanModelBase : ModelObject
    {
		    public AlimentosPlanModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_MenuPlanAlistamiento 
        /// </Resumen> 
        [Display(Name = "Menu Plan Alistamiento")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_MenuPlanAlistamiento{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_MenuPlanAlistamiento { get; set; }
        /// 
