...
{
     /// <Resumen>
     /// Clase Model Base para  AporteMenus
    ...
    public class AporteMenusModelBase : ModelObject
    {
		    public AporteMenusModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public Decimal AporteEstimado{ get; set; }
        ...
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public Decimal PorcentajeAdecuacion{ get; set; }
