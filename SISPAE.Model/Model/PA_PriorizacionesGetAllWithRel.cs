...
{
     /// <Resumen>
     /// Clase Model Base para  PA_PriorizacionesGetAllWithRel
    ...
    public class PA_PriorizacionesGetAllWithRelModelBase : ModelObject
    {
		    public PA_PriorizacionesGetAllWithRelModelBase() 
    {  
    }
