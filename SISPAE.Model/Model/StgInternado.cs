...
{
     /// <Resumen>
     /// Clase Model Base para  StgInternado
    ...
    public class StgInternadoModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgInternadoModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdInternado 
        /// </Resumen> 
        [Display(Name = "Id Internado")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(1 , ErrorMessage = " El campo {0} no debe tener mas de 1 caracteres.")] 
        [DataType (DataType.Text)]   
        public String IdInternado{ get; set; }
