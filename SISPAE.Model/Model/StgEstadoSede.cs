...
{
     /// <Resumen>
     /// Clase Model Base para  StgEstadoSede
    ...
    public class StgEstadoSedeModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgEstadoSedeModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdEstadoSede 
        /// </Resumen> 
        [Display(Name = "Id Estado Sede")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
