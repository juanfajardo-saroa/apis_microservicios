...
{
     /// <Resumen>
     /// Clase Model Base para  StgPaises
    ...
    public class StgPaisesModelBase : ModelObject
    {
		private DateTime _createdFechaCreacion; 
    public StgPaisesModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: IdPais 
        /// </Resumen> 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Cod 
        /// </Resumen> 
        [Display(Name = "Cod")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        [StringLength(150 , ErrorMessage = " El campo {0} no debe tener mas de 150 caracteres.")] 
