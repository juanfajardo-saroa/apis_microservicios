...
{
     /// <Resumen>
     /// Clase Model Base para  AporteSemanas
    ...
    public class AporteSemanasModelBase : ModelObject
    {
		    public AporteSemanasModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_Semana 
        /// </Resumen> 
        [Display(Name = "Semana")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        ...
        public String? sID_Semana { get; set; }
        /// 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: AporteEstimado 
        /// </Resumen> 
        [Display(Name = "Aporte Estimado")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public Double AporteEstimado{ get; set; }
