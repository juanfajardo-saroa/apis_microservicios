...
{
     /// <Resumen>
     /// Clase Model Base para  ReglasValidacion
    ...
    public class ReglasValidacionModelBase : ModelObject
    {
		    public ReglasValidacionModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Regla 
        /// </Resumen> 
        [Display(Name = "Regla")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
