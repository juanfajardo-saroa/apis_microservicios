...
{
     /// <Resumen>
     /// Clase Model Base para  EntregasComplementos
    ...
    public class EntregasComplementosModelBase : ModelObject
    {
		private DateTime _createdFechaEntrega; 
    public EntregasComplementosModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ID_SemanaEntregaComplemento 
        /// </Resumen> 
        [Display(Name = "Semana Entrega Complemento")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        public int ID_SemanaEntregaComplemento{ get; set; }

        ///[Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        /// Esta propiedad corresponde a las Foreing Key, la (s) inicial se pone porque el objeto no se puede llamar igual que la clase 
        public String? sID_SemanaEntregaComplemento { get; set; }
        /// 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ComplementosPreparadas 
        /// </Resumen> 
        [Display(Name = "Complementos Preparadas")] 
        public int? ComplementosPreparadas{ get; set; }
