...
{
     /// <Resumen>
     /// Clase Model Base para  LogErrores
    ...
    public class LogErroresModelBase : ModelObject
    {
		private DateTime _createdFecha; 
    public LogErroresModelBase() 
    {  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Operacion 
        /// </Resumen> 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: ParametrosOperacion 
        /// </Resumen> 
        [Display(Name = "Parametros Operacion")] 
        [DataType (DataType.MultilineText)]   
        public String? ParametrosOperacion{ get; set; }

        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: DetallesError 
        /// </Resumen> 
        [Display(Name = "Detalles Error")] 
        [DataType (DataType.MultilineText)]   
