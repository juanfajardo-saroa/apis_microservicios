...
{
     /// <Resumen>
     /// Clase Model Base para  Impuestos
    ...
    public class ImpuestosModelBase : ModelObject
    {
		    public ImpuestosModelBase() 
    {  
    }  
...
#region Public Members 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: Tarifa 
        /// </Resumen> 
        [Display(Name = "Tarifa")] 
        [Required(ErrorMessage =" El Campo {0} es obligatorio, no puede estar vacio !")] 
        ...
        /// <Resumen>  
        /// ( Gets or Sets ) Obtiene o establece el valor de la propiedad: BaseGravable 
        /// </Resumen> 
